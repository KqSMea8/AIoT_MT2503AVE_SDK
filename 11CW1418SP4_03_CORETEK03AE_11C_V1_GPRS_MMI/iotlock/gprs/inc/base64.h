...
Others:         
 *************************************************/
int iotlock_base64_decode(unsigned char *out, unsigned char *in, int inlen, int maxlen);
...
Others:         
 *************************************************/
int iotlock_base64_encode(char *out, const unsigned char *in, int inlen, int maxlen);
