...
/* information of progressive bar image resource */
    ...
    #define BAR_WIDTH		165
    #define BAR_HEIGHT		11
#elif (UI_DEVICE_WIDTH == 240) && (UI_DEVICE_HEIGHT == 240)
    #define BG_WIDTH		200
    #define BG_HEIGHT		81
    #define BAR_X			18
    #define BAR_Y			39
    #define BAR_WIDTH		165
    #define BAR_HEIGHT		11
#elif (UI_DEVICE_WIDTH == 128) && (UI_DEVICE_HEIGHT == 32)
    #define BG_WIDTH		128
    #define BG_HEIGHT		32
    #define BAR_X			0
    #define BAR_Y			8
...
#elif (UI_DEVICE_WIDTH == 96) && (UI_DEVICE_HEIGHT == 64)
		#define BG_WIDTH		96
		#define BG_HEIGHT		64
		#define BAR_X			0
		#define BAR_Y			8
...
#if defined(__BG_IMAGE__) && (defined(__CARD_DOWNLOAD__) ||defined(__FUNET_ENABLE__) || defined(__FUDIFFNET_ENABLE__)||defined(__ADUPS_FOTA_DIFF__))
...
__align(4) static kal_uint8 g_bl_pbar_buff[BL_BACKGROUND_BUFF_SIZE];  /* for background */
 ...
 *  void
 *****************************************************************************/
static void BL_InitLCDScreenConfiguration(kal_uint16 bg_width, kal_uint16 bg_height, kal_int32 bg_color, kal_uint16 x, kal_uint16 y, kal_bool align_center)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    {
        g_bl_layer_data.x_offset = x;
        g_bl_layer_data.y_offset = y;
    }
...
#if defined(__CARD_DOWNLOAD__) || defined(__FUNET_ENABLE__) || defined(__FUDIFFNET_ENABLE__)|| defined(__ADUPS_FOTA_DIFF__)
/*****************************************************************************
 * FUNCTION
...
void BL_ShowUpdateFirmwareInitBackground(void)
{
    ...
    BL_InitLCDScreenConfiguration(BG_WIDTH, BG_HEIGHT, 0xFFFFFF, 0, 0, KAL_TRUE);
 ...
 *****************************************************************************/
#ifdef __FAST_LOGO__
void BL_ShowUpdateFirmwareInitBackgroundByImage(U8 *imageSrc, kal_uint16 x, kal_uint16 y, kal_bool align_center)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* init LCD and layer configuration */
    BL_InitLCDScreenConfiguration(info.width, info.height, 0, x, y, align_center);
