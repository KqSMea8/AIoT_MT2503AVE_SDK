...
void motion_sensor_sample_cb(void *parameter)
{
    ...
    {
        kal_set_timer_ts(motion_sensor_data.motionsensor_timerid, (kal_timer_func_ptr)motion_sensor_sample_cb, NULL, 
        WAIT_UNMASK_I2C_IRQ_PERIOD, 0, KAL_TRUE); //wait 1 more tick to execute callback
        return;
    }
    ...
    kal_set_timer_ts(motion_sensor_data.motionsensor_timerid, (kal_timer_func_ptr)motion_sensor_sample_cb, NULL, 
    motion_sensor_data.sample_period,	0, KAL_TRUE);
...
#endif
#ifndef __MTK_SENSOR_SUBSYS_SUPPORT__		
typedef struct
{
   kal_uint8 addr;           /**< Device address.*/
   kal_uint8 reg;            /**< Device register value.*/
   kal_uint8 *data_buf;      /**< A pointer to a data buffer.*/
   kal_uint8	length;        /**< Length of the data buffer.*/
}bus_data_t;
void vsm_data_drop(kal_uint8 sram_type){}
kal_int8 vsm_driver_deinit(){}
kal_int8 vsm_driver_disable_signal(kal_int32 signal){}
kal_int8 vsm_driver_enable_signal(kal_int32 signal){}
kal_int8 vsm_driver_init(void){}
kal_int8 vsm_driver_read_register(bus_data_t *data){}
kal_int8 vsm_driver_read_sram(kal_uint8 sram_type, kal_uint32 *data_buf, kal_int32 *len){}
kal_int8 vsm_driver_reset_PPG_counter(void){}
kal_int8 vsm_driver_set_ambdac_current(kal_uint8 ambdac_type, kal_uint8 current){}
kal_int8 vsm_driver_set_led_current(kal_uint8 led_type, kal_uint32 input){}
kal_int8 vsm_driver_set_led_current_range(kal_uint32 cur_range){}
kal_int8 vsm_driver_set_signal(kal_int32 signal){}
kal_int8 vsm_driver_set_tia_cf(kal_uint8 led_type, kal_uint32 input){}
kal_int8 vsm_driver_set_tia_gain(kal_int32 ppg_type, kal_uint8 input){}
kal_int8 vsm_driver_update_register(void){}
kal_int8 vsm_driver_write_register(bus_data_t *data){}
