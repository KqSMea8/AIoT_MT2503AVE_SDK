...
*****************************************************************************/
...
#if (defined(WAP_SUPPORT) && !defined(__IOT__))
...
#if (defined(__LOW_COST_SUPPORT_COMMON__) && (defined(__MMI_MAINLCD_96X64__)||defined(__MMI_MAINLCD_128X32__)||defined(__MMI_MAINLCD_128X128__) || defined(__MMI_MAINLCD_128X160__) || defined(__MMI_MAINLCD_176X220__) || defined(__MMI_MAINLCD_320X320__)|| defined(__MMI_MAINLCD_240X240__)|| defined(__MMI_MAINLCD_240X320__)|| defined(__MMI_MAINLCD_320X240__)))
	...
	(defined(__MMI_WEARABLE_DEVICE__))
	...
	#define __MMI_FWUI_SLIM__
	 ...
	 ((defined(__COSMOS_MMI_PACKAGE__) && defined(LOW_COST_SUPPORT)) || (defined(__MMI_WEARABLE_DEVICE__) && defined(__MMI_FTE_SUPPORT__) && (defined(__MMI_MAINLCD_240X240__)|| defined(__MMI_MAINLCD_320X320__))))
...
#if defined(CFG_MMI_BLE_DOGP_SUPPORT) && ((CFG_MMI_BLE_DOGP_SUPPORT == __ON__)||(CFG_MMI_BLE_DOGP_SUPPORT == __AUTO__))
	#if (!defined(__BT_GATTS_PROFILE__))
	#error "dependence conflict, pls turn on__BT_GATTS_PROFILE__"
	#endif
	#ifndef __MMI_BLE_DOGP_SUPPORT__
	#define __MMI_BLE_DOGP_SUPPORT__
	#endif
#endif


#if (!defined(__BT_NOTI_SRV_REMOVE__)  && defined(__MMI_BT_DIALER_SUPPORT__) && defined(__XML_SUPPORT__) && (defined(__MMI_SPP_SUPPORT__) || defined(__MMI_BLE_DOGP_SUPPORT__)))
	...
	(defined(__BT_PBAP_CLIENT__)) || (defined(__MMI_WEARABLE_DEVICE__) && defined(__BT_PBAP_CLIENT__))
	...
	(((defined(__MMI_LANG_SM_CHINESE__) || defined(__MMI_LANG_TR_CHINESE__)) && (defined(__MMI_T9__) || defined(__MMI_ZI__) || defined(__MMI_CSTAR__) || defined(__MMI_GUOBI__))) || (!(defined(__MMI_LANG_SM_CHINESE__) || defined(__MMI_LANG_TR_CHINESE__)))) || (defined(__MMI_WEARABLE_DEVICE__) && defined(__MMI_PHB_PBAPC_SYNC_CONTACT__))
...
#if ((!defined(__MMI_TAB_BARS_SUPPORT__)) && (!defined(__MMI_FTE_SUPPORT__)) && (!defined(__MMI_TOUCH_SCREEN__)) && (!defined(__MMI_TOUCH_DIAL_SCREEN__))&&(!defined(__MMI_MAINLCD_96X64__)))
...
#if (defined(CFG_MMI_SMART_WATCH_MAINMENU_TYPE))
	#ifndef __MMI_SMART_WATCH_MAINMENU_TYPE__
	#define __MMI_SMART_WATCH_MAINMENU_TYPE__	CFG_MMI_SMART_WATCH_MAINMENU_TYPE
	#endif
#endif


#if (defined(__MMI_SMART_WATCH_MAINMENU_TYPE__) && ((__MMI_SMART_WATCH_MAINMENU_TYPE__ == __ONE__) || (__MMI_SMART_WATCH_MAINMENU_TYPE__ == __ALL__)))
	#ifndef __MMI_SMART_WATCH_MAINMENU_ONE__
	#define __MMI_SMART_WATCH_MAINMENU_ONE__
	#endif
#endif


#if (defined(__MMI_SMART_WATCH_MAINMENU_TYPE__) && ((__MMI_SMART_WATCH_MAINMENU_TYPE__ == __FOUR__) || (__MMI_SMART_WATCH_MAINMENU_TYPE__ == __ALL__)))
	#ifndef __MMI_SMART_WATCH_MAINMENU_FOUR__
	#define __MMI_SMART_WATCH_MAINMENU_FOUR__
	#endif
#endif


#if (defined(__MMI_WEARABLE_DEVICE__) && !defined(__MMI_SMART_WATCH_MAINMENU_ONE__) && !defined(__MMI_SMART_WATCH_MAINMENU_FOUR__) && !defined(__MMI_MAINLCD_128X128__))
	#error "Setting conflict, __MMI_WEARABLE_DEVICE__ require enable __MMI_SMART_WATCH_MAINMENU_ONE__ or __MMI_SMART_WATCH_MAINMENU_FOUR__"
#endif
...
#define __MMI_UI_CATEGORY_DIAL_TYPE_SEL__	DIAL_TYPE_DEFAULT
...
#if (defined(__MMI_WEARABLE_DEVICE__) && defined(__MMI_TELEPHONY_SUPPORT__) && defined(__GPS_SUPPORT__))
	#ifndef __MMI_APP_WITHOUT_LOCAL__
	#define __MMI_APP_WITHOUT_LOCAL__
	#endif
#endif
...
#if (defined(__MMI_FILE_MANAGER__) && defined(AUD_REC_ENABLE) && !defined(__MMI_MAINLCD_128X64__))
	...
	(!defined(__IOT__) || defined(__DISPLAY_LEVEL_GDI_ONLY__))
...
#if defined(CFG_MMI_BLE_ANCS_SUPPORT) && ((CFG_MMI_BLE_ANCS_SUPPORT == __ON__)||(CFG_MMI_BLE_ANCS_SUPPORT == __AUTO__)) && \
	(defined(__BT_GATTC_PROFILE__) && defined(__MMI_BT_NOTI_SRV__))
	#ifndef __MMI_BLE_ANCS_SUPPORT__
	#define __MMI_BLE_ANCS_SUPPORT__
	#endif
#endif


#if defined(CFG_MMI_BLE_ANP_SUPPORT) && ((CFG_MMI_BLE_ANP_SUPPORT == __ON__)||(CFG_MMI_BLE_ANP_SUPPORT == __AUTO__))
	#if (!defined(__BT_GATTC_PROFILE__))
	#error "dependence conflict, pls turn on__BT_GATTC_PROFILE__"
	#endif
	#ifndef __MMI_BLE_ANP_SUPPORT__
	#define __MMI_BLE_ANP_SUPPORT__
	#endif
#endif


#if defined(CFG_MMI_BLE_BAS_SUPPORT) && ((CFG_MMI_BLE_BAS_SUPPORT == __ON__)||(CFG_MMI_BLE_BAS_SUPPORT == __AUTO__))
	#if (!defined(__BT_GATTS_PROFILE__))
	#error "dependence conflict, pls turn on__BT_GATTS_PROFILE__"
	#endif
	#ifndef __MMI_BLE_BAS_SUPPORT__
	#define __MMI_BLE_BAS_SUPPORT__
	#endif
#endif


#if (defined(__BT_GATTS_PROFILE__) || defined(__BT_GATTC_PROFILE__))
	#ifndef __MMI_BLE_FMP_LISTEN_CM_EVT__
	#define __MMI_BLE_FMP_LISTEN_CM_EVT__
	#endif
#endif


#if defined(CFG_MMI_BLE_FMP_SUPPORT) && ((CFG_MMI_BLE_FMP_SUPPORT == __ON__)||(CFG_MMI_BLE_FMP_SUPPORT == __AUTO__))
	#if (!defined(__BT_GATTC_PROFILE__))
	#error "dependence conflict, pls turn on__BT_GATTC_PROFILE__"
	#endif
	#ifndef __MMI_BLE_FMP_SUPPORT__
	#define __MMI_BLE_FMP_SUPPORT__
	#endif
#endif


#if defined(CFG_MMI_BLE_LOW_POWER) && ((CFG_MMI_BLE_LOW_POWER == __ON__)||(CFG_MMI_BLE_LOW_POWER == __AUTO__))
...
#if defined(CFG_MMI_BLE_PDMS_SUPPORT) && ((CFG_MMI_BLE_PDMS_SUPPORT == __ON__)||(CFG_MMI_BLE_PDMS_SUPPORT == __AUTO__))
	#if (!defined(__BT_GATTS_PROFILE__))
	#error "dependence conflict, pls turn on__BT_GATTS_PROFILE__"
	#endif
	#ifndef __MMI_BLE_PDMS_SUPPORT__
	#define __MMI_BLE_PDMS_SUPPORT__
	#endif
#endif


#if (defined(__BT_GATTS_PROFILE__) || defined(__BT_GATTC_PROFILE__))
	#ifndef __MMI_BLE_PXP_LISTEN_CM_EVT__
	#define __MMI_BLE_PXP_LISTEN_CM_EVT__
	#endif
#endif


#if defined(CFG_MMI_BLE_PXP_SUPPORT) && ((CFG_MMI_BLE_PXP_SUPPORT == __ON__)||(CFG_MMI_BLE_PXP_SUPPORT == __AUTO__))
	#if (!defined(__BT_GATTS_PROFILE__))
	#error "dependence conflict, pls turn   on__BT_GATTS_PROFILE__"
	#endif
	#ifndef __MMI_BLE_PXP_SUPPORT__
	#define __MMI_BLE_PXP_SUPPORT__
	#endif
#endif


#if defined(CFG_MMI_BLE_TIP_SUPPORT) && ((CFG_MMI_BLE_TIP_SUPPORT == __ON__)||(CFG_MMI_BLE_TIP_SUPPORT == __AUTO__))
	#if (!defined(__BT_GATTC_PROFILE__))
	#error "dependence conflict, pls turn on__BT_GATTC_PROFILE__"
	#endif
	#ifndef __MMI_BLE_TIP_SUPPORT__
	#define __MMI_BLE_TIP_SUPPORT__
	#endif
#endif
...
#if defined(CFG_MMI_BT_APK_SMART_INSTALL_SUPPORT) && ((CFG_MMI_BT_APK_SMART_INSTALL_SUPPORT == __ON__)||(CFG_MMI_BT_APK_SMART_INSTALL_SUPPORT == __AUTO__)) && \
	(defined (__MMI_WEARABLE_DEVICE__) && defined(__MMI_OPP_SUPPORT__) && !defined (__MMI_BT_APPLICATION_BQB__))
	#ifndef __MMI_BT_APK_SMART_INSTALL_SUPPORT__
	#define __MMI_BT_APK_SMART_INSTALL_SUPPORT__
	#endif
#endif
	...
	(defined(__MMI_BT_DIALER_SUPPORT__) && defined(__XML_SUPPORT__) && (defined(__MMI_SPP_SUPPORT__) || defined(__MMI_BLE_DOGP_SUPPORT__)))
...
#if defined(CFG_MMI_BT_NOTIFICATION_ENHANCE) && ((CFG_MMI_BT_NOTIFICATION_ENHANCE == __ON__)||(CFG_MMI_BT_NOTIFICATION_ENHANCE == __AUTO__)) && \
	(defined(__MMI_BT_NOTIFICATION__))
...
#if defined(CFG_MMI_DISABLE_CAMERA) && ((CFG_MMI_DISABLE_CAMERA == __ON__)||(CFG_MMI_DISABLE_CAMERA == __AUTO__))
	#ifndef __MMI_DISABLE_CAMERA__
	#define __MMI_DISABLE_CAMERA__
	#endif
#endif


#if ((!defined(__COSMOS_MMI_PACKAGE__) && defined(JPG_DECODE) && (defined(CAMERA_MODULE) || defined(ISP_SUPPORT)) && defined(__MMI_FILE_MANAGER__)&&!defined(__MMI_DISABLE_CAMERA__)))
...
#if ((defined(MP4_ENCODE) || defined(MJPG_ENCODE)) && (defined(ISP_SUPPORT) || defined(__DIRECT_SENSOR_SUPPORT__)) && !defined(__COSMOS_MMI_PACKAGE__) && !defined(__STREAM_SERVER_SUPPORT__)&&!defined(__MMI_DISABLE_CAMERA__))
...
#if defined(CFG_MMI_CLOG_PHB_SYNC_SUPPORT) && ((CFG_MMI_CLOG_PHB_SYNC_SUPPORT == __ON__)||(CFG_MMI_CLOG_PHB_SYNC_SUPPORT == __AUTO__)) && \
	(!defined(__8_32_SEG__) && !defined(__32_32_SEG__) && !defined(__64_64_SEG__))
...
#if (defined (__IPERF__) && defined(__MMI_ENGINEER_MODE__))
...
/* under construction !*/
	...
	(defined(__MMI_FILE_MANAGER__) && (((defined(__64_32_SEG__)||defined(__32_32_SEG__)||defined(__24_32_SEG__)||defined(__16_32_SEG__)||defined(__8_32_SEG__)) && !defined(__COSMOS_MMI_PACKAGE__)) || (defined(__COSMOS_MMI_PACKAGE__) && defined(__COSMOS_NO_USER_DRIVE__))))
...
#if (defined(FM_RADIO_ENABLE) && defined(__FM_RADIO_RDS_SUPPORT__) && !defined(__MMI_MAINLCD_128X128__) && !defined(__MMI_WEARABLE_DEVICE__))
...
#if (defined(__MMI_WEARABLE_DEVICE__) && (defined(__MMI_MAINLCD_240X240__)||defined(__MMI_MAINLCD_320X320__) || defined(__MMI_MAINLCD_240X320__)))
	#ifndef __MMI_GPIO_SUPPORT_BL_TIME_SETTING__
	#define __MMI_GPIO_SUPPORT_BL_TIME_SETTING__
	#endif
#endif


#if defined(CFG_MMI_GSM_CALL_SUPPORT) && ((CFG_MMI_GSM_CALL_SUPPORT == __ON__)||(CFG_MMI_GSM_CALL_SUPPORT == __AUTO__)) && \
	(defined(__MMI_TELEPHONY_SUPPORT__))
	#ifndef __MMI_GSM_CALL_SUPPORT__
	#define __MMI_GSM_CALL_SUPPORT__
	#endif
#endif


#if defined(CFG_MMI_GUI_PICKER) && ((CFG_MMI_GUI_PICKER == __ON__)||(CFG_MMI_GUI_PICKER == __AUTO__)) && \
	(defined(__MMI_BTD_BOX_UI_STYLE__) || defined(__MMI_WEARABLE_DEVICE__))
...
#if defined(CFG_MMI_HF_BAT_SUPPORT) && ((CFG_MMI_HF_BAT_SUPPORT == __ON__)||(CFG_MMI_HF_BAT_SUPPORT == __AUTO__))
	#ifndef __MMI_HF_BAT_SUPPORT__
	#define __MMI_HF_BAT_SUPPORT__
	#endif
#endif
...
#if defined(CFG_MMI_WRISTBAND_SUPPORT) && ((CFG_MMI_WRISTBAND_SUPPORT == __ON__)||(CFG_MMI_WRISTBAND_SUPPORT == __AUTO__))
	#ifndef __MMI_WRISTBAND_SUPPORT__
	#define __MMI_WRISTBAND_SUPPORT__
	#endif
#endif


#if ((!defined(__MMI_BTBOX_NOLCD__)) || (!defined(__MMI_WRISTBAND_SUPPORT__)))
...
#if defined(CFG_MMI_MRE_ALL_SENSOR_INIT) && ((CFG_MMI_MRE_ALL_SENSOR_INIT == __ON__)||(CFG_MMI_MRE_ALL_SENSOR_INIT == __AUTO__))
	#ifndef __MMI_MRE_ALL_SENSOR_INIT__
	#define __MMI_MRE_ALL_SENSOR_INIT__
	#endif
#endif
...
#if defined(CFG_MMI_MRE_PREINSTALL_SYS_PACKAGE) && ((CFG_MMI_MRE_PREINSTALL_SYS_PACKAGE == __ON__)||(CFG_MMI_MRE_PREINSTALL_SYS_PACKAGE == __AUTO__))
	#if (defined(__MMI_MRE_PREINSTALL_TCARD_PACKAGE__))
	#error "Setting conflicts! Preinstall from Tcard, System and Phone drive could not be turned on at the same time"
	#endif
	#ifndef __MMI_MRE_PREINSTALL_SYS_PACKAGE__
	#define __MMI_MRE_PREINSTALL_SYS_PACKAGE__
	#endif
#endif


#if defined(CFG_MMI_MRE_PREINSTALL_PHONE_PACKAGE) && ((CFG_MMI_MRE_PREINSTALL_PHONE_PACKAGE == __ON__)||(CFG_MMI_MRE_PREINSTALL_PHONE_PACKAGE == __AUTO__))
	#if (defined(__MMI_MRE_PREINSTALL_TCARD_PACKAGE__) || defined(__MMI_MRE_PREINSTALL_SYS_PACKAGE__))
	#error "Setting conflicts! Preinstall from Tcard, System and Phone drive could not be turned on at the same time."
	#endif
	#ifndef __MMI_MRE_PREINSTALL_PHONE_PACKAGE__
	#define __MMI_MRE_PREINSTALL_PHONE_PACKAGE__
	#endif
#endif
...
/* under construction !*/
...
#if defined(CFG_MMI_ONE_KEY_SOS_SUPPORT) && ((CFG_MMI_ONE_KEY_SOS_SUPPORT == __ON__)||(CFG_MMI_ONE_KEY_SOS_SUPPORT == __AUTO__)) && \
	(defined(__MMI_TELEPHONY_SUPPORT__) && defined(__MMI_BT_NOTI_SRV__) && (defined(__MMI_SPP_SUPPORT__) || defined(__MMI_BLE_DOGP_SUPPORT__)))
	#ifndef __MMI_ONE_KEY_SOS_SUPPORT__
	#define __MMI_ONE_KEY_SOS_SUPPORT__
	#endif
#endif


#if (defined(__MMI_ONE_KEY_SOS_SUPPORT__))
	#ifndef __MMI_ONE_KEY_SOS_DATA_TRANS__
	#define __MMI_ONE_KEY_SOS_DATA_TRANS__
	#endif
#endif
...
#if (defined(__MMI_VUI_WIDGET_MRE__) || defined(__MMI_VUI_LAUNCHER_MRE__) || defined(__MMI_VUI_SCREEN_LOCK_MRE__) || defined(__MMI_MRE_AUTO_START__) || defined(__LINKIT_DEV_KIT__))
	...
	#ifndef __MMI_SAT_SUPPORT__
	#define __MMI_SAT_SUPPORT__
	#endif
#endif
...
#if defined(CFG_MMI_SMART_DEVICE_SECURITY_SUPPORT) && ((CFG_MMI_SMART_DEVICE_SECURITY_SUPPORT == __ON__)||(CFG_MMI_SMART_DEVICE_SECURITY_SUPPORT == __AUTO__))
	#ifndef __MMI_SMART_DEVICE_SECURITY_SUPPORT__
	#define __MMI_SMART_DEVICE_SECURITY_SUPPORT__
	#endif
#endif
...
/* under construction !*/
	...
	(defined(__MMI_MAINLCD_320X480__) || defined(__MMI_MAINLCD_240X400__)|| defined(__MMI_MAINLCD_240X240__)|| defined(__MMI_MAINLCD_320X320__)  || defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_480X800__)|| defined(__MMI_MAINLCD_320X240__))
...
#if (!defined(__LCD_SUPPORT__)) ||\
	 (defined(__DISPLAY_LEVEL_GDI_ONLY__))
...
#define __MMI_UI_STATUSBAR_STYLE__	STATUSBAR_STYLE_NONE
	...
	(defined(__MMI_BT_BOX__) || defined(__MMI_WEARABLE_DEVICE__))
...
#if (defined(__COSMOS_MMI_PACKAGE__) || defined(__MMI_WEARABLE_DEVICE__))
...
#if (defined(MT2502) || defined(MT2501) || defined(MT6261))
	#ifndef __MMI_USB_FIRMWARE_UPDATE__
	#define __MMI_USB_FIRMWARE_UPDATE__
	#endif
#endif
...
/* under construction !*/
	...
	#define __MMI_WEARABLE_DEVICE_ALARM__
	#endif
#endif


#if defined(CFG_MMI_WEARABLE_DEVICE_DIALER) && ((CFG_MMI_WEARABLE_DEVICE_DIALER == __ON__)||(CFG_MMI_WEARABLE_DEVICE_DIALER == __AUTO__)) && \
	(defined(__MMI_WEARABLE_DEVICE__))
	#ifndef __MMI_WEARABLE_DEVICE_DIALER__
	#define __MMI_WEARABLE_DEVICE_DIALER__
	#endif
#endif
	...
	#ifndef __MMI_WEARABLE_DEVICE_NOTI_UI_ENHANCE__
	#define __MMI_WEARABLE_DEVICE_NOTI_UI_ENHANCE__
	#endif
#endif


#if (defined(__MMI_WEARABLE_DEVICE__) && (defined(__MMI_MAINLCD_240X240__)||defined(__MMI_MAINLCD_320X320__)))
	#ifndef __MMI_WEARABLE_DEVICE_SETTING__
	#define __MMI_WEARABLE_DEVICE_SETTING__
	#endif
#endif
	...
	#define __MMI_WEARABLE_DEVICE_UI_ENHANCE__
	#endif
#endif
...
#define __UCS2_ENCODING
...
#if (defined(__BT_GATTS_PROFILE__) && (defined(MMI_SRV_BT_FMPT_PROFILE) || defined(MMI_SRV_BT_PRXR_PROFILE)))
	#ifndef MMI_BLE_IAS_ALERT_STATUS_CHAR
	#define MMI_BLE_IAS_ALERT_STATUS_CHAR
	#endif
#endif
...
#if (defined(__BT_GATTC_PROFILE__))
	#ifndef MMI_SRV_BT_FMPL_PROFILE
	#define MMI_SRV_BT_FMPL_PROFILE
	#endif
#endif


#if (defined(__BT_GATTC_PROFILE__))
	#ifndef MMI_SRV_BT_PRXM_PROFILE
	#define MMI_SRV_BT_PRXM_PROFILE
	#endif
#endif
...
#if (defined(__BT_GATTS_PROFILE__) || defined(__BT_GATTC_PROFILE__))
	#ifndef MMI_SRV_CONN_STATE_IND
	#define MMI_SRV_CONN_STATE_IND
	#endif
#endif
	...
	((defined(__MMI_MAINLCD_320X480__) || defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_240X240__)|| defined(__MMI_MAINLCD_320X320__)|| defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_480X800__)|| defined(__MMI_MAINLCD_320X240__)) && defined(__MMI_UI_CLOCK_SMAILL_DIGITAL_IMAGE_CLOCK__))
...
#if (defined(__MMI_BT_NOTI_SRV__) && defined(__MTK_SENSOR_SUBSYS_SUPPORT__))&&defined( __MMI_WEARABLE_DEVICE__)
	#ifndef __MMI_HEART_RATE_SUPPORT__
	#define __MMI_HEART_RATE_SUPPORT__
	#endif
#endif


#if (defined(__MMI_BT_NOTI_SRV__) && defined(__MTK_SENSOR_SUBSYS_SUPPORT__))&&defined( __MMI_WEARABLE_DEVICE__)
	#ifndef __MMI_BLOOD_PRESSURE_SUPPORT__
	#define __MMI_BLOOD_PRESSURE_SUPPORT__
	#endif
#endif

#if defined(__IOT_BLE_BKSS_SUPPORT__)
	#ifndef __BAT_7_LEVEL__
	#define __BAT_7_LEVEL__
	#endif
#endif
