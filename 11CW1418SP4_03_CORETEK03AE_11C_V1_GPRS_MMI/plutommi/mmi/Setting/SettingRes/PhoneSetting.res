 ...
 * $Log$
 *
 * 06 20 2016 baohua.ye
 * [MAUI_03556433] [2503AE] for 2503AE Check in
 * IT test result check in.
 *
 * 05 19 2016 baohua.ye
 * [MAUI_03556433] [2503AE] for 2503AE Check in
 * setting&timesync check in.
 *
 * 03 30 2015 baohua.ye
 * [MAUI_03534579] AsterV2 patch to 11CW1418SP4
 * .
 *
 * 01 23 2015 baohua.ye
 * [MAUI_03521707] [Aster] Smart watch UX improvement
 * Rollback //MAUI/BRANCHES_11C/11CW1418SP4/mcu/plutommi/MMI/Setting to changelist 897331
 *
 * 08 08 2014 yunliu.mao
 * [MAUI_03512215] [wearable]merge setting
 * .wrap alarm sync
 *
 * 07 30 2014 yunliu.mao
 * [MAUI_03512215] [wearable]merge setting
 * .phone setting phb display name add mcro
 *
 * 07 23 2014 yunliu.mao
 * [MAUI_03495002] [IOT] Contacts are displayed in reverse order in DUT
 * .[IOT] Contacts are displayed in reverse order in DUT
 *
 * 07 16 2014 zhen.tian
 * [MAUI_03508965] Hotknot Check in
 * .
 *
 * 06 11 2014 ziyao.xiong
 * [MAUI_03505037] [WEARABLE_DEVICE]Alarm sync Feature checkin to 11C1418MP
 * Alarm sync Feature checkin to 11C1418MP.
 *
 * 05 20 2014 yunliu.mao
 * [MAUI_03500775] [wearable device]check in 11CW1418MP
 * .[wearable device]check in 11CW1418MP
 *
...
<APP id = "APP_PHONESETTING_NEW">
    ...
    <STRING id = "STR_MENU9102_INITIAL_SETUP"/>
		...
		<STRING id = "STR_PHONE_SETTING_CLOCK"/>
		<STRING id = "STR_PHONE_SETTING_CLOCK_TYPE"/>
		<STRING id = "STR_PHONE_SETTING_AUTO_SYNC"/>
		<STRING id = "STR_PHONE_SETTING_CLOCK_DATE"/>
		<STRING id = "STR_PHONE_SETTING_CLOCK_TIME"/>
		<STRING id = "STR_PHONE_SETTING_CLOCK_TIME_FORMAT"/>
		<STRING id = "STR_PHONE_SETTING_CLOCK_TYPE_ANALOG"/>
		<STRING id = "STR_PHONE_SETTING_CLOCK_TYPE_DIGITAL_WHITE"/>
		<STRING id = "STR_PHONE_SETTING_CLOCK_TYPE_ROMAN_BLACK"/>
		<STRING id = "STR_PHONE_SETTING_CLOCK_TYPE_ROMAN_WHITE"/>
		<STRING id = "STR_PHONE_SETTING_CLOCK_TYPE_DIGITAL_RED"/>
		<STRING id = "STR_PHONE_SETTING_12_FORMAT"/>
		<STRING id = "STR_PHONE_SETTING_24_FORMAT"/>
		<STRING id = "STR_TIME_AUTO_SYNC_ON"/>
		<STRING id = "STR_TIME_AUTO_SYNC_OFF"/>
		<STRING id = "STR_BACK_LIGHT_DISP"/>
		<STRING id = "STR_BACK_LIGHT_BRIGHNESS"/>
		<STRING id = "STR_SCREEN_TIME_OUT"/>
		<STRING id = "STR_SCREEN_TIME_OUT_STR5"/>
		<STRING id = "STR_SCREEN_TIME_OUT_STR10"/>
		<STRING id = "STR_SCREEN_TIME_OUT_STR15"/>
		<STRING id = "STR_SCREEN_TIME_OUT_STR30"/>
		<STRING id = "STR_SCREEN_TIME_OUT_STR60"/>
		<STRING id = "STR_BRIGHTNESS_1"/>
		<STRING id = "STR_BRIGHTNESS_2"/>
		<STRING id = "STR_BRIGHTNESS_3"/>
		<STRING id = "STR_BRIGHTNESS_4"/>
		<STRING id = "STR_BRIGHTNESS_5"/>
		<STRING id = "STR_MAIN_MENU_STYLE"/>
		<STRING id = "STR_MAIN_MENU_STYLE_1APP"/>
		<STRING id = "STR_MAIN_MENU_STYLE_4APPS"/>
		<STRING id = "STR_ID_ALM_SYNC"/>
		<STRING id = "STR_ID_TIME_SYNC"/>
		<STRING id = "STR_ID_HOTKNOT"/>
		<STRING id = "STR_ID_HOTKNOT_POWER"/>
		<STRING id = "STR_HOTKNOT_POWER_ON"/>
		<STRING id = "STR_HOTKNOT_POWER_OFF"/>
		<STRING id = "STR_ID_USE_TIPS"/>
		<STRING id = "STR_ID_HOTKNOT_TIP_STRING1"/>
		<STRING id = "STR_ID_HOTKNOT_TIP_STRING2"/>
		<STRING id = "STR_MENU_INTERNATIONAL"/>

#if defined(__MMI_PHB_LAST_NAME_FIELD__) && defined(__MMI_BT_PBAP_CLIENT__)

		<STRING id = "STR_PHB_NAME_DISPLAY"/>
		<STRING id = "STR_PHB_FIRST_NAME_FIRST"/>
		<STRING id = "STR_PHB_LAST_NAME_FIRST"/>
#endif		
#endif
...
<!-- VUI mainmenu effect string -->
...
#ifdef __MMI_WEARABLE_DEVICE__
    <IMAGE id = "IMG_SETTING_BRIGHTNESS_DECREASE">CUST_IMG_PATH"\\\\MainLCD\\\\wsettings\\\\Setting_decrease.png"</IMAGE>
    <IMAGE id = "IMG_SETTING_BRIGHTNESS_DECREASE_PRESSED">CUST_IMG_PATH"\\\\MainLCD\\\\wsettings\\\\Setting_decrease_pressed.png"</IMAGE>
    <IMAGE id = "IMG_SETTING_BRIGHTNESS_INCREASE">CUST_IMG_PATH"\\\\MainLCD\\\\wsettings\\\\Setting_increase.png"</IMAGE>
    <IMAGE id = "IMG_SETTING_BRIGHTNESS_INCREASE_PRESSED">CUST_IMG_PATH"\\\\MainLCD\\\\wsettings\\\\Setting_increase_pressed.png"</IMAGE>
...
#ifdef __MMI_WEARABLE_DEVICE_SETTING__
    <SCREEN id = "SRC_ID_PHNSET_SCREEN"/>
#endif
    ...
    #ifdef __MMI_WEARABLE_DEVICE__
		<SCREEN id = "GRP_ID_DISPLAY_MENU"/>
	  <SCREEN id = "SRC_ID_DISPLAY_SCREEN"/>
	  <SCREEN id = "GRP_ID_DISPLAY_SCREEN_TIME_OUT"/>
	  <SCREEN id = "SRC_ID_DISPLAY_SCREEN_TIME_OUT"/>
	  <SCREEN id = "GRP_ID_DISPLAY_BRIGHTNESS"/>
	  <SCREEN id = "SRC_ID_DISPLAY_BRIGHTNESS"/>
	  <SCREEN id = "GRP_ID_DISPLAY_MAINMENU_STYLE"/>
	  <SCREEN id = "SRC_ID_DISPLAY_MAINMENU_STYLE"/>
	  #endif
    ...
    <SCREEN id = "SCR_ID_PHNSET_SHORT_CUT"/>
#endif
#ifdef __MMI_WEARABLE_DEVICE_SETTING__
	  <SCREEN id = "GRP_ID_PHNSET_TIME_AUTO_SYNC"/>
	  <SCREEN id = "GRP_ID_LANGUAGE_MENU"/>
	  <SCREEN id = "SRC_ID_LANGUAGE_SCREEN"/>
	  <SCREEN id = "GRP_ID_PHNSET_LANGUAGE_AUTO_SYNC"/>
	  <SCREEN id = "GRP_ID_DISPLAY_MENU"/>
	  <SCREEN id = "SRC_ID_DISPLAY_SCREEN"/>
	  <SCREEN id = "GRP_ID_DISPLAY_SCREEN_TIME_OUT"/>
	  <SCREEN id = "SRC_ID_DISPLAY_SCREEN_TIME_OUT"/>
	  ...
	  <SCREEN id = "GRP_ID_DISPLAY_MAINMENU_STYLE"/>
	  <SCREEN id = "SRC_ID_DISPLAY_MAINMENU_STYLE"/>
	  <SCREEN id = "GRP_ID_ALM_AUTO_SYNC"/>
	  <SCREEN id = "GRP_ID_HOTKNOT_MENU"/>
	  <SCREEN id = "SRC_ID_HOTKNOT_SCREEN"/>
	  <SCREEN id = "GRP_ID_HOTKNOT_POWER_MENU"/>
	  <SCREEN id = "SRC_ID_HOTKNOT_POWER_SCREEN"/>
#if defined(__MMI_PHB_LAST_NAME_FIELD__) && defined(__MMI_BT_PBAP_CLIENT__)
		<SCREEN id = "GRP_ID_PHB_NAME_DISPLAY"/>
	#endif
#endif
    <!-- menu ------------------------------------------------------------------------------------->
    <!--------------------------------------------------------------------------------------------->
    ...
    <!--------------------------------------------------------------------------------------------->
#ifdef __MMI_WEARABLE_DEVICE_SETTING__
    <MENU id = "MENU9102_INITIAL_SETUP" type = "APP_SUB" str = "STR_PHONE_SETTING_CLOCK"  highlight = "HighlightPhnsetScr">
 					<MENUITEM_ID>MENU_ID_CLOCK_TYPE</MENUITEM_ID>
 				#ifdef __MMI_WEARABLE_DEVICE_ALARM_SYNC__	
 					<MENUITEM_ID>MENU_ID_ALARM_SYNC</MENUITEM_ID>
 				#endif
 					<MENUITEM_ID>MENU_ID_AUTO_SYNC</MENUITEM_ID>
 					<MENUITEM_ID>MENU9141_DATE</MENUITEM_ID>
 					<MENUITEM_ID>MENU9141_TIME</MENUITEM_ID>
 					<MENUITEM_ID>MENU_ID_SETTING_TIMEANDFORMAT</MENUITEM_ID>
		</MENU>
		<MENU id = "MENU_ID_SETTING_TIMEANDFORMAT" type = "APP_SUB" str = "STR_PHONE_SETTING_CLOCK_TIME_FORMAT" >
 					<MENUITEM id="MENU_ID_12_FORMAT" str="STR_PHONE_SETTING_12_FORMAT"></MENUITEM>
 					<MENUITEM id="MENU_ID_24_FORMAT" str="STR_PHONE_SETTING_24_FORMAT"></MENUITEM>
		</MENU>
		<MENU id = "MENU_ID_AUTO_SYNC" type = "APP_SUB" str = "STR_PHONE_SETTING_AUTO_SYNC" >
 					<MENUITEM id="MENU_ID_TIME_AUTO_SYNC_ON" str="STR_TIME_AUTO_SYNC_ON"></MENUITEM>
 					<MENUITEM id="MENU_ID_TIME_AUTO_SYNC_OFF" str="STR_TIME_AUTO_SYNC_OFF"></MENUITEM>
		</MENU>
		/*<MENUITEM id = "MENU_PHNSET_SETTING_LANGUAGE" str = "STR_MENU_LANGUAGE"/>*/
		<MENU id = "MENU_PHNSET_SETTING_LANGUAGE" type = "APP_SUB" str = "STR_MENU_INTERNATIONAL" highlight = "HighlightLanguageScr">
 					<MENUITEM_ID>MENU_ID_LANGUAGE_AUTO_SYNC</MENUITEM_ID>
 					<MENUITEM_ID>MENU_SETTING_LANGUAGE</MENUITEM_ID>
#if defined(__MMI_PHB_LAST_NAME_FIELD__) && defined(__MMI_BT_PBAP_CLIENT__)
 					<MENUITEM_ID>MENU_SETTING_PHB_NAME_DISPLAY</MENUITEM_ID>
 				#endif
		</MENU>
		<MENU id = "MENU_ID_LANGUAGE_AUTO_SYNC" type = "APP_SUB" str = "STR_PHONE_SETTING_AUTO_SYNC" >
 					<MENUITEM id="MENU_ID_LANGUAGE_AUTO_SYNC_ON" str="STR_TIME_AUTO_SYNC_ON"></MENUITEM>
 					<MENUITEM id="MENU_ID_LANGUAGE_AUTO_SYNC_OFF" str="STR_TIME_AUTO_SYNC_OFF"></MENUITEM>
		</MENU>
		<MENU id = "MENU_PHNSET_BACKLIGHT_DISP" type = "APP_SUB" str = "STR_BACK_LIGHT_DISP" highlight = "HighlightDisplayScr">
					<MENUITEM id="MENU_ID_MAIN_MENU_STYLE" str="STR_MAIN_MENU_STYLE"></MENUITEM>
 					<MENUITEM id="MENU_ID_BACK_LIGHT_BRIGHTNESS" str="STR_BACK_LIGHT_BRIGHNESS"></MENUITEM>
 					<MENUITEM id="MENU_ID_SCREEN_TIME_OUT" str="STR_SCREEN_TIME_OUT"></MENUITEM>
		</MENU>
#if defined(__MMI_PHB_LAST_NAME_FIELD__) && defined(__MMI_BT_PBAP_CLIENT__)
		<MENU id = "MENU_SETTING_PHB_NAME_DISPLAY" type = "APP_SUB" str = "STR_PHB_NAME_DISPLAY" >
 					<MENUITEM id="MENU_ID_PHB_FIRST_NAME_FIRST" str="STR_PHB_FIRST_NAME_FIRST"></MENUITEM>
 					<MENUITEM id="MENU_ID_PHB_LAST_NAME_FIRST" str="STR_PHB_LAST_NAME_FIRST"></MENUITEM>
		</MENU>
#endif
		
		<MENU id = "MENU_ID_ALARM_SYNC" type = "APP_SUB" str = "STR_ID_ALM_SYNC" >
 					<MENUITEM id="MENU_ID_ALARM_AUTO_SYNC_ON" str="STR_TIME_AUTO_SYNC_ON"></MENUITEM>
 					<MENUITEM id="MENU_ID_ALARM_AUTO_SYNC_OFF" str="STR_TIME_AUTO_SYNC_OFF"></MENUITEM>
		</MENU>
		<MENU id = "MENU_HOTKNOT_SETTING" type = "APP_SUB" str = "STR_ID_HOTKNOT" highlight = "HighlightHotknotScr">
					<MENUITEM_ID>MENU_HOTKNOT_POWER</MENUITEM_ID>
 					
		</MENU>
		<MENU id = "MENU_HOTKNOT_POWER" type = "APP_SUB" str = "STR_ID_HOTKNOT_POWER" >
 					<MENUITEM id="MENU_ID_HOTKNOT_POWER_ON" str="STR_HOTKNOT_POWER_ON"></MENUITEM>
 					<MENUITEM id="MENU_ID_HOTKNOT_POWER_OFF" str="STR_HOTKNOT_POWER_OFF"></MENUITEM>
		</MENU>
		<MENUITEM id="MENU_HOTKNOT_POWER" str="STR_ID_HOTKNOT_POWER"></MENUITEM>
		<MENUITEM id="MENU_SETTING_LANGUAGE" str="STR_MENU_LANGUAGE"/>
		<MENUITEM id="MENU_ID_CLOCK_TYPE" str="STR_PHONE_SETTING_CLOCK_TYPE"/>
 	  <MENUITEM id="MENU_ID_AUTO_SYNC" str="STR_PHONE_SETTING_AUTO_SYNC" />
 		<MENUITEM id="MENU9141_DATE" str="STR_PHONE_SETTING_CLOCK_DATE" />
 		<MENUITEM id="MENU9141_TIME" str="STR_PHONE_SETTING_CLOCK_TIME" />
 		//<MENUITEM id="MENU_ID_HOTKNOT_POWER_ON" str="STR_HOTKNOT_POWER_ON">
 		//<MENUITEM id="MENU_ID_HOTKNOT_POWER_OFF" str="STR_HOTKNOT_POWER_OFF">
...
<CACHEDATA type="byte" id="NVRAM_UPDATE_DATETIME_MODE" restore_flag="TRUE">
			<DEFAULT_VALUE> [0x00] </DEFAULT_VALUE>
			<DESCRIPTION> Byte Cache </DESCRIPTION>
	</CACHEDATA>
	<CACHEDATA type="double" id="NVRAM_RTC_TIME" restore_flag="TRUE">
				<DEFAULT_VALUE> [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00] </DEFAULT_VALUE>
				<DESCRIPTION> Curr RTC Sec Cache </DESCRIPTION>
		</CACHEDATA>
	<CACHEDATA type="byte" id="NVRAM_PHNSET_MAIN_MENU_STYLE" restore_flag="TRUE">
				<DEFAULT_VALUE> [0x01] </DEFAULT_VALUE>
				<DESCRIPTION> Byte Cache </DESCRIPTION>
			</CACHEDATA>
#ifdef __MMI_WEARABLE_DEVICE_SETTING__
	    <CACHEDATA type="byte" id="NVRAM_PHNSET_TIME_AUTO_SYNC_SETTING" restore_flag="TRUE">
		    <DEFAULT_VALUE> [0x00] </DEFAULT_VALUE>
		    <DESCRIPTION> Byte Cache </DESCRIPTION>
	    </CACHEDATA>
	    <CACHEDATA type="byte" id="NVRAM_PHNSET_LANGUAGE_AUTO_SYNC_SETTING" restore_flag="TRUE">
		    <DEFAULT_VALUE> [0x00] </DEFAULT_VALUE>
		    <DESCRIPTION> Byte Cache </DESCRIPTION>
	    </CACHEDATA>
	    <CACHEDATA type="byte" id="NVRAM_PHNSET_MAIN_MENU_STYLE" restore_flag="TRUE">
	    ...
	    <CACHEDATA type="byte" id="NVRAM_ALARM_AUTO_SYNC" restore_flag="TRUE">
		    <DEFAULT_VALUE> [0x01] </DEFAULT_VALUE>
		    <DESCRIPTION> Byte Cache </DESCRIPTION>
	    </CACHEDATA>
	    <CACHEDATA type="byte" id="NVRAM_HOTKNOT_SETTING" restore_flag="TRUE">
		    <DEFAULT_VALUE> [0x01] </DEFAULT_VALUE>
		    <DESCRIPTION> Byte Cache </DESCRIPTION>
	    </CACHEDATA>
#endif
...
#endif
#ifdef __MMI_WEARABLE_DEVICE_SETTING__
<RECEIVER id="EVT_ID_TIP_CONNECT" proc="mmi_tip_sync_connect_event_hdlr"/>
<RECEIVER id="EVT_ID_TIP_DISCONNECT" proc="mmi_tip_sync_disconnect_event_hdlr"/>
<RECEIVER id="EVT_ID_SRV_BT_NOTI_CONNECTION_STATUS_CHANGE" proc="setting_spp_conn_event_handler"/>
#endif
</APP>
