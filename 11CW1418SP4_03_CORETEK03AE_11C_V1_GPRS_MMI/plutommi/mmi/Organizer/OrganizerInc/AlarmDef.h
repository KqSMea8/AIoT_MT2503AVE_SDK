...
#include "AlarmProt.h"
#include "AlarmSlim.h"
#if 1//def __MMI_WEARABLE_DEVICE__
...
typedef enum
{ 
    //ALM_ALERT_VIBRATION_AND_RING,
    ALM_ALERT_RING,
    ALM_ALERT_VIBRATION,
    ALM_ALERT_VIBRATION_AND_RING
}ALARM_ALERT_TYPE_ENUM;
#else
#define ALM_ALERT_TYPE_SETTING_NUM 3
...
}mmi_alm_confirm_user_data_struct;
...
}swatch_alm_cell_info;

#ifdef __MMI_BT_NOTI_SRV__
extern void mmi_alm_sync(void *data);
#endif

#define BT_NOTIFY_SYNC_ALARM_SENDERR     "bnsrv_alarm"
#define BT_NOTIFY_SYNC_ALARM_RECEIVER "mtk_bnapk"
#define BT_NOTIFY_SYNC_ALARM_CMD "EXCD"
#else
typedef struct
{
	gdi_handle base_layer;
