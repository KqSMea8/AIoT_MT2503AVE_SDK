 ...
 * ------------------------------------------------------------ */
#ifdef __MTK_SENSOR_SUBSYS_SUPPORT__
 extern void sensor_subsys_initialize(void);
#endif 
...
MMI_BOOTUP_INIT_REG_BEGIN(EVT_ID_SRV_BOOTUP_NORMAL_INIT)
    ...
    MMI_BOOTUP_INIT_REG(mmi_cnmgr_app_init)
#endif
#endif /* __TCPIP__ */
...
/* under construction !*/
    ...
    MMI_BOOTUP_INIT_REG(mmi_dm_init)
    MMI_BOOTUP_INIT_REG(srv_dm_init)
...
//#endif
    ...
    MMI_BOOTUP_INIT_REG(mmi_frm_auto_rotate_listen_motion)
#endif    
#ifdef __MMI_TETHERING__
    MMI_BOOTUP_INIT_REG(srv_tethering_bootup_init)
#endif /* __MMI_TETHERING__ */
#ifdef __MMI_PNS__
    MMI_BOOTUP_INIT_ADP(srv_pns_init)
#endif
#ifdef __MMI_SSO__
    MMI_BOOTUP_INIT_ADP(srv_sso_init) 
#endif /* __MMI_SSO__ */
#ifdef __CLOUD_SUPPORT__    
    MMI_BOOTUP_INIT_REG(srv_cloud_init)
#endif

#ifdef __MMI_WEARABLE_DEVICE_SETTING__
	MMI_BOOTUP_INIT_REG(mmi_language_autosync_init)
#endif

#ifdef __MMI_BT_REMOTE_CAPTURE__
    MMI_BOOTUP_INIT_REG(mmi_bt_rmtcap_bootup_init)
#endif
#ifdef __MMI_WEARABLE_DEVICE_ALARM__
#ifdef __MMI_BT_NOTI_SRV__
	MMI_BOOTUP_INIT_REG(mmi_alm_auto_sync_init)
#endif
#endif

#ifdef __MMI_WEARABLE_DEVICE__
MMI_BOOTUP_INIT_REG(mmi_wr_bt_by_spp_int)
#endif

#ifdef __WIFI_SCAN_ONLY__
    MMI_BOOTUP_INIT_REG(wlan_scan_only_bootup)
#endif

#ifdef __WIFI_SCAN_ONLY_AT_CMD__
    MMI_BOOTUP_INIT_REG(srv_wlan_scan_only_init)
#endif

#ifdef __MMI_SPP_SUPPORT__
MMI_BOOTUP_INIT_REG(mmi_frm_log_via_usb_init)
#endif
...
MMI_BOOTUP_INIT_REG_BEGIN(EVT_ID_SRV_BOOTUP_BEFORE_IDLE)
    ...
    MMI_BOOTUP_INIT_REG(widget_init_evt_hdlr)
#endif
...
#ifdef __MMI_TELEPHONY_SUPPORT__
    MMI_BOOTUP_INIT_ADP(srv_phb_init)
#ifdef __MMI_CLOG_SLIM_FOR_MT6261__
    MMI_BOOTUP_INIT_ADP(srv_clog_init)
#endif /* __MMI_CLOG_SLIM_FOR_MT6261__ */
#endif /* __MMI_TELEPHONY_SUPPORT__ */
#if defined(__BT_PBAP_CLIENT__)
    MMI_BOOTUP_INIT_ADP(srv_phb_pbapc_init)
#endif
    ...
    MMI_BOOTUP_INIT_ADP(PushMail_MMI_Init)
#endif
...
/* under construction !*/
    ...
    MMI_BOOTUP_INIT_ADP(mmi_provbox_app_init)
#endif /* __MMI_PROV_MESSAGE_SUPPORT__ */

#ifdef __MMI_PROVISIONING_SERVICE_SUPPORT__
    MMI_BOOTUP_INIT_REG(srv_prov_serv_init)
#endif
...
//#ifdef __MMI_SRV_TODOLIST__	
    ...
    MMI_BOOTUP_INIT_REG(mmi_netset_init)
#endif /* __MMI_TELEPHONY_SUPPORT__ */
#ifdef __MMI_BT_MAP_CLIENT__
    MMI_BOOTUP_INIT_REG(srv_sms_btmapc_init)
#endif
#ifdef __MMI_AUDPLY_WALK_PLAY__
    MMI_BOOTUP_INIT_REG(srv_plc_init)
#endif

#ifdef __MMI_BT_NOTI_SRV__
    MMI_BOOTUP_INIT_REG(srv_mre_installer_init)
#endif
...
MMI_BOOTUP_INIT_REG_BEGIN(EVT_ID_SRV_BOOTUP_COMPLETED)
    ...
    MMI_BOOTUP_INIT_REG(mmi_shct_init)
#endif
    MMI_BOOTUP_INIT_REG(srv_reminder_on_bootup_notify)
    ...
    MMI_BOOTUP_INIT_REG(srv_data_lock_init)
#endif
#if defined(__SIM_HOT_SWAP_SUPPORT__) || defined(__SIM_RECOVERY_ENHANCEMENT__)
    MMI_BOOTUP_INIT_REG(mmi_secset_hpveri_on_bootup_completed)
#endif
#if defined(__MCAREV30__) ||defined(__MCARE_COMMON__)
    MMI_BOOTUP_INIT_REG(mmi_mcare_ready_init)
#endif
    MMI_BOOTUP_INIT_REG(srv_mre_appmgr_bootup_hdlr)
#ifdef __MMI_TELEPHONY_SUPPORT__
    MMI_BOOTUP_INIT_REG(mmi_phnset_download_cal_data_init)
#endif
#ifdef __MMI_MRE_AUTO_START__
    MMI_BOOTUP_INIT_REG(vm_bootup_launch_autostart_app_hdlr)
    MMI_BOOTUP_INIT_REG(mmi_safe_mode_autostart_evt_hdlr)
#endif

#if (defined(__IOT__)||defined(__MMI_MRE_AUTO_START__)) && !defined(__MMI_MRE_DISABLE_FMGR__)
      MMI_BOOTUP_INIT_REG(srv_mre_appmgr_bootup_iot_autostart_hdlr)
#endif 
    ...
    MMI_BOOTUP_INIT_ADP(srv_sns_bootup_init_completed_hdlr)
#endif /* __SOCIAL_NETWORK_SUPPORT__ */
#ifdef __MMI_SSO_OOBE__
    MMI_BOOTUP_INIT_REG(mmi_sso_bootup)
#endif
#ifdef __MMI_AUTO_KEYPAD_LOCK__
    MMI_BOOTUP_INIT_REG(mmi_slk_set_main_evt_hdlr)
#endif /* __MMI_AUTO_KEYPAD_LOCK__ */
#if defined(__MMI_BTBOX_NOLCD__) && defined(__MMI_LINE_IN__)
    MMI_BOOTUP_INIT_REG(mmi_linein_proc)
#endif  //defined(__MMI_BTBOX_NOLCD__) && defined(__MMI_LINE_IN__)
...
MMI_BOOTUP_INIT_REG_BEGIN(EVT_ID_SRV_BOOTUP_EARLY_INIT)
	...
	MMI_BOOTUP_INIT_ADP(srv_um_service_init)
    ...
    MMI_BOOTUP_INIT_ADP(srv_mms_jsr_init)
#endif /* __MMI_MMS_2__ */
#if (defined (__MOD_SMSAL__) && defined(__MMI_TELEPHONY_SUPPORT__))
    MMI_BOOTUP_INIT_ADP(InitMessageProtocolEventHandlers)
#ifdef __UM_SUPPORT__
    MMI_BOOTUP_INIT_ADP(mmi_sms_um_sap_init)
#endif /* __UM_SUPPORT__ */
    ...
    MMI_BOOTUP_INIT_ADP(mmi_mobilevideo_init)
#endif
    MMI_BOOTUP_INIT_ADP(srv_phb_init_protocol)
    /*
    ...
    MMI_BOOTUP_INIT_ADP(mmi_sat_app_init)
    MMI_BOOTUP_INIT_ADP(srv_sat_init)
    MMI_BOOTUP_INIT_ADP(InitCPHS)
#ifdef __MMI_SML_MENU__
    MMI_BOOTUP_INIT_ADP(mmi_sml_init)
#endif
...
#endif /* __MMI_TELEPHONY_SUPPORT__ */
#ifdef __TCPIP__
    /* CNMGR SRV should be initialized before Call Log App and EM App because they will use CNMGR SRV functionality in init stage */
    MMI_BOOTUP_INIT_REG(srv_cnmgr_init)
#endif
    ...
    MMI_BOOTUP_INIT_ADP(srv_tcard_init)
#endif
...
/* under construction !*/
    ...
    /* Initialize mre application */
    MMI_BOOTUP_INIT_ADP(vm_mre_init)
/* Initialize mre application */
    MMI_BOOTUP_INIT_REG(srv_mre_appmgr_init)    
#endif
#ifdef __MMI_PHNSET_APPICON_SUPPORT__
    MMI_BOOTUP_INIT_ADP(mmi_phnset_appicon_init)
#endif 
    MMI_BOOTUP_INIT_ADP(srv_setting_common_init)
    MMI_BOOTUP_INIT_ADP(mmi_phnset_init)
#ifdef __FM_AT_SUPPORT__
    MMI_BOOTUP_INIT_ADP(mmi_fm_atcommand_init)
#endif
#ifdef __MMI_BT_SUPPORT__
    ...
    MMI_BOOTUP_INIT_ADP(srv_ble_cm_init)
#endif
    //MMI_BOOTUP_INIT_ADP(bt_switch_mode_app_init)//add by
#ifdef __NFC_SUPPORT__
    MMI_BOOTUP_INIT_ADP(mmi_nfc_setting_init)
    ...
    MMI_BOOTUP_INIT_ADP(srv_nitz_init)
#endif

#ifdef __NTPD_SUPPORT__
    MMI_BOOTUP_INIT_ADP(srv_ntp_init)
#endif
...
#ifdef WAP_SUPPORT
#if !defined(__IOT__)
    MMI_BOOTUP_INIT_REG(mmi_wap_prof_app_init)
#endif
#endif /* WAP_SUPPORT */
#ifdef __MMI_MMS_BGSR_SUPPORT__
    MMI_BOOTUP_INIT_ADP(srv_mms_bgsr_init)
#endif
...
/* under construction !*/
    ...
    MMI_BOOTUP_INIT_ADP(srv_wap_push_inbox_init) /* For Generic Push Inbox */
...
//#ifdef __MRE_AM__
    ...
    MMI_BOOTUP_INIT_REG(srv_alm_init)
...
#endif
    MMI_BOOTUP_INIT_ADP(srv_speech_set_mode_volume)
#ifdef __MMI_TELEPHONY_SUPPORT__
...
#ifdef __MMI_TELEPHONY_SUPPORT__
    MMI_BOOTUP_INIT_REG(srv_netset_init)
#endif /* __MMI_TELEPHONY_SUPPORT__ */
    ...
    MMI_BOOTUP_INIT_ADP(srv_setting_init_general_setting)
#ifdef __SOCIAL_NETWORK_SUPPORT__
    MMI_BOOTUP_INIT_ADP(srv_sns_init)
#endif /* __SOCIAL_NETWORK_SUPPORT__ */
#ifdef __MMI_SAFE_MODE__
    MMI_BOOTUP_INIT_REG(mmi_safe_mode_main_evt_hdlr)
#endif
#ifdef __LCD_COLOR_ENGINE_SUPPORT__
    MMI_BOOTUP_INIT_ADP(mmi_phnset_picture_quality_init) /* For Picture Quality*/
#endif

#ifdef __BT_GATTS_PROFILE__ 
    MMI_BOOTUP_INIT_ADP(srv_gatts_init)
#endif
#ifdef __BT_GATTC_PROFILE__ 
    MMI_BOOTUP_INIT_ADP(srv_gattc_init)
#endif

#ifdef __MMI_BT_NOTI_SRV__
    MMI_BOOTUP_INIT_ADP(srv_bt_noti_recv_init)
    MMI_BOOTUP_INIT_ADP(srv_bt_noti_data_init)
#endif

#if defined(__MMI_BT_NOTIFICATION__) || defined(__MMI_BT_NOTI_SRV__)
    MMI_BOOTUP_INIT_ADP(mmi_bt_notification_init)
#endif
#if defined(__MMI_BTBOX_NOLCD__)//__MMI_FRM_INPUT_EVT__
	MMI_BOOTUP_INIT_ADP(mmi_frm_input_event_init)
	MMI_BOOTUP_INIT_ADP(mmi_frm_input_event_check_info_tbl)
#endif/**/


#if defined(__MMI_BLE_PXP_SUPPORT__)
	MMI_BOOTUP_INIT_ADP(mmi_pxpapp_server_init)
#endif/*__MMI_BLE_PXP_SUPPORT__*/

#if defined(__IOT_BLE_BKSS_SUPPORT__)
	MMI_BOOTUP_INIT_ADP(mmi_bkssapp_server_init)
#endif/*__IOT_BLE_BKSS_SUPPORT__*/

#if defined(__MMI_BLE_FMP_SUPPORT__)
	MMI_BOOTUP_INIT_ADP(mmi_fmpapp_client_init)
	//MMI_BOOTUP_INIT_ADP(mmi_fmpapp_server_init)
#endif

#ifdef __FUDIFFNET_ENABLE__
    MMI_BOOTUP_INIT_ADP(srv_fudiffnet_init)
#endif

#ifdef __FUNET_ENABLE__
    MMI_BOOTUP_INIT_ADP(srv_funet_init)
#endif

#ifdef __MMI_BT_NOTI_SRV__
    MMI_BOOTUP_INIT_ADP(srv_bt_push_recv_init)
#endif

#if defined(__MMI_BLE_ANP_SUPPORT__)
	MMI_BOOTUP_INIT_ADP(mmi_anpapp_client_init)
#endif/*__MMI_BLE_ANP_SUPPORT__*/

#ifdef __MMI_BLE_ANCS_SUPPORT__
    MMI_BOOTUP_INIT_ADP(srv_ancs_init)
...
//#endif
    ...
    MMI_BOOTUP_INIT_ADP(srv_sogps_adp_bootup_init)
#endif

#if defined (__MMI_WEARABLE_DEVICE__) && !defined(__MMI_A2DP_SUPPORT__)
#ifdef __BT_GATTC_PROFILE__ 
    MMI_BOOTUP_INIT_ADP(mmi_bt_music_client_int)
#endif
#endif

#ifdef __MMI_BLE_TIP_SUPPORT__
    MMI_BOOTUP_INIT_ADP(mmi_tipc_init)
#endif

#ifdef __MMI_ONE_KEY_SOS_SUPPORT__
MMI_BOOTUP_INIT_ADP(srv_oksos_init)
#endif /* __MMI_ONE_KEY_SOS_SUPPORT__ */

/*Battery Service*/
#ifdef __MMI_BLE_BAS_SUPPORT__ 	
    MMI_BOOTUP_INIT_ADP(bas_bootup_init)
#endif

#ifdef __MMI_HEART_RATE_SUPPORT__ 	
    MMI_BOOTUP_INIT_ADP(mmi_heart_rate_init)
#endif

#ifdef __MMI_BLOOD_PRESSURE_SUPPORT__ 	
    MMI_BOOTUP_INIT_ADP(mmi_blood_pressure_init)
#endif

#ifdef __MTK_TARGET__ 
#ifdef __MTK_SENSOR_SUBSYS_SUPPORT__
	MMI_BOOTUP_INIT_ADP(sensor_subsys_initialize)
#endif
#endif
