...
#ifdef __MRE_PACKAGE_NONE__
    <IMAGE id = "IMG_SI_MRE_DEFAULT" force_type = "FORCE_ABM">CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp"</IMAGE>;
    <IMAGE id = "IMG_SI_MRE_FETION" force_type = "FORCE_ABM">CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp"</IMAGE>;
    <IMAGE id = "IMG_SI_MRE_MSN" force_type = "FORCE_ABM">CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp"</IMAGE>;
    <IMAGE id = "IMG_SI_MRE_PUSHMAIL" force_type = "FORCE_ABM">CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp"</IMAGE>;
    <IMAGE id = "IMG_SI_MRE_QQ" force_type = "FORCE_ABM">CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp"</IMAGE>;
    <IMAGE id = "IMG_SI_MRE_PUSH" force_type = "FORCE_ABM">CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp"</IMAGE>;
#else
