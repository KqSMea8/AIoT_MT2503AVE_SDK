...
#if 0
/* under construction !*/
#endif /* added for customized title background image */
...
#if defined ( __MMI_MAINLCD_128X32__) || defined ( __MMI_MAINLCD_128X128__) || defined ( __MMI_MAINLCD_128X160__) ||  defined (__MMI_MAINLCD_176X220__) ||  defined (__MMI_MAINLCD_480X800__)
