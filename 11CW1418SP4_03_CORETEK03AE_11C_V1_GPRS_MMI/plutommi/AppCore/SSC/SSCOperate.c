...
static mmi_ret mmi_imei_grp_proc(mmi_event_struct *evt)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
void SSCHandleIMEI(void)
{
	...
	mmi_frm_group_create_ex(GRP_ID_ROOT, SCR_ID_DUMMY, mmi_imei_grp_proc, NULL, MMI_FRM_NODE_SMART_CLOSE_FLAG);
	scrn_dummy_entry();
#endif
