...
extern void mmi_fm_version_menu_item_highlight(cui_menu_event_struct *evt)
{
    ...
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
#ifndef __MMI_WEARABLE_DEVICE_FACTORY_MODE__
...
#endif /*__MMI_WEARABLE_DEVICE_FACTORY_MODE__*/
}
#ifdef __MMI_WEARABLE_DEVICE_FACTORY_MODE__
/*****************************************************************************
 * FUNCTION
 *  mmi_fm_select_version
 * DESCRIPTION
 *  
 * PARAMETERS
 *  void        
 ...
 *  void
 *****************************************************************************/
extern void mmi_fm_select_version(cui_menu_event_struct *evt)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    memset(version_cntx->UnicodeDisplayBuf, 0, sizeof(version_cntx->UnicodeDisplayBuf));
	
	mmi_ucs2cat((CHAR*) version_cntx->UnicodeDisplayBuf, (const CHAR*)GetString(STR_ID_FM_SW_VER));
	mmi_ucs2cat((CHAR*) version_cntx->UnicodeDisplayBuf, (CHAR*)L"\n");
	...
	mmi_ucs2cat((CHAR*) version_cntx->UnicodeDisplayBuf, (const CHAR*)GetString(STR_ID_FM_BUILD_TIME));
	mmi_ucs2cat((CHAR*) version_cntx->UnicodeDisplayBuf, (CHAR*)L"\n");
	memset(tempbuf, 0, sizeof(tempbuf));
	...
	mmi_ucs2cat((CHAR*) version_cntx->UnicodeDisplayBuf, (const CHAR*)GetString(STR_ID_FM_ISN));
	mmi_ucs2cat((CHAR*) version_cntx->UnicodeDisplayBuf, (CHAR*)L"\n");
	memset(tempbuf, 0, sizeof(tempbuf));
	mmi_asc_to_ucs2((CHAR*) tempbuf, (CHAR*) version_cntx->gBarCode);  
  	mmi_ucs2cat((CHAR*) version_cntx->UnicodeDisplayBuf, (const CHAR*)tempbuf);
	mmi_ucs2cat((CHAR*) version_cntx->UnicodeDisplayBuf, (CHAR*)L"\n");
...
extern void mmi_fm_version_pre_hint(cui_menu_event_struct *evt)
{
    ...
    MMI_ID tab[2] ={
       MENU_ID_FM_SW_VER,               
       MENU_ID_FM_ISN}; 
#else /*__MMI_WEARABLE_DEVICE_FACTORY_MODE__*/
	MMI_ID tab[8] ={
	MENU_ID_FM_SW_VER,				 
