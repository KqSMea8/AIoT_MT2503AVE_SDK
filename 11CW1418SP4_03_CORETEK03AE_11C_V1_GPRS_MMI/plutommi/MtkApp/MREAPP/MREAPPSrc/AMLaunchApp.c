...
#ifdef __MMI_MRE_ALL_SENSOR_INIT__
extern const __align(4) U8 all_sensor_init_vxp[];
#endif
...
#ifdef __MMI_MRE_ALL_SENSOR_INIT__
    {APPID_ALL_SENSOR_INIT, NULL, NULL, all_sensor_init_vxp},
#endif
...
#ifdef __MMI_MRE_ALL_SENSOR_INIT__
static void mmi_am_la_launch_all_sensor_init(void)
{
    mmi_am_launch_app_by_id(APPID_ALL_SENSOR_INIT);
}
    
void mmi_am_la_highlight_all_sensor_init(void)
{
	NULL;
}
#endif
