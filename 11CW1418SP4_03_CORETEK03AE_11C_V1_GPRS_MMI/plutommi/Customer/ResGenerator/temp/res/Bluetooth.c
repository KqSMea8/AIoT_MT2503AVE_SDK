...
<APP id="APP_BLUETOOTH" 
    ...
    #if defined( __MMI_BTBOX_NOLCD__) || defined(__FORCE_DISABLE_NOTIFICATION_POPUP__)  || defined(__IOT_BLE_BKSS_SUPPORT__)
    ...
    <RECEIVER id="EVT_ID_WEARABLE_DEVICE_MOVE_RIGHT" proc="mmi_bt_dialer_move_right_hdlr"/>
...
#if defined(__MMI_BT_APPLICATION_BQB__) && defined(__MMI_WEARABLE_DEVICE__)
    <STRING id="STR_BT_OPPC_CONN_TEST"/>
#endif
...
/*    <STRING id="STR_BT_DEV_SET_BLOCK_LIST"/> */
    ...
    <STRING id="STR_BT_CONN_SERVICE"/>
    <STRING id="STR_BT_NO_SERVICE"/>
...
/*    <STRING id="STR_BT_AUDIO_SCO_DISCON"/> */
    ...
    <INPUT_EVENT grp_id="GRP_ID_BT_ANTI_LOST_IND" grp_desc="SP abnormal disc" evt_id="EVT_BTB_RECONN_RESTART_D" evt_desc="start reconnect" key_code="KEY_2" key_type="KEY_EVENT_UP"/>
   #ifdef __MMI_BTB_AT_KEY_SUPPORT__
    ...
    <AUDIO id="AUD_BTB_SRC2_LOST" desc="SP2 Device Lost" path="BT_Lost.mp3">CUST_ADO_PATH"\\\\BTBOX\\\\BT_Lost.mp3"</AUDIO>
    <AUDIO id="AUD_BTB_SRC2_ABDISCONNECT" desc="SP2 abnormal disc" path="BT_Abdisc.mp3">CUST_ADO_PATH"\\\\BTBOX\\\\BT_Abnomal_Disc.mp3"</AUDIO>
    <AUDIO id="AUD_BTB_SRC2_RECONNECT" desc="SP2 reconnection" path="BT_Reconnect.mp3">CUST_ADO_PATH"\\\\BTBOX\\\\BT_Reconnect.mp3"</AUDIO>
    <AUDIO id="AUD_BTB_SRC2_RECONNECT_FINISH" desc="SP2 reconnect finish" path="BT_Recoonect_OK.mp3">CUST_ADO_PATH"\\\\BTBOX\\\\BT_Recoonect_OK.mp3"</AUDIO>

    <NOTIFY id="NOTIFY_BTB_SRC2_LOST" desc="SP2 Device Lost" led="INPUT_EVENT_LED_ID_19" vib="INPUT_EVENT_VIB_INDX_0" voice="AUD_BTB_SRC2_LOST"/>
    <NOTIFY id="NOTIFY_BTB_SRC2_ABDISCONNECT" desc="SP2 abnormal disc" led="INPUT_EVENT_LED_ID_19" vib="INPUT_EVENT_VIB_INDX_0" voice="AUD_BTB_SRC2_ABDISCONNECT"/>
    <NOTIFY id="NOTIFY_BTB_SRC2_RECONNECT" desc="reconnect SP2" led="INPUT_EVENT_LED_ID_18"/>
    <NOTIFY id="NOTIFY_BTB_SRC2_RECONN_FINISH" desc="finish reconnect SP2" voice="AUD_BTB_SRC2_RECONNECT_FINISH"/>
   #endif
  #endif /* __MMI_BT_ANTI_LOST_BY_RSSI__ */
#endif 
...
/*    <STRING id="STR_BT_BROWSE_IMAGES"/> */
  ...
  #ifdef __MMI_WEARABLE_DEVICE__
  	<STRING id="STR_BT_REMOTE_CTRL_PLAY_PAUSE"/>
  	<STRING id="STR_BT_REMOTE_CTRL_PREV_SONG"/>
  	<STRING id="STR_BT_REMOTE_CTRL_NEXT_SONG"/>
  	<STRING id="STR_BT_REMOTE_CTRL_VOL_UP"/>
  	<STRING id="STR_BT_REMOTE_CTRL_VOL_DOWN"/>
  	<STRING id="STR_BT_REMOTE_CTRL_UP_ARROW"/>
  	<STRING id="STR_BT_REMOTE_CTRL_DOWN_ARROW"/>
  	<STRING id="STR_BT_REMOTE_CTRL_LEFT_ARROW"/>
  	<STRING id="STR_BT_REMOTE_CTRL_RIGHT_ARROW"/>
  	<STRING id="STR_BT_REMOTE_CTRL_ENTER"/>
  	<STRING id="STR_BT_REMOTE_CAPTURE"/>
#ifdef __MMI_BT_APPLICATION_BQB__
	<STRING id = "STR_BT_REMOTE_CTRL_MOUSE_POINTER">Mouse Pointer</STRING>
	<STRING id = "STR_BT_REMOTE_CTRL_LEFT">Left</STRING>
	<STRING id = "STR_BT_REMOTE_CTRL_UP">Up</STRING>
	<STRING id = "STR_BT_REMOTE_CTRL_DOWN">Down</STRING>
	<STRING id = "STR_BT_REMOTE_CTRL_RIGHT">Right</STRING>
	<STRING id = "STR_BT_REMOTE_CTRL_LEFT_BUTTON">LeftButton</STRING>
	<STRING id = "STR_BT_REMOTE_CTRL_RIGHT_BUTTON">RightButton</STRING>
#endif
...
/*    <STRING id="STR_OPP_OBJ_FROM"/> */
   ...
   <STRING id="STR_BT_PROF_MAP"/>  
    ...
    <STRING id="STR_BT_HEADSET_CONN_PROMPT"/>
		...
		<STRING id="STR_BT_CONN_SINGLE_CONNECTING"/>
...
<IMAGE id="IMG_BT_MENU_TITLE" >CUST_IMG_PATH"\\\\MainLCD\\\\Bluetooth\\\\SB_BT.png"</IMAGE>
...
#if (defined(__MMI_HIDD_SUPPORT__) && !defined(__MMI_WEARABLE_DEVICE__))
...
#endif  /* defined(__MMI_HIDD_SUPPORT__) && !defined(__MMI_WEARABLE_DEVICE__)*/
    ...
    <IMAGE id="IMG_BPP_TB_ZOOM_OUT_DISABLED" >CUST_IMG_PATH"\\\\MainLCD\\\\ToolBar\\\\BPP\\\\TB_zoom_out_dis.png"</IMAGE>
		...
		<IMAGE id="IMG_WRISTBAND_BT_ON" >CUST_IMG_PATH"\\\\MainLCD\\\\Bluetooth\\\\BT_ON.bmp"</IMAGE>
		<IMAGE id="IMG_WRISTBAND_BT_OFF" >CUST_IMG_PATH"\\\\MainLCD\\\\Bluetooth\\\\BT_OFF.bmp"</IMAGE>
#endif		
    <!------------------------------------------------------Menu Resource Area------------------------------------------------------>
...
#if defined(__MMI_BT_APPLICATION_BQB__) && defined(__MMI_WEARABLE_DEVICE__)
    <MENU id="MENU_OPPC_CONN_TEST" str="STR_BT_OPPC_CONN_TEST" img="IMG_BT_SET"/>
#endif /* defined(__MMI_WEARABLE_DEVICE__) && defined(__MMI_BT_APPLICATION_BQB__) */
...
#endif
#ifdef __MMI_WEARABLE_DEVICE__
    <STRING id="STR_BT_SWATCH_SETTING"/>
    <STRING id="STR_BT_SCH_RESULT_TILE"/>
    <STRING id="STR_BT_DELETE_CONFIRM"/>
    <STRING id="STR_BT_SCH_ING"/>
#endif
...
/* visibility configuration menu */
...
#ifdef __MMI_WEARABLE_DEVICE__
    <MENU id="MENU_CONN_BT_MAIN" type="APP_SUB" str="STR_BT_SWATCH_SETTING" img="IMG_BT_MENU_TITLE" highlight="mmi_bt_main_hilight_handler"
    ...
    <MENU id="MENU_CONN_BT_MAIN" type="APP_SUB" str="STR_GLOBAL_BLUETOOTH" img="IMG_BT_MENU_TITLE" highlight="mmi_bt_main_hilight_handler"
      shortcut="ON" shortcut_img="IMG_BT_MENU_TITLE" launch="mmi_bt_entry_main_menu">             
        ...
        #if defined(__MMI_BT_APPLICATION_BQB__) && defined(__MMI_WEARABLE_DEVICE__)
        <MENUITEM_ID>MENU_OPPC_CONN_TEST</MENUITEM_ID>
        #endif
    ...
    <SCREEN id="GRP_ID_BT_AUTO_CONNECT"/>
    /* common screen id */        
...
#endif
#ifdef __MMI_WEARABLE_DEVICE__	
<SCREEN id="SRC_ID_BT_SETTING"/>

#endif
#ifdef __MMI_WRISTBAND_SUPPORT__
		<SCREEN id="SRC_ID_BT_WB_SETTING"/>
#endif
...
/*__MMI_BT_SPP_SERVER_MULTI_LINK_SUPPORT__*/
    ...
    <RECEIVER id="SRV_LE_CM_EVENT_CONNECT_CNF" proc="mmi_bt_le_update_status_icon"/>
    <RECEIVER id="SRV_LE_CM_EVENT_DISCONNECT_CNF" proc="mmi_bt_le_update_status_icon"/>
#endif
 #endif
