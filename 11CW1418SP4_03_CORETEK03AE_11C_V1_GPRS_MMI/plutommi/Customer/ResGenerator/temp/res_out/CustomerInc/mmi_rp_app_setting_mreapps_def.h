 ...
 * Filename:
 * ---------
 *   mmi_rp_app_setting_mreapps_def.h
 *
 * Project:
 * --------
 *   MAUI
...
#ifndef _MMI_RP_APP_SETTING_MREAPPS_DEF_H
#define _MMI_RP_APP_SETTING_MREAPPS_DEF_H
...
typedef enum
{
    ...
    MMI_RP_APP_SETTING_MREAPPS_STR_MAX
}mmi_rp_app_setting_mreapps_str_enum;
...
typedef enum
{
    ...
    MMI_RP_APP_SETTING_MREAPPS_SCR_MAX
}mmi_rp_app_setting_mreapps_scr_enum;
/******************** Screen resource IDs - finish ********************/
/******************** Template resource IDs - Begin ********************/
/******************** Template resource IDs - End ********************/


#endif /* _MMI_RP_APP_SETTING_MREAPPS_DEF_H */
