...
typedef enum
{
    MENU_ID_EDITOR_OPT_INPUT_METHOD = 23468 + 1, /* BASE_ID + 1 */
    MENU_ID_EDIT_OPTS,
...
typedef enum
{
    STR_INPUT_METHOD_MENU_INSERT_SYMBOLS = 23468 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    GRP_ID_PHNSET_HANDWRITING = 23468 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    NVRAM_IME_SMART_MODE_CONFIG = 23468 + 1, /* BASE_ID + 1 */   /*         BYTE */ 
