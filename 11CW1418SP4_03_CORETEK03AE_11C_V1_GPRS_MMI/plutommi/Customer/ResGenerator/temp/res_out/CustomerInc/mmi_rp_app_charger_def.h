...
typedef enum
{
    STR_LOW_BATTERY = 11632 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    GRP_ID_CHARGER_ROOT = 11632 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    LOW_BATTERY_SCR_TIMER = 11632 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    IMG_ID_CHARGER_CHARGING = 11632 + 1, /* BASE_ID + 1 */
    IMG_ID_CHARGER_DONE,
