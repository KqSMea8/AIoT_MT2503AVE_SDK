...
#ifndef _MMI_RP_SRV_FLIGHT_MODE_DEF_H
#define _MMI_RP_SRV_FLIGHT_MODE_DEF_H
...
typedef enum
{
    ...
    MMI_RP_SRV_FLIGHT_MODE_STR_MAX
}mmi_rp_srv_flight_mode_str_enum;
...
#endif /* _MMI_RP_SRV_FLIGHT_MODE_DEF_H */
