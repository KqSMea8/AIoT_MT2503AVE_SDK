...
#ifndef _MMI_RP_APP_SS_DEF_H
#define _MMI_RP_APP_SS_DEF_H
...
typedef enum
{
    ...
    STR_ID_SS_PERIOD,
    STR_ID_SS_SECOND,
    STR_ID_SS_CHANGE_PSW_SUC,
    STR_ID_SS_CANCELLED,
    MMI_RP_APP_SS_STR_MAX
}mmi_rp_app_ss_str_enum;
...
typedef enum
{
    ...
    GRP_ID_SS_SIM4,
    GRP_ID_SS_SIM4_USSR,
    SCR_ID_SS_REQUESTING,
    SCR_ID_SS_USSR,
    SCR_ID_SS_USSN,
    SCR_ID_SS_RESULT,
    MMI_RP_APP_SS_SCR_MAX
}mmi_rp_app_ss_scr_enum;
