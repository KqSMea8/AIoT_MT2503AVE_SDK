...
# 3 "temp/res/editor.c" 2
# 1 "../customerinc/custresdef.h" 1
# 207 "../customerinc/custresdef.h"
# 1 "../../mmi/inc/MMI_features.h" 1
# 208 "../customerinc/custresdef.h" 2
# 4 "temp/res/editor.c" 2
# 1 "../../framework/commonscreens/commonscreensinc/CommonScreensResDef.h" 1
# 347 "../../framework/commonscreens/commonscreensinc/CommonScreensResDef.h"
# 1 "../../mmi/inc/MMI_features.h" 1
# 348 "../../framework/commonscreens/commonscreensinc/CommonScreensResDef.h" 2
...
# 349 "../../framework/commonscreens/commonscreensinc/CommonScreensResDef.h" 2
# 1 "../../mmi/inc/GlobalDefs.h" 1
# 69 "../../mmi/inc/GlobalDefs.h"
# 1 "../../mmi/inc/GlobalResDef.h" 1
# 455 "../../mmi/inc/GlobalResDef.h"
typedef enum _mmi_scenario_evt_enum
{
    EVT_ID_POST_CB_RST = (1) + 1,
    ...
    EVT_ID_GROUP_REDRAW_START,
    EVT_ID_GROUP_REDRAW_DONE,
    ...
    EVT_ID_WGUI_LSK_CLICK,
    EVT_ID_WGUI_RSK_CLICK,
    EVT_ID_WGUI_CSK_CLICK,
    ...
    EVT_ID_MMI_AP_DCM_UNLOAD,
        ...
        EVT_ID_INPUT_EVENT_COMMON_START,
        EVT_ID_BTB_CHANGE_VISIBILITY,
        EVT_ID_BTB_CONNECT,
        EVT_ID_INPUT_EVENT_COMMON_END,


        EVT_ID_BTB_START,
        EVT_ID_BTB_DISCONNECT,
        EVT_ID_BTB_RESET,

        EVT_ID_BTB_END,


        EVT_ID_INPUT_EVENT_LOCAL_START,
    ...
    EVT_ID_INPUT_EVENT_LAUNCH_AUDPLY,
# 648 "../../mmi/inc/GlobalResDef.h"
        EVT_ID_INPUT_EVENT_LOCAL_END,
# 662 "../../mmi/inc/GlobalResDef.h"
    EVT_ID_SCENARIO_MAX
...
typedef enum _STR_GLOBAL_LIST_ENUM
{
    ...
    STR_GLOBAL_DONE,
    STR_GLOBAL_DOWNLOAD,
    STR_GLOBAL_DOWNLOAD_ASK,
    STR_GLOBAL_DOWNLOADING,
    STR_GLOBAL_DRAFTS,
    STR_GLOBAL_DRM_FILE_EXISTS,
    STR_GLOBAL_DRM_FS_ERROR,
    STR_GLOBAL_DRM_INVALID_FORMAT,
    STR_GLOBAL_DRM_NON_DRM,
    STR_GLOBAL_DRM_PROCESSING,
    STR_GLOBAL_DRM_PROHIBITED,
    STR_GLOBAL_DRM_RO_RECEIVED,
    STR_GLOBAL_DRM_SIZE_TOO_BIG,
    STR_GLOBAL_EARPHONE_IN,
    STR_GLOBAL_EARPHONE_OUT,
    STR_GLOBAL_EDIT,
    ...
    STR_GLOBAL_HTTP,
    STR_GLOBAL_INBOX,
    STR_GLOBAL_INCOMING_CALL,
    STR_GLOBAL_INPUT_METHOD,
    STR_GLOBAL_INPUT_METHOD_OPTIONS,
    STR_GLOBAL_INSERT_SIM_CARD,
    STR_GLOBAL_INSTALL,
    STR_GLOBAL_INSUFFICIENT_MEMORY,
    STR_GLOBAL_INVALID,
    STR_GLOBAL_INVALID_DATA_ACCOUNT,
    STR_GLOBAL_INVALID_EMAIL_ADDRESS,
    STR_GLOBAL_INVALID_EMAIL_ADDRESSES,
    STR_GLOBAL_INVALID_FILENAME,
    STR_GLOBAL_INVALID_FORMAT,
    STR_GLOBAL_INVALID_INPUT,
    STR_GLOBAL_INVALID_NUMBER,
    STR_GLOBAL_INVALID_NUMBERS,
    STR_GLOBAL_INVALID_RECIPIENTS,
    ...
    STR_GLOBAL_MC_REMOVED,
    STR_GLOBAL_MC_INSERTED,
    STR_GLOBAL_OTG_REMOVED_USE_PHONE,
    STR_GLOBAL_OTG_REMOVED_USE_PHONE_QUERY,
    STR_GLOBAL_OTG_REMOVED,
    STR_GLOBAL_OTG_CONNECTED,
    STR_GLOBAL_NOT_AVAILABLE_IN_MASS_STORAGE_MODE,
    STR_GLOBAL_NO_NUMBER,

    STR_GLOBAL_SUNDAY,
    STR_GLOBAL_MONDAY,
    STR_GLOBAL_TUESDAY,
    STR_GLOBAL_WEDNESDAY,
    STR_GLOBAL_THURSDAY,
    STR_GLOBAL_FRIDAY,
    STR_GLOBAL_SATURDAY,

    STR_GLOBAL_SUNDAY_SHORT,
    STR_GLOBAL_MONDAY_SHORT,
    STR_GLOBAL_TUESDAY_SHORT,
    STR_GLOBAL_WEDNESDAY_SHORT,
    STR_GLOBAL_THURSDAY_SHORT,
    STR_GLOBAL_FRIDAY_SHORT,
    STR_GLOBAL_SATURDAY_SHORT,

    STR_GLOBAL_JANUARY_SHORT,
    STR_GLOBAL_FEBRUARY_SHORT,
    STR_GLOBAL_MARCH_SHORT,
    STR_GLOBAL_APRIL_SHORT,
    STR_GLOBAL_MAY_SHORT,
    STR_GLOBAL_JUNE_SHORT,
    STR_GLOBAL_JULY_SHORT,
    STR_GLOBAL_AUGEST_SHORT,
    STR_GLOBAL_SEPTEMBER_SHORT,
    STR_GLOBAL_OCTOBER_SHORT,
    STR_GLOBAL_NOVEMBER_SHORT,
    STR_GLOBAL_DECEMBER_SHORT,
...
typedef enum _IMG_GLOBAL_LIST_ENUM
{
    ...
    IMG_GLOBAL_DEFAULT,
    IMG_GLOBAL_PROGRESS,
    IMG_GLOBAL_LOADING = IMG_GLOBAL_PROGRESS,
    IMG_GLOBAL_ERROR,
    IMG_GLOBAL_UNFINISHED = IMG_GLOBAL_ERROR,
    IMG_GLOBAL_INFO,
    IMG_GLOBAL_EMPTY = IMG_GLOBAL_INFO,
    IMG_VICON,
    IMG_GLOBAL_CLEAR,
    ...
    IMG_GLOBAL_SUCCESS,
    IMG_GLOBAL_ACTIVATED = IMG_GLOBAL_SUCCESS,
    IMG_GLOBAL_FAIL,
...
{
    ADO_GLOBAL_EMPTYAUDIO = (1),
    ADO_GLOBAL_EMPTYAUDIO_EXT,
    ADO_GLOBAL_NOAUDIO,
    ADO_GLOBAL_DEFAULT,
...
{
    BINARY_GLOBAL_NO_BINARY = (1),
    BINARY_GLOBAL_TOTAL
}BINARY_GLOBAL_LIST_ENUM;
# 1267 "../../mmi/inc/GlobalResDef.h"
typedef enum
{
    INPUT_EVENT_APP_INDX_AUDPLY,
        ...
        INPUT_EVENT_APP_INDX_LOCAL_END,
}mmi_input_event_app_indx_enum;
...
typedef enum
{
        INPUT_EVENT_LED_ID_DUMMY,
        INPUT_EVENT_LED_ID_0,
        INPUT_EVENT_LED_ID_1,
        INPUT_EVENT_LED_ID_2,
        INPUT_EVENT_LED_ID_3,
        INPUT_EVENT_LED_ID_4,
        INPUT_EVENT_LED_ID_5,
        INPUT_EVENT_LED_ID_6,
        INPUT_EVENT_LED_ID_7,
        INPUT_EVENT_LED_ID_8,
        INPUT_EVENT_LED_ID_9,
        INPUT_EVENT_LED_ID_10,
        INPUT_EVENT_LED_ID_11,
        INPUT_EVENT_LED_ID_12,
        INPUT_EVENT_LED_ID_13,
        INPUT_EVENT_LED_ID_14,
        INPUT_EVENT_LED_ID_15,
        INPUT_EVENT_LED_ID_16,
        INPUT_EVENT_LED_ID_17,
        INPUT_EVENT_LED_ID_18,
        INPUT_EVENT_LED_ID_19,
        INPUT_EVENT_LED_ID_20,
        INPUT_EVENT_LED_ID_21,
        INPUT_EVENT_LED_ID_22,
        INPUT_EVENT_LED_ID_23,
        INPUT_EVENT_LED_ID_24,

        INPUT_EVENT_LED_ID_CUSTOM_0,
        INPUT_EVENT_LED_ID_CUSTOM_1,
        INPUT_EVENT_LED_ID_CUSTOM_2,
        INPUT_EVENT_LED_ID_CUSTOM_3,
        INPUT_EVENT_LED_ID_CUSTOM_4,


        INPUT_EVENT_LED_ID_END,
}mmi_input_event_led_enum;
...
typedef enum
{
        INPUT_EVENT_VIB_INDX_DUMMY,
        INPUT_EVENT_VIB_INDX_0,
        INPUT_EVENT_VIB_INDX_1,
        INPUT_EVENT_VIB_INDX_2,
        INPUT_EVENT_VIB_INDX_3,
        INPUT_EVENT_VIB_INDX_4,

        INPUT_EVENT_VIB_INDX_CUSTOM_0,
        INPUT_EVENT_VIB_INDX_CUSTOM_1,
        INPUT_EVENT_VIB_INDX_CUSTOM_2,
        INPUT_EVENT_VIB_INDX_CUSTOM_3,
        INPUT_EVENT_VIB_INDX_CUSTOM_4,


        INPUT_EVENT_VIB_IND_END,
}mmi_input_event_vib_enum;
# 70 "../../mmi/inc/GlobalDefs.h" 2
# 350 "../../framework/commonscreens/commonscreensinc/CommonScreensResDef.h" 2
# 358 "../../framework/commonscreens/commonscreensinc/CommonScreensResDef.h"
typedef enum _common_screen_event_enum
{
    EVT_ID_POPUP_QUIT = ((U16) RESOURCE_BASE_SRV_COMMON_SCREENS),
    EVT_ID_ALERT_QUIT = EVT_ID_POPUP_QUIT,
    EVT_ID_POPUP_REQ,
        EVT_ID_ALERT_ENTER,

    EVT_ID_POPUP_END
}mmi_common_screen_event_enum;



    typedef enum
    {
                SCR_FSEDITOR = ((U16) RESOURCE_BASE_SRV_COMMON_SCREENS),
                SCR_FSEDITOR_OPTIONS,
        SCR_POPUP_SCREEN,
        SCR_POPUP_SCREEN_1,
        SCR_CONFIRM_SCREEN,
        ...
        SCR_INPUT_METHOD_LIST,
        SCR_INPUT_METHOD_LIST_END = SCR_INPUT_METHOD_LIST + 5 - 1,
        SCR_INPUT_METHOD_OPTIONS,
        SCR_INPUT_METHOD_OPTIONS_END = SCR_INPUT_METHOD_OPTIONS + 5 -1 ,
        SCR_INPUT_METHOD_WRITING_LANGUAGES,
        SCR_INPUT_METHOD_WRITING_LANGUAGES_END = SCR_INPUT_METHOD_WRITING_LANGUAGES + 5 -1,
        SCR_INPUT_METHOD_MAIN_WRITING_LANGUAGES,
        SCR_INPUT_METHOD_MAIN_WRITING_LANGUAGES_END = SCR_INPUT_METHOD_MAIN_WRITING_LANGUAGES + 5 -1 ,
        SCR_INPUT_METHOD_SUB_WRITING_LANGUAGES,
        SCR_INPUT_METHOD_SUB_WRITING_LANGUAGES_END= SCR_INPUT_METHOD_MAIN_WRITING_LANGUAGES + 5 -1 ,
        SCR_INPUT_METHOD_ADVANCED_OPTIONS,
        SCR_INPUT_METHOD_ADVANCED_OPTIONS_END = SCR_INPUT_METHOD_ADVANCED_OPTIONS + 5 -1 ,
        SCR_INPUT_METHOD_KEYBOARD_TYPE,
        SCR_INPUT_METHOD_KEYBOARD_TYPE_END = SCR_INPUT_METHOD_KEYBOARD_TYPE + 5 -1 ,
        ...
        SCR_ID_CASCADING_MENU_END = SCR_ID_CASCADING_MENU_BASE + 7,
        SCR_ID_INPUT_METHOD_VK_POPUP_LIST,
        SCR_ID_INPUT_METHOD_VK_POPUP_LIST_END = SCR_ID_INPUT_METHOD_VK_POPUP_LIST + 5 - 1,
        SCR_ID_MTV_IME_POPUP_ID,
        SCR_COMMON_SCREENS_END
    } SCREENID_LIST_COMMON_SCREENS;
# 475 "../../framework/commonscreens/commonscreensinc/CommonScreensResDef.h"
typedef enum
{
# 489 "../../framework/commonscreens/commonscreensinc/CommonScreensResDef.h"
    COMMONSCREENS_IME_ADVANCEDOPTIONS_TOTAL

}imeadvancedoptions_enum;


typedef enum
{
# 512 "../../framework/commonscreens/commonscreensinc/CommonScreensResDef.h"
    COMMONSCREENS_IME_OPTIONS_TOTAL
}imeoptions_enum;
...
typedef enum
{
    ...
    COMMONSCREENS_KEYPAD_QWERTY,
    COMMONSCREENS_KEYPAD_TOTAL
}keypadtype_enum;
    typedef enum
    {

        GRP_ID_CASCADING_MENU = SCR_ID_CASCADING_MENU_BASE,
    } grp_id_cascading_enum;
# 5 "temp/res/editor.c" 2
