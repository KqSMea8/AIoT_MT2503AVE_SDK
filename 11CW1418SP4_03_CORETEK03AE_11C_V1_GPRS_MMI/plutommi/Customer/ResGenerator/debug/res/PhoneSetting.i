# 1 "temp/res/PhoneSetting.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "temp/res/PhoneSetting.c"
# 478 "temp/res/PhoneSetting.c"
...
# 482 "temp/res/PhoneSetting.c" 2
# 1 "../../mmi/mainmenu/mainmenuinc/MainMenuDef.h" 1
# 323 "../../mmi/mainmenu/mainmenuinc/MainMenuDef.h"
# 1 "../../mmi/inc/MMI_features.h" 1
# 324 "../../mmi/mainmenu/mainmenuinc/MainMenuDef.h" 2
...
# 327 "../../mmi/mainmenu/mainmenuinc/MainMenuDef.h" 2
# 397 "../../mmi/mainmenu/mainmenuinc/MainMenuDef.h"
enum MAIN_MENU_IMG_ID
{
    IMG_MAIN_MENU_BG = ((U16) RESOURCE_BASE_APP_MAINMENU) + 1,

    IMG_SUBLCD_SYSTEM_SHUTDOWN,
# 412 "../../mmi/mainmenu/mainmenuinc/MainMenuDef.h"
...
# 668 "temp/res/PhoneSetting.c"
    <!-- font size setting menu ---------------------------------------------------------->
# 680 "temp/res/PhoneSetting.c"
    <!-- UART setting string -->
...
# 776 "temp/res/PhoneSetting.c"
    <!-- Dial style string -->
# 787 "temp/res/PhoneSetting.c"
...
# 876 "temp/res/PhoneSetting.c"
    <!-- main menu style string-->
# 910 "temp/res/PhoneSetting.c"
...
# 959 "temp/res/PhoneSetting.c"
    <!-- image ------------------------------------------------------------------------------------>
    <!--------------------------------------------------------------------------------------------->

    <!-- phone setting image----------------------------------------------------------------------->
    <IMAGE id = "IMG_SETTING_PHONE">"..\\\\..\\\\Customer\\\\Images\\\\PLUTO128X32""\\\\MainLCD\\\\SubMenu\\\\Settings\\\\SB_SPH.bmp"</IMAGE>
# 972 "temp/res/PhoneSetting.c"
    <!-- greeting text image -->
    ...
    <IMAGE id = "IMG_SCR_SETTING_CAPTION">"..\\\\..\\\\Customer\\\\Images\\\\PLUTO128X32""\\\\MainLCD\\\\TitleBar\\\\TB_ST.PNG"</IMAGE>
...
# 1694 "temp/res/PhoneSetting.c"
    <!--------------------------------------------------------------------------------------------->
    <!-- call back function------------------------------------------------------------------------>
    <!--------------------------------------------------------------------------------------------->
# 1710 "temp/res/PhoneSetting.c"
</APP>
