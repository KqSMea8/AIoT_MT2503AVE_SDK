# 1 "temp/res/Profiles.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "temp/res/Profiles.c"
# 245 "temp/res/Profiles.c"
...
# 246 "temp/res/Profiles.c" 2
# 1 "../customerinc/custresdef.h" 1
# 207 "../customerinc/custresdef.h"
# 1 "../../mmi/inc/MMI_features.h" 1
# 208 "../customerinc/custresdef.h" 2
# 247 "temp/res/Profiles.c" 2
# 1 "../../../custom/drv/misc_drv/coretek03ae_11c_bb/custom_equipment.h" 1
# 201 "../../../custom/drv/misc_drv/coretek03ae_11c_bb/custom_equipment.h"
...
# 202 "../../../custom/drv/misc_drv/coretek03ae_11c_bb/custom_equipment.h" 2
# 223 "../../../custom/drv/misc_drv/coretek03ae_11c_bb/custom_equipment.h"
...
# 319 "../../../custom/drv/misc_drv/coretek03ae_11c_bb/custom_equipment.h"
...
# 364 "../../../custom/drv/misc_drv/coretek03ae_11c_bb/custom_equipment.h"
extern kal_uint8 custom_cfg_outward_gpio_port
(
 kal_uint8 gpio_device_id
 );
...
# 353 "temp/res/Profiles.c"
    <STRING id="STR_ID_PROF_RING_VOL"/>
# 366 "temp/res/Profiles.c"
...
# 391 "temp/res/Profiles.c"
    <STRING id="STR_ID_PROF_KEYPAD_VOL"/>
# 402 "temp/res/Profiles.c"
    <STRING id="STR_ID_PROF_SYSTEM_ALERT"/>
# 422 "temp/res/Profiles.c"
    <STRING id="STR_ID_PROF_CHANGE"/>

    <STRING id="STR_ID_PROF_SELECT_FROM_FILE"/>

    <STRING id="STR_ID_PROF_FILE_TOO_LARGE"/>
# 443 "temp/res/Profiles.c"
    <STRING id="STR_ID_PROF_QUESTION_MARK"/>
# 477 "temp/res/Profiles.c"
    <!-----------------------------------------------------Image Resource Area------------------------------------------------------>
# 511 "temp/res/Profiles.c"
    <IMAGE id="IMG_ID_PROF_ACTIVATED" >"..\\\\..\\\\Customer\\\\Images\\\\PLUTO128X32""\\\\MainLCD\\\\UIElement\\\\checkbox\\\\CK_V.BMP"</IMAGE>
