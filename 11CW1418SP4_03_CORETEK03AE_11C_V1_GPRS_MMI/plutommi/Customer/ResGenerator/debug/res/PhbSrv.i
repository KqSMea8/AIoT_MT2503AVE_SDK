...
<APP id="SRV_PHB">
    ...
    <!-----------------------------------------------------Image Resource Area------------------------------------------------------>
# 257 "temp/res/PhbSrv.c"
    <IMAGE id="IMG_PHB_DEFAULT">"..\\\\..\\\\Customer\\\\Images\\\\PLUTO128X32""\\\\MainLCD\\\\Call\\\\Connect\\\\CL_NET.png"</IMAGE>
    ...
    <!------------------------------------------------------Menu Resource Area------------------------------------------------------>
        ...
        <SENDER id="EVT_ID_PHB_PBAPC_SYNC_STATUS_UPDATE" hfile="PhbSrvGprot.h"/>
        <SENDER id="EVT_ID_PHB_PBAPC_SYNC_DATA_CLEAR" hfile="PhbSrvGprot.h"/>
        <SENDER id="EVT_ID_PHB_PBAPC_NOTIFY" hfile="PhbSrvGprot.h"/>
        <SENDER id="EVT_ID_PBAP_NOTIFY" hfile="PhbSrvGprot.h"/>
  <SENDER id="EVT_ID_TIP_UPDATE_TIME" hfile="PhbSrvGprot.h"/>
  <SENDER id="EVT_ID_TIP_CONNECT" hfile="PhbSrvGprot.h"/>
  <SENDER id="EVT_ID_TIP_DISCONNECT" hfile="PhbSrvGprot.h"/>
  <SENDER id="EVT_ID_GATT_UPDATE_TF" hfile="PhbSrvGprot.h"/>
# 303 "temp/res/PhbSrv.c"
    <!------------------------------------------------------NARAM Resource---------------------------------------------------------->
...
# 364 "temp/res/PhbSrv.c"
                        <OPTION hint="All"> [0x06, 0x00] </OPTION>
# 384 "temp/res/PhbSrv.c"
        </FIELD>
    </CACHEDATA>
    ...
    <CACHEDATA type="short" id="NVRAM_PHB_PBAPC_NAME_ORDER" restore_flag="TRUE">
        <DEFAULT_VALUE> [0x11, 0x11] </DEFAULT_VALUE>
        <DESCRIPTION> PBAPC NAME ORDER </DESCRIPTION>
    </CACHEDATA>
