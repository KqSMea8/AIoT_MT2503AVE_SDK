# 1 "temp/res/IdleNotificationManager.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "temp/res/IdleNotificationManager.c"
# 96 "temp/res/IdleNotificationManager.c"
...
# 97 "temp/res/IdleNotificationManager.c" 2
# 1 "../customerinc/CustResDef.h" 1
# 207 "../customerinc/CustResDef.h"
# 1 "../../mmi/inc/MMI_features.h" 1
# 208 "../customerinc/CustResDef.h" 2
# 98 "temp/res/IdleNotificationManager.c" 2
...
# 131 "temp/res/IdleNotificationManager.c"
    <!----- Image Resource Area ----------------------------------------------->
