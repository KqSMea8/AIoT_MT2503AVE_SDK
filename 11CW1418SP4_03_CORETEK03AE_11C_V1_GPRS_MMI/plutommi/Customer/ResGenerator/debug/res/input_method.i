...
# 3 "temp/res/input_method.c" 2
# 1 "../customerinc/custresdef.h" 1
# 207 "../customerinc/custresdef.h"
# 1 "../../mmi/inc/MMI_features.h" 1
# 208 "../customerinc/custresdef.h" 2
# 4 "temp/res/input_method.c" 2

# 1 "../../mmi/inc/CustomCfg.h" 1
# 6 "temp/res/input_method.c" 2





# 1 "../../../venusmmi/framework/ui_core/base/vfx_config.h" 1
# 211 "../../../venusmmi/framework/ui_core/base/vfx_config.h"
...
# 212 "../../../venusmmi/framework/ui_core/base/vfx_config.h" 2
# 12 "temp/res/input_method.c" 2
...
# 47 "temp/res/input_method.c"
    <STRING id="STR_INPUT_METHOD_NUMERIC"/>
# 1087 "temp/res/input_method.c"
    <!-----------------------------------------------------Image Resource Area------------------------------------------------------>
# 1113 "temp/res/input_method.c"
    <!-----------------------------------------------------Theme Resource Area----------------------------------------------------->
# 1182 "temp/res/input_method.c"
<!-----------------------------------------------------Event Section------------------------------------------------------>
