...
int main(int argc, char* argv[])
{
	...
	AddFont(
		...
		MCT_SMALL_FONT | MCT_SUBLCD_FONT | MCT_MEDIUM_FONT | MCT_LARGE_FONT | MCT_DIALER_FONT, 0, 0);
    ...
    #endif
#endif /*__MMI_WRISTBAND_SUPPORT__*/
    ...
    AddFont(
        ("English"), ("*#0044#"), ("en-US"), 
        FONT_DATA_FILE_PATH(Latin\\pluto_medium.bdf),
        MCT_LARGE_FONT | MCT_MEDIUM_FONT, 0, 0);
    //AddFont(
        //("English"), ("*#0044#"), ("en-US"), 
...
AddFont(
	...
	AddFont(
		("Chinesec"), ("*#0086#"), ("zh-CN"), 
		FONT_DATA_FILE_PATH(Chinese\\GB2312_14.bdf), 
		MCT_SMALL_FONT | MCT_MEDIUM_FONT | MCT_LARGE_FONT | MCT_SUBLCD_FONT |MCT_DIALER_FONT, 
		1, 0);
	AddFont(
		("Chineset"), ("*#0886#"), ("zh-TW"), 
		FONT_DATA_FILE_PATH(Chinese\\uM13x14_14.bdf), 
		MCT_SMALL_FONT | MCT_MEDIUM_FONT | MCT_LARGE_FONT | MCT_SUBLCD_FONT |MCT_DIALER_FONT, 
		1, 0);
