...
const unsigned short  mtk_CurrMaxAudioNumEXT=15;
#include "CustAdoDataHWExt.h"
const CUSTOM_AUDIO	mtk_nCustAudioNamesEXT[]={
(U8*)&________CUSTOMER__AUDIO__EMPTYAUDIO_MP3_,
(U8*)&________CUSTOMER__AUDIO__PLUTO__USERPROFILES__TONE__POWER_ON_MP3_,
...
(U8*)&________CUSTOMER__AUDIO__PLUTO__USERPROFILES__TONE__YOUR_CODE_TIP_MP3_,
(U8*)&________CUSTOMER__AUDIO__PLUTO__USERPROFILES__TONE__OPEN_MP3_,
(U8*)&________CUSTOMER__AUDIO__PLUTO__USERPROFILES__TONE__CLOSE_MP3_,
(U8*)&________CUSTOMER__AUDIO__PLUTO__USERPROFILES__TONE__WARN_MP3_,
...
const CUSTPACK_AUDIO_HEADER mtk_audio_header={15, (CUSTOM_AUDIO *)mtk_nCustAudioNamesEXT};