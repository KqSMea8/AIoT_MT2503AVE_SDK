...
#if !defined(__MMI_FTE_SUPPORT__) && (defined (__MMI_MAINLCD_240X320__) ||  defined (__MMI_MAINLCD_320X320__) ||  defined (__MMI_MAINLCD_240X240__) || defined (__MMI_MAINLCD_320X240__)) && defined (__MMI_TOUCH_DIAL_SCREEN__)
const U8 category16[] = 
{
    5,
    DM_NEW_LAYER_START,
...
/* 061507 128x160 touch Start */
#elif defined (__MMI_MAINLCD_176X220__) || defined (__MMI_MAINLCD_240X320__) || defined (__MMI_MAINLCD_320X320__) || defined (__MMI_MAINLCD_240X240__) ||  defined (__MMI_MAINLCD_320X240__) || defined (__MMI_MAINLCD_240X400__)
...
const S16 coordinate_set63[] = 
{
	...
	0, 0, MMI_POP_UP_DIALOG_WIDTH, MMI_POP_UP_DIALOG_HEIGHT, DM_NO_FLAGS, 
    ...
    MMI_POP_UP_DIALOG_GAP, MMI_POP_UP_DIALOG_GAP, MMI_POP_UP_DIALOG_WIDTH - 2*MMI_POP_UP_DIALOG_GAP, MMI_POP_UP_DIALOG_HEIGHT - MMI_POP_UP_DIALOG_GAP,
    DM_ALLIGNED_AREA_NO_BACK_FILL | DM_ALLIGNED_AREA_EQUAL_SPACE_TOP_AND_BOTTOM,
    DM_DUMMY_COORDINATE,
    DM_DUMMY_COORDINATE,
...
const S16 coordinate_set103[] = 
{
	...
	0, CAT103_SINGLE_LINE_INPUTBOX_Y, MAIN_LCD_DEVICE_WIDTH, 30, DM_NO_FLAGS,  /* DM_SINGLELINE_INPUTBOX1 */
#elif  defined(__MMI_MAINLCD_320X320__) && defined(__MMI_FTE_SUPPORT__)   
	0, CAT103_SINGLE_LINE_INPUTBOX_Y, MAIN_LCD_DEVICE_WIDTH, 30, DM_NO_FLAGS,  /* DM_SINGLELINE_INPUTBOX1 */	
#else
...
const S16 coordinate_set105[] = 
{
    ...
    DM_FULL_SCREEN_COORDINATE_FLAG, DM_FULL_SCREEN_COORDINATE_FLAG
};
...
#elif defined(__MMI_MAINLCD_320X480__) || defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_320X320__) || defined(__MMI_MAINLCD_240X240__) || defined(__MMI_MAINLCD_176X220__) || defined(__MMI_MAINLCD_128X160__)
const U8 category105[] = 
{
    6,
    DM_BASE_LAYER_START,
...
#if defined(__MMI_WEARABLE_DEVICE__)//add by xl
...
const S16 coordinate_set165[] = 
{
	...
	0, 0, MMI_POP_UP_DIALOG_WIDTH, MMI_POP_UP_DIALOG_HEIGHT - MMI_SW_BUTTON_BAR_HEIGHT, DM_NO_FLAGS, 
#else
	0, 0, MMI_POP_UP_DIALOG_WIDTH, MMI_POP_UP_DIALOG_HEIGHT, DM_NO_FLAGS, 
#endif /*__MMI_WEARABLE_DEVICE_UI_ENHANCE__*/
	//WGUI_POPUP_FTE_AREA_X, MMI_POP_UP_DIALOG_Y + UI_POPUP_BORDER_SIZE - 20, MAIN_LCD_DEVICE_WIDTH - 2*WGUI_POPUP_FTE_AREA_X, MMI_POP_UP_DIALOG_FULL_HEIGHT - UI_POPUP_BORDER_SIZE*2,
     //   DM_ALLIGNED_AREA_FOR_POPUP_FTE | DM_ALLIGNED_AREA_NO_BACK_FILL | DM_ALLIGNED_AREA_EQUAL_SPACE_TOP_AND_BOTTOM,
    MMI_POP_UP_DIALOG_GAP, MMI_POP_UP_DIALOG_GAP, MMI_POP_UP_DIALOG_WIDTH - 2*MMI_POP_UP_DIALOG_GAP, MMI_POP_UP_DIALOG_HEIGHT - MMI_SW_BUTTON_BAR_HEIGHT - MMI_POP_UP_DIALOG_GAP,
     DM_ALLIGNED_AREA_NO_BACK_FILL | DM_ALLIGNED_AREA_EQUAL_SPACE_TOP_AND_BOTTOM,
    DM_DUMMY_COORDINATE,
    DM_DUMMY_COORDINATE,
    0, MAIN_LCD_DEVICE_HEIGHT - MMI_SW_BUTTON_BAR_HEIGHT, MAIN_LCD_DEVICE_WIDTH, MMI_SW_BUTTON_BAR_HEIGHT,
         DM_NO_FLAGS, MMI_SOFTKEY_WIDTH,       /* Button Bar */
};
#else 
#if defined(__MMI_MAINLCD_128X64__)
...
#ifdef __MMI_WEARABLE_DEVICE__	
#if defined(__MMI_MAINLCD_128X128__)
    0, MMI_SMALL_SW_STATUS_ICON_BAR_HEIGHT, MAIN_LCD_DEVICE_WIDTH, MAIN_LCD_DEVICE_HEIGHT - MMI_SMALL_SW_STATUS_ICON_BAR_HEIGHT,  DM_NO_FLAGS,
	DM_DEFAULT_STATUS_BAR_FLAG,
#else
#ifdef __MMI_WEARABLE_DEVICE_UI_ENHANCE__
	0, 0, MAIN_LCD_DEVICE_WIDTH, MAIN_LCD_DEVICE_HEIGHT - MMI_SW_BUTTON_BAR_HEIGHT, DM_NO_FLAGS,
	0, MAIN_LCD_DEVICE_HEIGHT - MMI_SW_BUTTON_BAR_HEIGHT, MAIN_LCD_DEVICE_WIDTH, MMI_SW_BUTTON_BAR_HEIGHT,
                DM_NO_FLAGS, MMI_SOFTKEY_WIDTH,       /* Button Bar */
#else
	0, 0, MAIN_LCD_DEVICE_WIDTH, MAIN_LCD_DEVICE_HEIGHT - MMI_SW_BUTTON_BAR_HEIGHT - 1, DM_NO_FLAGS,
	0, MAIN_LCD_DEVICE_HEIGHT - MMI_SW_BUTTON_BAR_HEIGHT, MAIN_LCD_DEVICE_WIDTH, MMI_SW_BUTTON_BAR_HEIGHT,
                DM_BUTTON_DISABLE_BACKGROUND, MMI_SOFTKEY_WIDTH,       /* Button Bar */
#endif /*__MMI_WEARABLE_DEVICE_UI_ENHANCE__*/
#endif /*__MMI_MAINLCD_128X128__*/
#else	
    DM_DUMMY_COORDINATE,            /* control area */
...
#else /* __MMI_MAINLCD_320X240__ */
#ifdef __MMI_FTE_SUPPORT__
#if defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_320X320__) || defined(__MMI_MAINLCD_240X240__) || defined(__MMI_MAINLCD_320X240__)
const U8 category280[] = 
{
#ifdef __WGUI_CAT280_SUPPORT_MMS__
    7,
...
#else
#if defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_320X320__) || defined(__MMI_MAINLCD_240X240__) || defined(__MMI_MAINLCD_240X400__)
const U8 category307[] = 
{
    5,
    DM_BASE_LAYER_START,
...
#if defined(__MMI_MAINLCD_176X220__) || defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_320X320__) || defined(__MMI_MAINLCD_240X240__) ||defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__) || defined(__MMI_MAINLCD_320X240__) 
...
#if defined ( __MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_320X320__) || defined(__MMI_MAINLCD_240X240__) ||defined ( __MMI_MAINLCD_240X400__) || defined ( __MMI_MAINLCD_320X480__) || defined ( __MMI_MAINLCD_360X640__) 
...
#if defined ( __MMI_MAINLCD_128X32__) || defined ( __MMI_MAINLCD_128X128__) || defined ( __MMI_MAINLCD_128X160__) ||  defined (__MMI_MAINLCD_176X220__)
...
const S16 coordinate_set6333[] = 
{
    ...
    MMI_POP_UP_DIALOG_GAP, MMI_POP_UP_DIALOG_GAP, MMI_POP_UP_DIALOG_WIDTH - 2*MMI_POP_UP_DIALOG_GAP, MAIN_LCD_DEVICE_HEIGHT - MMI_SW_BUTTON_BAR_HEIGHT - 2*MMI_POP_UP_DIALOG_GAP, DM_NO_FLAGS,
    
    //MMI_POP_UP_DIALOG_GAP, MMI_POP_UP_DIALOG_GAP + CAT6333_CONTROL_AREA1_HEIGHT, MMI_POP_UP_DIALOG_WIDTH - 2*MMI_POP_UP_DIALOG_GAP, CAT6333_INPUTBOX_HEIGHT, DM_NO_FLAGS,
	
	//MMI_POP_UP_DIALOG_GAP, MMI_POP_UP_DIALOG_GAP + CAT6333_CONTROL_AREA1_HEIGHT + CAT6333_INPUTBOX_HEIGHT + CAT6333_INPUTBOX_AREA2_GAP, MMI_POP_UP_DIALOG_WIDTH - 2*MMI_POP_UP_DIALOG_GAP, CAT6333_CONTROL_AREA2_HEIGHT, DM_NO_FLAGS,

	//0, MAIN_LCD_DEVICE_HEIGHT - MMI_SW_BUTTON_BAR_HEIGHT - 1, MAIN_LCD_DEVICE_WIDTH, 1, DM_NO_FLAGS, 
    #ifdef __MMI_WEARABLE_DEVICE_UI_ENHANCE__ 
	0, MAIN_LCD_DEVICE_HEIGHT - MMI_SW_BUTTON_BAR_HEIGHT, MAIN_LCD_DEVICE_WIDTH, MMI_SW_BUTTON_BAR_HEIGHT,
                DM_NO_FLAGS, MMI_SOFTKEY_WIDTH,
	#else
	0, MAIN_LCD_DEVICE_HEIGHT - MMI_SW_BUTTON_BAR_HEIGHT, MAIN_LCD_DEVICE_WIDTH, MMI_SW_BUTTON_BAR_HEIGHT,
                DM_BUTTON_DISABLE_BACKGROUND, MMI_SOFTKEY_WIDTH,
    #endif /*__MMI_WEARABLE_DEVICE_UI_ENHANCE__*/
...
const S16 coordinate_set6335[] = 
{
    ...
    0, 0, MMI_POP_UP_DIALOG_WIDTH, MMI_POP_UP_DIALOG_HEIGHT, DM_NO_FLAGS,   
    #endif /*__MMI_WEARABLE_DEVICE_UI_ENHANCE__*/
    MMI_POP_UP_DIALOG_GAP, MMI_POP_UP_DIALOG_GAP, MMI_POP_UP_DIALOG_WIDTH - 2*MMI_POP_UP_DIALOG_GAP, \
    MAIN_LCD_DEVICE_HEIGHT - MMI_SW_BUTTON_BAR_HEIGHT - MMI_POP_UP_DIALOG_GAP * 3, DM_NO_FLAGS,
    //Line
//	0, MAIN_LCD_DEVICE_HEIGHT - MMI_SW_BUTTON_BAR_HEIGHT - 1, MAIN_LCD_DEVICE_WIDTH, 1, DM_NO_FLAGS, 
	#ifdef __MMI_WEARABLE_DEVICE_UI_ENHANCE__
    0, MAIN_LCD_DEVICE_HEIGHT - MMI_SW_BUTTON_BAR_HEIGHT, MAIN_LCD_DEVICE_WIDTH, MMI_SW_BUTTON_BAR_HEIGHT,
...
#if defined(__MMI_MAINLCD_128X128__)
const U8 wearable_list_menu_category[] = 
{
    4,
    DM_BASE_LAYER_START,
    DM_SCR_BG,
...
const S16 wearable_list_coordinate_set[] = 
{
    DM_FULL_SCREEN_COORDINATE_FLAG,
  //  DM_DEFAULT_STATUS_BAR_FLAG,
    DM_DEFAULT_STATUS_BAR_FLAG,
    0, MMI_SMALL_SW_STATUS_ICON_BAR_HEIGHT, MAIN_LCD_DEVICE_WIDTH, MAIN_LCD_DEVICE_HEIGHT - MMI_SMALL_SW_STATUS_ICON_BAR_HEIGHT,   
	DM_CENTRE_ALIGN_X | DM_CENTER_ALIGN_Y,
};
#endif /*__MMI_MAINLCD_128X128__*/
#endif  //__MMI_WEARABLE_DEVICE__

#ifdef __MMI_WEARABLE_DEVICE_NOTI_UI_ENHANCE__
const U8 category52_no_title[] = 
{
    3,
    DM_BASE_LAYER_START,
    DM_SCR_BG,
...
const S16 coordinate_set52_no_title[] = 
{
    DM_FULL_SCREEN_COORDINATE_FLAG,
    //MMI_SUBMENU_CONTENT_X, MMI_SUBMENU_CONTENT_Y, MMI_SUBMENU_CONTENT_WIDTH, MMI_SUBMENU_CONTENT_HEIGHT, DM_CENTRE_ALIGN_X | DM_CENTER_ALIGN_Y
    DM_SUBMENU_CONTENT_COORDINATE, DM_CENTRE_ALIGN_X | DM_CENTER_ALIGN_Y | DM_CATEGORY_CONTROL_COORDINATES,
};
...
#ifdef __MMI_WEARABLE_DEVICE_NOTI_UI_ENHANCE__
	{MMI_CATEGORY52_ID_NO_TITLE, (U8 *) category52_no_title, (S16 *) coordinate_set52_no_title, NULL},
#endif /*__MMI_WEARABLE_DEVICE_NOTI_UI_ENHANCE__*/
#endif /* defined(__MMI_SCREEN_ROTATE__) */ 
...
/* under construction !*/
#endif
#if defined ( __MMI_MAINLCD_240X320__) || defined ( __MMI_MAINLCD_320X320__) || defined ( __MMI_MAINLCD_240X240__) || defined ( __MMI_MAINLCD_320X240__) || defined ( __MMI_MAINLCD_240X400__) || defined ( __MMI_MAINLCD_320X480__) || defined ( __MMI_MAINLCD_360X640__) 
...
//	{MMI_CAT1033_NO_TAB_ID, (U8 *) fixed_list_menu_category, (S16 *) list_coordinate_set, NULL},
	...
	{MMI_CAT1071_ID, (U8 *) wearable_list_menu_category, (S16 *) wearable_list_coordinate_set, NULL},
#else
	...
	{MMI_CAT6333_ID, (U8*)category6333, (S16*)coordinate_set6333, NULL}, //pop up
	{MMI_CAT6335_ID, (U8 *) category6335, (S16 *) coordinate_set6335, NULL},//pop up percentage
#endif  //__MMI_WEARABLE_DEVICE__
};
