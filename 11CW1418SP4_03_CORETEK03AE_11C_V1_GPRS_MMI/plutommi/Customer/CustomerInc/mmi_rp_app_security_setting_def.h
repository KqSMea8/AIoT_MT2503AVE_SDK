 ...
 * Filename:
 * ---------
 *   mmi_rp_app_security_setting_def.h
 *
 * Project:
 * --------
 *   MAUI
...
#ifndef _MMI_RP_APP_SECURITY_SETTING_DEF_H
#define _MMI_RP_APP_SECURITY_SETTING_DEF_H
...
typedef enum
{
    ...
    MENU_ID_SECSET_SIM1_CHANGE_CHV1,
    MENU_ID_SECSET_SIM1_CHANGE_CHV2,
    MENU_ID_SECSET_PHONE_LOCK,
    MENU_ID_SECSET_CHANGE_PHONE_PASSWORD,
    MMI_RP_APP_SECURITY_SETTING_MENU_MAX
}mmi_rp_app_security_setting_menu_enum;
...
typedef enum
{
    ...
    STR_ID_SECSET_TEMP_FAIL,
    STR_ID_SECSET_INVALID_LENGTH,
    STR_ID_SECSET_SIM_SETTING,
    STR_ID_SECSET_PHONE_SETTING,
    STR_ID_SECSET_CHV1_LOCK,
    STR_ID_SECSET_CHANGE_CHV1_PASSWORD,
    STR_ID_SECSET_CHANGE_CHV2_PASSWORD,
    STR_ID_SECSET_OLD_PHONE_PASSWORD,
    STR_ID_SECSET_NEW_PHONE_PASSWORD,
    STR_ID_SECSET_CONFIRM_NEW_PHONE_PASSWORD,
    STR_ID_SECSET_DIFF_NEW_PHONE_PASSWORD,
    ...
    STR_ID_SECSET_CHV2_NOT_MATCH,
    STR_ID_SECSET_SIM_ERROR,
    MMI_RP_APP_SECURITY_SETTING_STR_MAX
}mmi_rp_app_security_setting_str_enum;
...
typedef enum
{
    ...
    MMI_RP_APP_SECURITY_SETTING_SCR_MAX
}mmi_rp_app_security_setting_scr_enum;
...
#endif /* _MMI_RP_APP_SECURITY_SETTING_DEF_H */
