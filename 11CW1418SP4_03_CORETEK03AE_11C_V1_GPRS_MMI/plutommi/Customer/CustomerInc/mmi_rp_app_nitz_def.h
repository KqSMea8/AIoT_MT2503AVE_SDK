...
#ifndef _MMI_RP_APP_NITZ_DEF_H
#define _MMI_RP_APP_NITZ_DEF_H
...
typedef enum
{
    ...
    MENU_ID_NITZ_APP_ON,
    MMI_RP_APP_NITZ_MENU_MAX
}mmi_rp_app_nitz_menu_enum;
...
typedef enum
{
    ...
    STR_ID_NITZ_CONFIRM_INFO,
    STR_ID_NITZ_MAX,
    MMI_RP_APP_NITZ_STR_MAX
}mmi_rp_app_nitz_str_enum;
...
typedef enum
{
    ...
    SCR_ID_NITZ_CONFIRM,
    SCR_ID_NITZ_MAX,
    MMI_RP_APP_NITZ_SCR_MAX
}mmi_rp_app_nitz_scr_enum;
