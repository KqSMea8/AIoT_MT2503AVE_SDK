...
#ifndef _MMI_RP_APP_USBMMI_DEF_H
#define _MMI_RP_APP_USBMMI_DEF_H
...
typedef enum
{
    ...
    MMI_RP_APP_USBMMI_STR_MAX
}mmi_rp_app_usbmmi_str_enum;
...
typedef enum
{
    ...
    SCR_ID_USB_PROGRESS,
    SCR_ID_USB_WAIT,
    MMI_RP_APP_USBMMI_SCR_MAX
}mmi_rp_app_usbmmi_scr_enum;
...
#endif /* _MMI_RP_APP_USBMMI_DEF_H */
