@echo off
set prj=
set customer=CORETEK03AE_11C
set optr_path=PPP
set optr_spec=NONE
set main_lcd_size=128X32
...
set populate_string_data=TRUE
set populate_image_data=TRUE
...
if %populate_string_data%==FALSE goto:skip_ref_list_merge
rem ************************************************************
...
if %populate_image_data%==FALSE goto:skip_image_resource_usage
rem ************************************************************
...
if .%1==.NOSTRING set populate_string_data=FALSE
if .%1==.NOIMAGE set populate_image_data=FALSE
shift
