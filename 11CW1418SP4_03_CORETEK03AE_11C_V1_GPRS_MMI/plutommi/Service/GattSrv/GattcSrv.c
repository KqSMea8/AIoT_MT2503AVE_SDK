...
static void srv_gattc_conn_param_interval_reset(void);
static void srv_gattc_conn_param_update_req_send(char *bd_addr, CONN_PRIO_ENUM connectionPriority);
static void srv_gattc_conn_param_update_req_retry(void* arg);
 ...
 *  void
 *****************************************************************************/
void srv_gattc_conn_update_complete_ind(void *msg)
{
 ...
 *  void
 *****************************************************************************/
U32 srv_gattc_get_conn_updated_profile_num(gattc_conn_prio_struct *conn_info)
{
	U32 j;
	U32 high_num = 0, balance_num = 0, low_num = 0;
 ...
 *  void
 *****************************************************************************/
void srv_gattc_reset_all_link_context(void)
{
	U32 i,j;
	U32 high_num = 0, balance_num = 0, low_num = 0;
 ...
 *  void
 *****************************************************************************/
S32 srv_gattc_conn_param_is_updating(char *bt_addr)
{
	/*----------------------------------------------------------------*/
	/* Local Variables												  */
	/*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
S32 srv_gattc_get_link_context_by_addr(char *bt_addr)
{
	/*----------------------------------------------------------------*/
	/* Local Variables												  */
	/*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void srv_gattc_conn_param_update_req_send(char *bd_addr, CONN_PRIO_ENUM connectionPriority)
{
