...
static gatts_profile_srv_decl_struct g_bikesw_srv_decl[] =
{
    {TYPE_SERVICE, "0000FEE7-0000-1000-8000-00805f9b34fb", TRUE, 0, 0},
    {TYPE_CHARACTERISTIC, "000036F5-0000-1000-8000-00805f9b34fb", FALSE, GATT_CHAR_PROP_WRITE , GATT_PERM_WRITE},
    {TYPE_CHARACTERISTIC, "000036F6-0000-1000-8000-00805f9b34fb", FALSE, GATT_CHAR_PROP_READ|GATT_CHAR_PROP_NOTIFY , GATT_PERM_READ},
    {TYPE_CHARACTERISTIC, "0000FEC7-0000-1000-8000-00805f9b34fb", FALSE, GATT_CHAR_PROP_WRITE , GATT_PERM_WRITE},
    {TYPE_CHARACTERISTIC, "0000FEC8-0000-1000-8000-00805f9b34fb", FALSE, GATT_CHAR_PROP_READ | GATT_CHAR_PROP_INDICATE, GATT_PERM_READ},
    {TYPE_DESCRIPTOR,	  "00002902-0000-1000-8000-00805f9b34fb", FALSE, 0, (GATT_PERM_READ | GATT_PERM_WRITE)},
    {TYPE_CHARACTERISTIC, "0000FEC9-0000-1000-8000-00805f9b34fb", FALSE, GATT_CHAR_PROP_READ , GATT_PERM_READ},
};
#endif
...
/*add for BAS end*/	
#ifdef __IOT_BLE_BKSS_SUPPORT__
	{PROFILE_ID_BIKESW, g_bikesw_srv_decl, sizeof(g_bikesw_srv_decl)/sizeof(g_bikesw_srv_decl[0])},
#endif	
};
