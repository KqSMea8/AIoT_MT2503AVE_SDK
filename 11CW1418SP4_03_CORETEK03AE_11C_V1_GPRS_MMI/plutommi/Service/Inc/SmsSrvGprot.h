...
#elif defined(__COSMOS_MMI_PACKAGE__) || defined(__MMI_SMS_SLIM__) /* COSMOS */
#define SRV_SMS_MSG_INFO_CONTENT_LEN   140
...
typedef enum
{
    ...
    SRV_SMS_PARA_BT_INDEX = 0x00800000          /* Select bt send index */ 
} srv_sms_para_enum;

#ifdef __MMI_BT_MAP_CLIENT__
typedef enum
{
    SRV_SMS_BT_INDEX0 = 0x00,             
    SRV_SMS_BT_INDEX1 = 0x01,                              

    SRV_SMS_BT_INDEX_RESERVED    = 0xFF  /* Reserved */
} srv_sms_send_bt_enum;

typedef enum
{
    SRV_SMS_EVENT_BT_INDEX0 = 0x00,  
    SRV_SMS_EVENT_BT_INDEX1 = 0x01,             
    SRV_SMS_EVENT_BT_INDEX2 = 0x02,                     

    SRV_SMS_EVENT_BT_INDEX_RESERVED    = 0xFF  /* Reserved */
} srv_sms_event_bt_enum;
#endif
...
#ifdef __MMI_BT_MAP_CLIENT__
    srv_sms_event_bt_enum bt_index;
#endif
 ...
 *  return true if number is valid, else return false
 *****************************************************************************/
extern MMI_BOOL srv_sms_check_sc_number(U8 *num, U8 numLen);
