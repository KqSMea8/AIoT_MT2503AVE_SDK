...
{
		/* index 0 */
	{	-1,	5,	keyTable+0	},		/* skb_phn_en_0 */
		/* index 1 */
	{	-1,	5,	keyTable+5	},		/* skb_phn_en_1 */
		/* index 2 */
	{	-1,	5,	keyTable+10	},		/* skb_phn_en_2 */
		/* index 3 */
	{	-1,	5,	keyTable+15	},		/* skb_phn_en_3 */
		/* index 4 */
	{	-1,	5,	keyTable+20	},		/* skb_phn_123sym_1_en_0 */
		/* index 5 */
	{	-1,	5,	keyTable+25	},		/* skb_phn_123sym_1_en_1 */
		/* index 6 */
	{	-1,	5,	keyTable+30	},		/* skb_phn_123sym_1_en_2 */
		/* index 7 */
	{	-1,	5,	keyTable+35	},		/* skb_phn_123sym_1_en_3 */
		/* index 8 */
	{	-1,	5,	keyTable+40	},		/* skb_phn_123sym_2_en_0 */
		/* index 9 */
	{	-1,	5,	keyTable+45	},		/* skb_phn_123sym_2_en_1 */
		/* index 10 */
	{	-1,	5,	keyTable+50	},		/* skb_phn_123sym_2_en_2 */
		/* index 11 */
	{	-1,	5,	keyTable+55	},		/* skb_phn_123sym_2_en_3 */
		/* index 12 */
	{	-1,	5,	keyTable+60	},		/* skb_phn_symbol_1_en_0 */
		/* index 13 */
	{	-1,	5,	keyTable+65	},		/* skb_phn_symbol_1_en_1 */
		/* index 14 */
	{	-1,	5,	keyTable+70	},		/* skb_phn_symbol_1_en_2 */
		/* index 15 */
	{	-1,	5,	keyTable+75	},		/* skb_phn_symbol_1_en_3 */
		/* index 16 */
	{	-1,	5,	keyTable+80	},		/* skb_phn_symbol_2_en_0 */
		/* index 17 */
	{	-1,	5,	keyTable+85	},		/* skb_phn_symbol_2_en_1 */
		/* index 18 */
	{	-1,	5,	keyTable+90	},		/* skb_phn_symbol_2_en_2 */
		/* index 19 */
	{	-1,	5,	keyTable+95	},		/* skb_phn_symbol_2_en_3 */
		/* index 20 */
	{	-1,	5,	keyTable+100	},		/* skb_phn_symbol_3_en_0 */
		/* index 21 */
	{	-1,	5,	keyTable+105	},		/* skb_phn_symbol_3_en_1 */
		/* index 22 */
	{	-1,	5,	keyTable+110	},		/* skb_phn_symbol_3_en_2 */
		/* index 23 */
	{	-1,	5,	keyTable+115	},		/* skb_phn_symbol_3_en_3 */
		/* index 24 */
	{	-1,	5,	keyTable+120	},		/* skb_phn_symbol_custom_1_en_0 */
		/* index 25 */
	{	-1,	5,	keyTable+125	},		/* skb_phn_symbol_custom_1_en_1 */
		/* index 26 */
	{	-1,	5,	keyTable+130	},		/* skb_phn_symbol_custom_1_en_2 */
		/* index 27 */
	{	-1,	5,	keyTable+135	},		/* skb_phn_symbol_custom_1_en_3 */
		/* index 28 */
	{	-1,	5,	keyTable+140	},		/* skb_phn_symbol_custom_2_en_0 */
		/* index 29 */
	{	-1,	5,	keyTable+145	},		/* skb_phn_symbol_custom_2_en_1 */
		/* index 30 */
	{	-1,	5,	keyTable+150	},		/* skb_phn_symbol_custom_2_en_2 */
		/* index 31 */
	{	-1,	5,	keyTable+155	},		/* skb_phn_symbol_custom_2_en_3 */
		/* index 32 */
	{	-1,	5,	keyTable+160	},		/* skb_phone_en_0 */
		/* index 33 */
	{	-1,	5,	keyTable+165	},		/* skb_phone_en_1 */
		/* index 34 */
	{	-1,	5,	keyTable+170	},		/* skb_phone_en_2 */
		/* index 35 */
	{	-1,	5,	keyTable+175	},		/* skb_phone_en_3 */
		/* index 36 */
	{	-1,	5,	keyTable+180	},		/* skb_phone_sym_en_0 */
		/* index 37 */
	{	-1,	5,	keyTable+185	},		/* skb_phone_sym_en_1 */
		/* index 38 */
	{	-1,	5,	keyTable+190	},		/* skb_phone_sym_en_2 */
		/* index 39 */
	{	-1,	5,	keyTable+195	},		/* skb_phone_sym_en_3 */
		/* index 40 */
	{	-1,	2,	keyTable+200	},		/* skb_popup_123sym_en_0 */
		/* index 41 */
	{	-1,	4,	keyTable+202	},		/* skb_popup_qwerty_com_en_0 */
		/* index 42 */
	{	-1,	6,	keyTable+206	},		/* skb_popup_qwerty_fullstop_en_0 */
		/* index 43 */
	{	-1,	3,	keyTable+212	},		/* skb_popup_symbol_en_0 */
		/* index 44 */
	{	-1,	2,	keyTable+215	},		/* skb_popup_symbol_custom_en_0 */
};
...
const wgui_virtual_keyboard_layout_struct		keyBoardTable[] = 
{
		...
		/* index 5 : skb_phn_symbol_3_en */
	{
		...
		/* index 6 : skb_phn_symbol_custom_1_en */
	{
		140,			/*keyboard height*/
		240,			/*keyboard width*/
		IMG_ID_KEYBOARD_BACKGROUND_9SLICE,			/*skb_bg*/
		...
		/* index 7 : skb_phn_symbol_custom_2_en */
	{
		140,			/*keyboard height*/
		240,			/*keyboard width*/
		IMG_ID_KEYBOARD_BACKGROUND_9SLICE,			/*skb_bg*/
		...
		/* index 10 : skb_popup_123sym_en */
	{
		...
		/* index 11 : skb_popup_qwerty_com_en */
	{
		48,			/*keyboard height*/
		148,			/*keyboard width*/
		IMG_ID_POPUP_KEYBOARD_BACKGROUND_9SLICE,			/*skb_bg*/
		...
		/* index 12 : skb_popup_qwerty_fullstop_en */
	{
		48,			/*keyboard height*/
		156,			/*keyboard width*/
		IMG_ID_POPUP_KEYBOARD_BACKGROUND_9SLICE,			/*skb_bg*/
		...
		/* index 13 : skb_popup_symbol_en */
	{
		...
		/* index 14 : skb_popup_symbol_custom_en */
	{
		48,			/*keyboard height*/
		72,			/*keyboard width*/
		IMG_ID_POPUP_KEYBOARD_BACKGROUND_9SLICE,			/*skb_bg*/
...
keyBoardTable+11,			 /*popup_skb*/		0 			  /*toggle_index*/
...

	{
		...
		0,			  /*height*/
		0,			  /*width*/
keyBoardTable+14,			 /*popup_skb*/		0 			  /*toggle_index*/
	},
...
keyBoardTable+14,			 /*popup_skb*/		0 			  /*toggle_index*/
...

	{
		...
		0,			  /*height*/
		0,			  /*width*/
keyBoardTable+10,			 /*popup_skb*/		0 			  /*toggle_index*/
	},
...
/* index: 18 */
		1,			/* state_num */
		stateListTable+33,			/* toggle_stateid pointer */
...
/* index: 20 */
		1,			/* state_num */
		stateListTable+35,			/* toggle_stateid pointer */
...
/* index: 22 */
		2,			/* state_num */
		stateListTable+37,			/* toggle_stateid pointer */
