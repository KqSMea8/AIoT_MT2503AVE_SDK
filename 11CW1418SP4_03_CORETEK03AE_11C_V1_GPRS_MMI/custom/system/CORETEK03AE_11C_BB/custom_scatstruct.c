 ...
 * Author:
 * -------
 *   Claudia Lo (mtk01876)     system auto generator v1.73 -> p1.74 -> p1.75 -> p1.76 -> p1.77 -> p1.78 -> p1.79 -> p1.82 -> p1.83. + sysGenUtility v0.49 -> p0.50 -> p0.51 -> p0.52 -> p0.53 -> p0.54 -> p0.55 -> p0.56 -> p0.57
 * 
 *============================================================================
 *             HISTORY
 ...
 * $Log$
 *
 * 09 09 2014 dongming.li
 * .dummy check in use MAUI_03503699
 *
 * 09 09 2014 dongming.li
 *  [6261 Driver] Feature check for MT6261
 * IOT FOTA patch back to 11C1418SP4 from 11C1418MP
 *
 * 07 09 2014 yinli.liang
 *  [IoT FOTA] Separate bin FOTA check in
 * .
 *
 * 07 08 2014 yinli.liang
 *  [IoT FOTA] Separate bin FOTA check in
 * support Indirect Reference Table
 *
...
{
    region[0].addr = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_NONCACHEABLE_ZI_MMIPOOL$$Base;
    region[0].len = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_NONCACHEABLE_RW$$ZI$$Limit - region[0].addr;
    region[1].addr = 0x0;
    region[1].len = 0x200;
    region[2].addr = (kal_uint32)&Image$$CACHED_EXTSRAM$$Base;
    region[2].len = (kal_uint32)&Image$$EXTSRAM_GADGET$$ZI$$Limit - region[2].addr;
    region[3].addr = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_NONCACHEABLE_ZI_MMIPOOL$$Base;
    region[3].len = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_NONCACHEABLE_RW$$ZI$$Limit - region[3].addr;
    region[3].addr = MAP2CREGVA(region[3].addr);
    region[4].addr = (kal_uint32)&Image$$SINGLE_BANK_CODE$$Base;
    region[4].len = (kal_uint32)&Image$$EXTSRAM$$ZI$$Limit - region[4].addr;
    region[5].addr = (kal_uint32)&Image$$EXTSRAM_DSP_TX$$Base;
    region[5].len = 0x6000;
    region[6].addr = (kal_uint32)&Image$$EXTSRAM_DSP_RX$$Base;
    region[6].len = 0xf000;
    region[7].addr = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_CACHEABLE_RW$$Base;
    region[7].len = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_CACHEABLE_ZI$$ZI$$Limit - region[7].addr;
    region[8].addr = (kal_uint32)&Image$$INTSRAM_CODE$$Base;
    region[8].len = 0x1300;
    region[9].addr = (kal_uint32)&Image$$INTSRAM_DATA$$Base;
    region[9].len = 0xd00;
    ...
    region[10].addr = MAP2CREGPA(region[10].addr);
...
*
*************************************************************************/
static EXTSRAM_REGION_INFO_T TOTAL_CODE_REGION[5];
...
kal_bool custom_check_code_address(kal_uint32 address)
{
    ...
    TOTAL_CODE_REGION[4].addr = 0x0;
    TOTAL_CODE_REGION[4].len = 0x200;
...
/*************************************************************************
* FUNCTION
*  custom_init_ubin_region
*
* DESCRIPTION
*  This function for ubin region init
...
void custom_init_ubin_region(void)
{
	kal_uint32* p_jump_addr = (kal_uint32*)(custom_get_UPDATE_ROM_entry() + UBIN_SYMBOL_UBIN_REGION_INIT * sizeof(void *));
	((void (*)(void))(*p_jump_addr))();
...
/*************************************************************************
* FUNCTION
*  custom_query_dynamic_DC_ZI_MMIPOOL_region
*
* DESCRIPTION
...
*
*************************************************************************/
kal_uint32 custom_query_dynamic_DC_ZI_MMIPOOL_region(EXTSRAM_REGION_INFO_T* region)
{
    kal_uint32* p_jump_addr = (kal_uint32*)(custom_get_UPDATE_ROM_entry() + UBIN_SYMBOL_CUSTOM_QUERY_DYNAMIC_DC_ZI_MMIPOOL_REGION * sizeof(void *));
    ((kal_uint32 (*)(EXTSRAM_REGION_INFO_T*))(*p_jump_addr))(region);
...
*
*************************************************************************/
kal_uint32 custom_query_ubin_dump_region(EXTSRAM_REGION_INFO_T* region)
{
    kal_uint32 ubin_count;
    kal_uint32* p_jump_addr = (kal_uint32*)(custom_get_UPDATE_ROM_entry() + UBIN_SYMBOL_CUSTOM_QUERY_UBIN_DUMP_REGION *sizeof(void *));
    ubin_count = ((kal_uint32 (*)(EXTSRAM_REGION_INFO_T*))(*p_jump_addr))(region);
...
/*************************************************************************
* FUNCTION
*  custom_get_UPDATE_ROM_entry
*
* DESCRIPTION
*  This function Retrieve UPDATE_ROM entry address, actually it's the jump-table base address
* PARAMETERS
*
* RETURNS
*
...
kal_uint32 custom_get_UPDATE_ROM_entry(void)
{
    return 0;
}
...
/*************************************************************************
* FUNCTION
*  custom_get_UPDATE_ROM_region
*
* DESCRIPTION
*  This function Retrieve UPDATE_ROM base and length for cache setting
* PARAMETERS
*
* RETURNS
*
...
void custom_get_UPDATE_ROM_region(EXTSRAM_REGION_INFO_T *region)
{

}

kal_uint32 custom_query_if_ubin_existed(void)
{
    return 1;
}

#else /* !__UPDATE_BINARY_FILE__ */

extern void* mmiSymbolArray[];
...
kal_uint32 custom_get_UPDATE_ROM_entry(void)
{
    return (kal_uint32)mmiSymbolArray;
}
...
*
* DESCRIPTION
*  For Modis, just return array address
* PARAMETERS
*
* RETURNS
*
