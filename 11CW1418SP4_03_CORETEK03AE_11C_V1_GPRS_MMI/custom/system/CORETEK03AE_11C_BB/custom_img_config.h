 ...
 * Author:
 * -------
 *   Carlos Yeh (mtk02377)     system auto generatorp7.19 -> p7.20 ->p7.21 ->p7.22 ->p7.23 -> p7.24 + scatFrame v0.12 + sysGenUtility v0.49 -> p0.50 -> p0.51 -> p0.52 -> p0.53 -> p0.54 -> p0.55 -> p0.56 -> p0.57
 *
 *============================================================================
 *             HISTORY
...
#define FOTA_PACKAGE_STORAGE_BASE  (0x10F00000)

#define FOTA_PACKAGE_STORAGE_SIZE  (0x00000000)

#define FOTA_PACKAGE_BLOCK_NUMBER  (4)

#define FOTA_BACKUP_STORAGE_BASE   (0x10F00000)
