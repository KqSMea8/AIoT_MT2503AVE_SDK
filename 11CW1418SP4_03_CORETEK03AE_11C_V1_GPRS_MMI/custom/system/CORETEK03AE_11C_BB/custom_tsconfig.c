 ...
 * $Log$
 *
 * 04 07 2015 dongming.li
 *  [Tiny System]Tiny system slim
 * .tiny system slim
 *
...
/*************************************************************************
* FUNCTION
*  custom_get_TINYSYS_ROM3_on_Flash
*
* DESCRIPTION
*  Retrieve the base address where flashtool download the TINYSYS_ROM3 binary
*  This function must sync with scatter file structure
* PARAMETERS
*  pBase: [IN] pointer to download base address
* RETURNS
*  KAL_TRUE if get base address and length, otherwise, KAL_FALSE.
*************************************************************************/
kal_bool custom_get_TINYSYS_ROM3_on_Flash(kal_uint32 *pBase)
{
[AUTOGEN_SCAT_C_Gen_TEMPLATE_TINYSYS_ROM3_ON_FLASH]
}
