 ...
 *
 * 09 02 2014 dongming.li
 *  [IoT FOTA] Separate bin FOTA check in
 * .make ubin common solution
 *
 * 08 05 2014 dongming.li
 *  [IoT FOTA] Separate bin FOTA check in
 * .ubin dump region patch back
 *
 *
 *
 *------------------------------------------------------------------------------
...
#define UB_DUMP_REGION_COUNT [AUTOGEN_SCAT_H_Gen_UB_DUMP_REGION_COUNT]

#else

#define UB_DUMP_REGION_COUNT 1
