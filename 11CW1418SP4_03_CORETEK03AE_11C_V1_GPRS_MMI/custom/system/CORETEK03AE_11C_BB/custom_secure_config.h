 ...
 * Author:
 * -------
 *   Kengchu Lin (mtk01866)     system auto generatorp7.19 -> p7.20 ->p7.21 ->p7.22 ->p7.23 -> p7.24 + scatFrame v0.12 + sysGenUtility v0.49 -> p0.50 -> p0.51 -> p0.52 -> p0.53 -> p0.54 -> p0.55 -> p0.56 -> p0.57
 *
 *============================================================================
 *             HISTORY
...
#define SDS_START_ADDR     0x0
#define SDS_TOTAL_SIZE     0x0
#define SDS_RESERVED_SIZE  0x0
#define SDS_RGN_NUM        0
#endif 
