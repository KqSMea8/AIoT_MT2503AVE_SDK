/* EasyCASE V6.5 02/09/2010 17:46:51 */
/* EasyCASE O
If=vertical
LevelNumbers=no
LineNumbers=no
...
#define BMA250_I2C_ADDR1                0x18
#define BMA250_I2C_ADDR2                0x19
#define BMA250_I2C_ADDR                 BMA250_I2C_ADDR2
...
typedef struct
   ...
   unsigned char chip_id,  /**< save bma250's chip id which has to be 0x03 after calling bma250_init() */
...
// gaoys modified, low-g threshhold isn't effected by range setting.
#define bma250_LOW_TH_IN_G( gthres, range)                      ((256 * gthres ) / 2) 
...
int bma250_set_flat_holt_time(unsigned char holdtime);
/* EasyCASE ) */
/* EasyCASE ( 1104
   bma250_get_flat_holt_time */
int bma250_get_flat_holt_time(unsigned char *holdtime );
/* EasyCASE ) */
/* EasyCASE ( 1106
