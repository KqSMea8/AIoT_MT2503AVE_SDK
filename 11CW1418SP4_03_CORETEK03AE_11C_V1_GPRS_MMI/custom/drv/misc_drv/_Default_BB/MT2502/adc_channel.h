...
#define ADC_TEMP_T4  75*1000000	 /*75C*/
#define ADC_TEMP_T5  100*1000000 /*100C*/
...
#define ADC_TEMP_NTCR4 1924.5    /*resistor at 75C*/
#define ADC_TEMP_NTCR5 973.8    /*resistor at 100C*/
...
#define ADC_TEMP_V4 (ADC_TEMP_AVDD*(ADC_TEMP_NTCR4/(ADC_TEMP_NTCR4+ADC_TEMP_PUR))) /*voltage at 75C*/
#define ADC_TEMP_V5 (ADC_TEMP_AVDD*(ADC_TEMP_NTCR5/(ADC_TEMP_NTCR5+ADC_TEMP_PUR))) /*voltage at 100C*/
...
#define ADC_TEMP_M34 (((ADC_TEMP_T3-ADC_TEMP_T4)*ADC_TEMP_SCALE)/(ADC_TEMP_V3-ADC_TEMP_V4))  /*T3T4's slppe*/
#define ADC_TEMP_M45 (((ADC_TEMP_T4-ADC_TEMP_T5)*ADC_TEMP_SCALE)/(ADC_TEMP_V4-ADC_TEMP_V5))  /*T4T5's slppe*/

#define ADC_TEMPV2_FACTOR    ADC_TEMP_V2
#define ADC_TEMPV3_FACTOR    ADC_TEMP_V3
#define ADC_TEMPV4_FACTOR    ADC_TEMP_V4
#define ADC_TEMPV5_FACTOR    ADC_TEMP_V5
...
#define ADC_TEMPA34_FACTOR   (ADC_TEMP_T3-ADC_TEMP_M34/ADC_TEMP_SCALE*ADC_TEMP_V3)
#define ADC_TEMPA45_FACTOR   (ADC_TEMP_T4-ADC_TEMP_M45/ADC_TEMP_SCALE*ADC_TEMP_V4)

#define ADC_TEMPM12_FACTOR   ADC_TEMP_M12
#define ADC_TEMPM23_FACTOR   ADC_TEMP_M23
#define ADC_TEMPM34_FACTOR   ADC_TEMP_M34
#define ADC_TEMPM45_FACTOR   ADC_TEMP_M45
