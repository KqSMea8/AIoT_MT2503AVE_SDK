...
#define VCHARGER_LOW_CHECK_COUNT		    3		// VCHARGER low check count
#define VCHARGER_OVER_CHECK_COUNT		    3		// VCHARGER high check count
#define OVER_CURRENT_CHECK_COUNT		    3		// Over current check count
#define LOW_CURRENT_CHECK_COUNT			    3		// Low current check count
#define OVER_BATTEMP_CHECK_COUNT		    3		// Over battery temperature check count
#define LOW_BATTEMP_CHECK_COUNT			    3		// Low battery temperature check count
...
#define CHR_V_PRE2FAST_THRES            3600000
#define CHR_V_PRE2FULL_THRES            4170000
...
#define TOTAL_CHARGE_TIME               (8 * 60) // 8 hours = 480 mins
