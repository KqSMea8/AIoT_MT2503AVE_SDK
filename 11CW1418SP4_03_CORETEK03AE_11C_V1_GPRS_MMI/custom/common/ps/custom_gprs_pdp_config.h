...
extern kal_bool custom_gprs_pdp_secondary_qos_encode(custom_app_qos_type_enum app_qos_type, void * param, l4c_gprs_qos_info_struct * qos_info);

#endif // ~ #ifdef __APP_SECONDARY_PDP_SUPPORT__

extern kal_uint32 mm_custom_get_custom_t3380_timer_period();
