...
kal_uint32 mm_custom_get_custom_t3380_timer_period()
{
    kal_uint32 t3380_timer_period = 30;
#ifdef __MM_FAST_RETRY_ON_LOWER_LAYER_FAILURE__
    // Random value between 13 to 17
    t3380_timer_period = (rand() % 5) + 13;
#endif
    return t3380_timer_period * KAL_TICKS_1_SEC;
}
