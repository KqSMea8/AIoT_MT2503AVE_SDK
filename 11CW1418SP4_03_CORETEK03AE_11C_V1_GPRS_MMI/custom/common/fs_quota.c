...
FS_QuotaStruct gFS_ExtQuotaSet[] =
{
    ...
    #if !defined(__32_32_SEG__)	// 3232 projects has no quota space by default because of small flash size
      #if defined(__WEARABLE_WATCH__)
        {"Z:\\@fota_iot\\", FS_QP_HIG_ENUM,  2550 * 1024 , FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},
      #else
        {"Z:\\@fota_iot\\", FS_QP_HIG_ENUM,  1800 * 1024 , FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},	// non-watch project needs smaller size
      #endif
    #elif defined (__UPDATE_PKG_SENSOR_ONLY__)
        {"Z:\\@fota_iot\\", FS_QP_HIG_ENUM,  40 * 1024 , FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE}, // separate bin FOTA for sensor only
    #endif
    {"Z:\\@fota_iot_data\\", FS_QP_HIG_ENUM,  10 * 1024 , FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},
  #elif defined(__64_32_SEG__)	// 6432 projects has no quota space by default because of small flash size
	{"Z:\\@fota_iot\\", FS_QP_HIG_ENUM,  3300 * 1024 , FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},
  #else
	{"Z:\\@fota_iot\\", FS_QP_HIG_ENUM,  7000 * 1024 , FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},
	#endif  
#endif
#if defined(__FUDIFFNET_ENABLE__)
    #ifdef __ROCK_FOTA_SUPPORT__
	    {"Z:\\@fota_rock\\", FS_QP_HIG_ENUM, 440 * 1024, FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},
    #else    
	    {"Z:\\@fota_redbend\\", FS_QP_HIG_ENUM,  500 * 1024 , FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},
    #endif
#endif
#ifdef __MMI_VCARD__
...
#ifdef __ADUPS_FOTA_DIFF__
    {"Z:\\@fota_adups\\", FS_QP_HIG_ENUM, 2*1024, FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},
#endif
...
/* under construction !*/
...
#endif
#ifdef __MMI_BT_MAP_CLIENT__
    {"Z:\\@map\\",   FS_QP_HIG_ENUM, (5*1024 + 520*SRV_SMS_BTMAPC_MAX_SMS_ENTRY), FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},
...
#elif defined __BT_NOTI_SRV_ICON_WITH_BUFFER__
    {"Z:\\@BTNotify\\", FS_QP_HIG_ENUM, (10 * 1024), FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},
#else
    {"Z:\\@BTNotify\\", FS_QP_HIG_ENUM, (5 * 1024 + 2560 * SRV_BT_NOTI_MSG_LIST_MAX_NUM), FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},
#endif
    ...
    #ifdef __LINKIT_APP_STORAGE_QUOTA__
    {"Z:\\@BTMre\\", FS_QP_HIG_ENUM, (__LINKIT_APP_STORAGE_QUOTA__) * 1024, FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},
    #else
    ...
    {"Z:\\@pbapc\\",   FS_QP_HIG_ENUM, ((SRV_PHB_PBAPC_FOLDER_SIZE + MMI_CLOG_PBAPC_FOLDER_SIZE) * 512 * BT_MAX_LINK_NUM), FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},
#else
    {"Z:\\@pbapc\\",   FS_QP_HIG_ENUM, MMI_PHB_PBAPC_MAX_PSE_CONTACT * 72, FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},
#endif
#elif defined(__FORMAT_NOT_SUPPORT__)
    {"Z:\\@pbapc\\",   FS_QP_HIG_ENUM, 5120, FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},
#endif /* __BT_PBAP_CLIENT__ */
...
#if defined(__MMI_BT_APK_SMART_INSTALL_SUPPORT__) || defined(__MMI_BT_APPLICATION_BQB__)
{"Z:\\@Apk\\",   FS_QP_HIG_ENUM, 1024 * 512, FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},
#endif /*__MMI_BT_APK_SMART_INSTALL_SUPPORT__*/
#endif

#ifndef __MMI_BT_NOTI_SRV__  /* ifndef __MMI_BT_NOTI_SRV__, also put bt firmware patch in Z:\@BTMre\ */
	{"Z:\\@BTMre\\", FS_QP_HIG_ENUM,  56 * 1024 , FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},
