...
/* Reserved                     ,  10 */ 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00
};
#else
static kal_uint8 const NVRAM_EF_MNL_SETTING_DATA_DEFAULT[] = {
/* Internal LNA Enable          ,  1  */ 0x00,
...
static port_setting_struct const NVRAM_EF_PORT_SETTING_DEFAULT[]=
{
    ...
    #elif defined(__USB_MULTIPLE_COMPORT_SUPPORT__) && defined(__LINKIT_DEV_KIT__)
        #if defined(__PRODUCTION_RELEASE__)
        99,  /* tst-ps uses NULL */
        5,   /* Tool use uart_port_usb2 */
...
#endif
    /* Reserved sensor NVRAM data */
    {
        NVRAM_EF_RESERVED_SENSOR1_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR01",
        VER(NVRAM_EF_RESERVED_SENSOR1_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR2_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR02",
        VER(NVRAM_EF_RESERVED_SENSOR2_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR3_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR03",
        VER(NVRAM_EF_RESERVED_SENSOR3_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR4_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR04",
        VER(NVRAM_EF_RESERVED_SENSOR4_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR5_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR05",
        VER(NVRAM_EF_RESERVED_SENSOR5_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR6_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR06",
        VER(NVRAM_EF_RESERVED_SENSOR6_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR7_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR07",
        VER(NVRAM_EF_RESERVED_SENSOR7_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR8_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR08",
        VER(NVRAM_EF_RESERVED_SENSOR8_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR9_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR09",
        VER(NVRAM_EF_RESERVED_SENSOR9_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR10_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR10",
        VER(NVRAM_EF_RESERVED_SENSOR10_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR11_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR11",
        VER(NVRAM_EF_RESERVED_SENSOR11_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR12_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR12",
        VER(NVRAM_EF_RESERVED_SENSOR12_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR13_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR13",
        VER(NVRAM_EF_RESERVED_SENSOR13_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR14_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR14",
        VER(NVRAM_EF_RESERVED_SENSOR14_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR15_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR15",
        VER(NVRAM_EF_RESERVED_SENSOR15_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR16_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR16",
        VER(NVRAM_EF_RESERVED_SENSOR16_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR17_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR17",
        VER(NVRAM_EF_RESERVED_SENSOR17_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR18_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR18",
        VER(NVRAM_EF_RESERVED_SENSOR18_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR19_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR19",
        VER(NVRAM_EF_RESERVED_SENSOR19_LID)
    },
    {
        NVRAM_EF_RESERVED_SENSOR20_LID,
        NVRAM_EF_RESERVED_SENSOR_TOTAL,
        NVRAM_EF_RESERVED_SENSOR_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "SR20",
        VER(NVRAM_EF_RESERVED_SENSOR20_LID)
    },
};
