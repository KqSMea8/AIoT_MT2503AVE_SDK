...
#define NVRAM_CUSTPACK_TOTAL  10
#define NVRAM_SECUPACK_TOTAL  1
#define NVRAM_SECUPACK_SIZE  190

#ifdef __NVRAM_PSEUDO_MERGE__
#define NVRAM_PACKAGE_LID_NUM     100
#define NVRAM_PACKAGE_LID_SIZE    22424
