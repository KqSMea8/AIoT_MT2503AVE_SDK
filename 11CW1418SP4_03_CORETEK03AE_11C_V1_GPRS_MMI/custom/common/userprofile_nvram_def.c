...
#if !defined(EMPTY_MMI) && !defined(NEPTUNE_MMI) && !defined(__IOT_NO_MULTIMEDIA__)
...
nvram_srv_prof_setting_struct const NVRAM_PROFILES_DEFAULT [NVRAM_SRV_PROF_PROFILES_TOTAL_NUM] =
{
...
#else
	{
        SRV_PROF_VOL_LEVEL_6, SRV_PROF_VOL_LEVEL_6, SRV_PROF_VOL_LEVEL_6, SRV_PROF_MEDIA_VOL_LEVEL_15, SRV_PROF_ALERT_TYPE_RING,KAL_TRUE,KAL_FALSE,SRV_PROF_RING_TYPE_REPEAT,
        ...
        SRV_PROF_AUD_TONE1, SRV_PROF_AUD_TONE4, SRV_PROF_AUD_TONE4, SRV_PROF_AUD_TONE4,
	...
	},
	{
        ...
        SRV_PROF_AUD_TONE1, SRV_PROF_AUD_TONE2, KAL_TRUE, 0, 0,
        #else
        0, 0, KAL_FALSE, 0, 0,
        #endif
        0, 0, 0, 0,
