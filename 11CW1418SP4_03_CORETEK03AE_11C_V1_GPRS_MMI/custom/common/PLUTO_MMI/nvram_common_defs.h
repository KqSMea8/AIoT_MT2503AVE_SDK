...
//hukingnvarm
	...
	NVRAM_EF_BLE_BKSS_LID,
#endif
    /* ADD-E  20120417 FOR CMMBCAS2GPP*/
#ifdef	__IOT_LOCK__
	NVRAM_EF_IOT_LOCK_LID,
	NVRAM_EF_IOT_LOCK_MSG_LID,
	NVRAM_EF_LOCK_COUNT_LID,
	NVRAM_EF_LOCK_AGING_LID,
	NVRAM_EF_ORDER_NUM_LID,
	NVRAM_EF_ORDER_INFO_LID,
	NVRAM_EF_IOT_BACKUP_LID,
#endif /*__IOT_LOCK__*/
...
#if (defined(__UPDATE_BINARY_FILE__) && !defined(__NVRAM_SUPPORT_CUSTPACK__))
#define NVRAM_MMI_CACHE_INIT_SIZE    4      /* dependency to the cache size and the key size */
#define NVRAM_MMI_CACHE_INIT_TOTAL   1
#endif
...
#define  NVRAM_BYTE_BT_DIALER_AUTO_CONN_SIZE    (sizeof(srv_bt_cm_dev_struct)) * (__BT_MAX_LINK_NUM__)
#endif
...
#define NVRAM_EF_FM_RADIO_SIZE      (NVRAM_EF_FM_RADIO_CHANNEL * 2) /* Same as "sizeof(mmi_fmrdo_channel_list_struct) */
...
#ifdef __MMI_BT_APK_SMART_INSTALL_SUPPORT__
#define NVRAM_EF_BT_APK_SMART_INS_RECORD_TOTAL  1
#define NVRAM_EF_BT_APK_SMART_INS_RECORD_SIZE (SRV_BT_CM_MAX_PAIRED_DEVICE_LIST * sizeof(srv_bt_cm_bt_addr))
#define NVRAM_EF_BT_APK_SMART_INS_RECORD_LID_VERNO "000"
#endif  /* defined(__MMI_BT_APK_SMART_INSTALL_SUPPORT__) */

#if defined(__FUDIFFNET_ENABLE__)
#define NVRAM_EF_DIFF_FOTA_INFO_TOTAL            1
#define NVRAM_EF_DIFF_FOTA_INFO_SIZE             sizeof(nvram_ef_diff_fota_info_struct)

#define NVRAM_EF_DIFF_FOTA_INFO_SWMC_TOTAL       1
#define NVRAM_EF_DIFF_FOTA_INFO_SWMC_SIZE        sizeof(nvram_ef_diff_fota_info_swmc_struct)

#define NVRAM_EF_DIFF_FOTA_DM_TYPE_TOTAL         1
#define NVRAM_EF_DIFF_FOTA_DM_TYPE_SIZE          1 
#endif

#if defined(__FUNET_ENABLE__)
#define NVRAM_EF_UBIN_FOTA_INFO_TOTAL            1
#define NVRAM_EF_UBIN_FOTA_INFO_SIZE             sizeof(nvram_ef_ubin_fota_info_struct)
#endif

#if defined(__MMI_USB_FIRMWARE_UPDATE__)
#define NVRAM_EF_USB_FOTA_INFO_TOTAL            1
#define NVRAM_EF_USB_FOTA_INFO_SIZE             sizeof(nvram_ef_usb_fota_info_struct)
#endif

#if defined(__ROCK_FOTA_SUPPORT__)
#define NVRAM_EF_ROCK_FOTA_INFO_TOTAL            1
#define NVRAM_EF_ROCK_FOTA_INFO_SIZE             sizeof(nvram_ef_rock_fota_info_struct)
#endif

#ifdef __MMI_ONE_KEY_SOS_SUPPORT__
#define NVRAM_EF_OKSOS_MAX_NUM_LEN              41
#define NVRAM_EF_OKSOS_MAX_NAME_LEN             100
#define NVRAM_EF_OKSOS_MAX_KEY_COUNT            3
#define NVRAM_EF_OKSOS_MAX_NUM_COUNT            5
#define NVRAM_EF_OKSOS_INFO_TOTAL               (NVRAM_EF_OKSOS_MAX_KEY_COUNT*NVRAM_EF_OKSOS_MAX_NUM_COUNT)
#define NVRAM_EF_OKSOS_INFO_SIZE                sizeof(nvram_ef_oksos_info_struct)
#endif /* __MMI_ONE_KEY_SOS_SUPPORT__ */
...
#ifdef __IOT_LOCK__
#define NVRAM_EF_IOT_LOCK_MSG_TOTAL            60
#define NVRAM_EF_IOT_LOCK_MSG_SIZE             260
#define NVRAM_EF_IOT_LOCK_TOTAL            1
#define NVRAM_EF_IOT_LOCK_SIZE             sizeof(nvram_ef_iot_lock_struct)
#define NVRAM_EF_LOCK_COUNT_TOTAL	1
#define NVRAM_EF_LOCK_COUNT_SIZE		sizeof(kal_uint32)
#define NVRAM_EF_LOCK_AGING_TOTAL	1
#define NVRAM_EF_LOCK_AGING_SIZE		sizeof(kal_uint8)
#define NVRAM_EF_ORDER_NUM_TOTAL		1
#define NVRAM_EF_ORDER_NUM_SIZE          sizeof(nvram_ef_order_num)
#define NVRAM_EF_ORDER_INFO_TOTAL	1
#define NVRAM_EF_ORDER_INFO_SIZE         sizeof(nvram_ef_order_info)
#define NVRAM_EF_IOT_BACKUP_TOTAL	1
#define NVRAM_EF_IOT_BACKUP_SIZE         512
#endif /*__IOT_LOCK__*/
#ifdef __IOT_BLE_BKSS_SUPPORT__
#define NVRAM_EF_BLE_BKSS_TOTAL            1
#define NVRAM_EF_BLE_BKSS_SIZE             sizeof(nvram_ef_bel_bkss_struct)
#endif
#ifdef __ADUPS_FOTA_SOC__
#define NVRAM_EF_FOTA_TOTAL 		1
#define NVRAM_EF_FOTA_SIZE         sizeof(nvram_ef_fota_struct)
#endif
#ifdef __cplusplus
}
#endif
