    ...
    {
        {
            ...
            "", "", "", "", "", "",
            DTCNT_APPTYPE_BRW_HTTP | DTCNT_APPTYPE_MRE_NET | DTCNT_APPTYPE_DEF,  /* app type */
            "46000, 46002, 46004, 46007" /* SIM ID */
        },
    ...
    {
        {
            ...
            "", "",  /* proxy username, password */
            "", "", "", "", "", "",
            DTCNT_APPTYPE_BRW_HTTP | DTCNT_APPTYPE_MRE_WAP, /* app type */
            "46000, 46002, 46004,46007" /* SIM ID */
        },
    ...
    {
        {
            ...
            "", "",  /* proxy username, password */
            "", "", "", "", "", "",
            DTCNT_APPTYPE_GPS | DTCNT_APPTYPE_BRW_HTTP | DTCNT_APPTYPE_EMAIL | DTCNT_APPTYPE_MRE_NET | DTCNT_APPTYPE_TETHERING | DTCNT_APPTYPE_PLAYER | DTCNT_APPTYPE_NTP | DTCNT_APPTYPE_PUSH, /* app type */
            "46000, 46002, 46004, 46007" /* SIM ID */
        },
    ...
    {
        {
            ...
            CUSTOM_DTCNT_PROF_TYPE_FACTORY_CONF, /* type */ 
            CUSTOM_DTCNT_SIM_TYPE_1,      /* SIM1/SIM2 */
            (const kal_uint8*)L"Cingular GPRS", /* Account Name */
            "", /* Home page */
            {
                CUSTOM_DTCNT_PROF_GPRS_AUTH_TYPE_NORMAL,
                "wap@cingulargprs.com", "cingular1"  /* username, password */
            },
            0,
            CUSTOM_DTCNT_PROF_PX_SRV_HTTP,  /* proxy service type */
            0, /* proxy port */
    ...
    {
        {
            ...
            CUSTOM_DTCNT_PROF_TYPE_FACTORY_CONF, /* type */ 
            CUSTOM_DTCNT_SIM_TYPE_1,      /* SIM1/SIM2 */
            (const kal_uint8*)L"AT&T M2M", /* Account Name */
            "", /* Home page */
            {
                CUSTOM_DTCNT_PROF_GPRS_AUTH_TYPE_NORMAL,
                "", ""  /* username, password */
