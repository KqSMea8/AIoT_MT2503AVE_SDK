...
#if !defined(__FUE__) && defined(__LED_SUPPORT__)
#define GPIO_DEV_LED_1	0x01
#define GPIO_DEV_LED_2	0x02
#define GPIO_DEV_LED_3	0x04
typedef enum {
    RED_LED = GPIO_DEV_LED_1,
    GREEN_LED = GPIO_DEV_LED_3,
    BLUE_LED = GPIO_DEV_LED_2,
    YELLOW_LED = (RED_LED | GREEN_LED),
    PURPLE_LED = (RED_LED | BLUE_LED),
    AZURE_LED = (GREEN_LED | BLUE_LED),
    ALL_LED = (RED_LED | GREEN_LED | BLUE_LED),
    MAX_LED_SUPPORT
} gpio_device_led_enum;
...
typedef enum {
    ...
    LED_CMD_DIMMING,
    LED_CMD_BRIGHTING    
} gpio_device_led_ctrl_cmd_enum;

typedef struct
{
	LOCAL_PARA_HDR
	kal_uint8	led; /* gpio_device_enum */
	kal_uint8	cmd;
	kal_uint8	on_time;
	kal_uint8	off_time;
} mmi_eq_control_gpio_led_req_struct;
#endif
...
typedef enum {
    ...
    EXT_DEV_LINEIN_PLUGIN       , /* Linein plugin */
    EXT_DEV_LINEIN_PLUGOUT       , /* Linein plugout */
#endif  //__LINE_IN_SUPPORT__
#ifdef __BT_NFC_TAG_SUPPORT__
    EXT_DEV_NFC_TAG_PAIRING       , /* NFC tag pairing */
...
typedef enum 
{
   ...
   BATTERY_LEVEL_7, /* BATTERY_LEVEL_7 */
...
#if !defined(BATTERY_LEVEL_TOTAL)
#define 	BATTERY_LEVEL_TOTAL	       (BATTERY_LEVEL_MAX - BATTERY_LEVEL_0 - 1)
#endif
#if !defined(BATTERY_LEVEL_PERCENTAGE)
#define 	BATTERY_LEVEL_PERCENTAGE	       ((int)(100/BATTERY_LEVEL_TOTAL))
#endif
...
typedef enum 
{
    ...
    DEVUSB_DETECT_ACTION_MS_EXIT_DONE,
