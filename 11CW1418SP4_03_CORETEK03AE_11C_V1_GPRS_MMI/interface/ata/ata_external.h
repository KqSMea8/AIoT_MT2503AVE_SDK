...
extern custom_rsp_type_enum ata_tp_hdlr_v2(custom_cmdLine *commandBuffer_p);
#endif

#if defined(__LCD_SUPPORT__)
extern custom_rsp_type_enum ata_tp_ui_hdlr(custom_cmdLine *commandBuffer_p);
extern custom_rsp_type_enum ata_lcm_hdlr_v2(custom_cmdLine * commandBuffer_p);
#endif
...
extern custom_rsp_type_enum ata_sim_hdlr_v2(custom_cmdLine * commandBuffer_p);
#endif
extern custom_rsp_type_enum ata_customer_lcd_hdlr(custom_cmdLine * commandBuffer_p);
extern custom_rsp_type_enum ata_led_hdlr_v2(custom_cmdLine * commandBuffer_p);

extern custom_rsp_type_enum ata_lock_hdlr(custom_cmdLine * commandBuffer_p);
extern custom_rsp_type_enum ata_beep_hdlr(custom_cmdLine * commandBuffer_p);
extern custom_rsp_type_enum ata_500hz_hdlr(custom_cmdLine * commandBuffer_p);
extern custom_rsp_type_enum ata_1000hz_hdlr(custom_cmdLine * commandBuffer_p);
extern custom_rsp_type_enum ata_3000hz_hdlr(custom_cmdLine * commandBuffer_p);
extern custom_rsp_type_enum ata_beep_stop_hdlr(custom_cmdLine * commandBuffer_p);
extern custom_rsp_type_enum ata_gps_hdlr(custom_cmdLine * commandBuffer_p);
extern custom_rsp_type_enum ata_Gsensor_hdlr(custom_cmdLine * commandBuffer_p);
extern custom_rsp_type_enum ata_Sim_hdlr(custom_cmdLine * commandBuffer_p);
extern custom_rsp_type_enum ata_Charge_hdlr(custom_cmdLine * commandBuffer_p);
extern custom_rsp_type_enum ata_Speakercheck_hdlr(custom_cmdLine * commandBuffer_p);
extern custom_rsp_type_enum ata_led_hdlr_v1(custom_cmdLine * commandBuffer_p);
extern custom_rsp_type_enum ata_Led1check_hdlr(custom_cmdLine * commandBuffer_p);
extern custom_rsp_type_enum ata_Led2check_hdlr(custom_cmdLine * commandBuffer_p);
extern custom_rsp_type_enum ata_Ladc_hdlr(custom_cmdLine * commandBuffer_p);
extern custom_rsp_type_enum ata_Tadc_hdlr(custom_cmdLine * commandBuffer_p);
extern custom_rsp_type_enum ata_Temp_hdlr(custom_cmdLine * commandBuffer_p);
