    ...
    ifdef WIFI_SUPPORT
      ifneq ($(strip $(WIFI_SUPPORT)),NONE)
        ...
        ifeq ($(strip $(WIFI_SUPPORT)),MT5931)
            ...
            INC_DIR += custom\drv\wifi\$(strip $(BOARD_VER)) \
                     	wifi\wndrv\SCANONLY_MT5931\inc
...
SRC_LIST := $(filter-out custom\system\$(strip $(BOARD_VER))\custom_ubconfig.c,$(SRC_LIST))
...
ifneq ($(filter __BQ25601_SWCHR_SUPPORT__, $(strip $(MODULE_DEFS))),)
SRC_LIST += custom\drv\switch_charger\BQ25601_I2C\bq25601.c
SRC_LIST += custom\drv\switch_charger\BQ25601_I2C\i2c_drv.c

INC_DIR += custom\drv\switch_charger\BQ25601_I2C
