...
ifeq ($(strip $(DCM_COMPRESSION_MAUI_INIT)),TRUE)
  LNKOPT += --callgraph_output=text --callgraph
endif
  ...
  ifeq ($(strip $(WAP_MMS_FEATURES)),NONE)
    ifeq ($(strip $(XYSSL_SUPPORT)),TRUE)
      ifneq ($(strip $(MMI_VERSION)),IOT_MMI)
        ifneq ($(strip $(PRODUCT_LINE)),WEARABLE_WATCH) 
  ...
  ifneq ($(strip $(WIFI_SUPPORT)),NONE)
    ...
    ifeq ($(strip $(WIFI_SUPPORT)),MT5931)
      ifdef WIFI_AUTHENTICATION_LEVEL
        ifeq ($(strip $(WIFI_AUTHENTICATION_LEVEL)),WIFI_FEATURE_SCAN_ONLY)
          COMP_TRACE_DEFS += wifi\wndrv\SCANONLY_MT5931\inc\wndrv_trc.h
        else 
...
ifdef MSDC2_CARD_SUPPORT_TYPE
  ifneq ($(strip $(MSDC2_CARD_SUPPORT_TYPE)),NONE)
    ifeq ($(strip $(MSDC2_CARD_SUPPORT_TYPE)),MSDC2_SD_MMC)
      COM_DEFS += __MSDC2_SD_MMC__
    endif
    ifeq ($(strip $(MSDC2_CARD_SUPPORT_TYPE)),MSDC2_SD_SDIO)
      COM_DEFS += __MSDC2_SD_SDIO__
    endif
  endif
endif
...
ifdef BLUETOOTH_SUPPORT
  ifneq ($(strip $(BLUETOOTH_SUPPORT)),NONE)
    ...
    ifeq ($(strip $(BT_HF_PROFILE)),TRUE)
      ...
      ifeq ($(strip $(PRODUCT_LINE)),WEARABLE_WATCH)
        COM_DEFS += __BT_HF_BVRA_SUPPORT__
      endif
    endif
...
HORIZONTAL_CAMERA_SUPPORT_SIZE = 128X128 128X160 176X220 240X320 240X400 320X480 360X640 480X800 240X240 320X320
...
ifdef PHB_BT_ENTRY
  COM_DEFS += MAX_PHB_BT_ENTRY=$(strip $(PHB_BT_ENTRY))
endif
...
ifneq ($(filter $(strip $(PLATFORM)),$(TEARING_REDUCTION_FB_PLATFORM)),)
  ...
  ifeq ($(call Upper,$(strip $(MAIN_LCD_SIZE))),320X320)
    COM_DEFS  +=  __TEARING_REDUCTION_FB_IN_INTSRAM__
  endif
...
ifdef NOR_SUPPORT_RAW_DISK
  ifeq ($(strip $(NOR_SUPPORT_RAW_DISK)),TRUE)
    ifeq ($(strip $(NVRAM_BACKUP_PARTITION_ON_NOR)),ENABLE)
      $(call DEP_ERR_OFFA_OR_OFFB,NOR_SUPPORT_RAW_DISK,NVRAM_BACKUP_PARTITION_ON_NOR)
      DEPENDENCY_CONFLICT = TRUE
    endif
...
#      endif
    ...
    ifeq ($(strip $(AGPS_SUPPORT)), USER_PLANE)
      ...
      COM_DEFS += __IOT_CUSTOMIZE__ __GPS_ADAPTOR_SUPPORT__
      ifeq ($(strip $(XYSSL_SUPPORT)),TRUE)
...
ifdef SMS_BT_ENTRY
  COM_DEFS += MAX_SMS_BT_ENTRY=$(strip $(SMS_BT_ENTRY))
endif
...
ifdef FONT_ENGINE
  ifneq ($(strip $(FONT_ENGINE)),NONE)
    ...
    ifeq ($(filter $(call Upper,$(strip $(MAIN_LCD_SIZE))),320X320 240X240 240X320 320X240 240X400 320X480 360X640 480X800),)
      $(warning ERROR: FONT_ENGINE only supports 320X320 240X240 240X320, 320X240, 240X400, 320X480 360X640 480X800 MAIN_LCD_SIZE)
      DEPENDENCY_CONFLICT = TRUE
    endif
...
MEDIA_PLAYER_VER_MAIN_LCD_SIZE = 128X160 176X220 240X240 240X320 320X320 240X400 320X480 320X240 360X640 480X800 
...
ifeq ($(strip $(MRE_PACKAGE)), NONE)
    COM_DEFS    += __MRE_PACKAGE_NONE__
    COM_DEFS    += __DISABLE_SANDBOX_LIB__
...
ifdef IMAGE_VIEWER_VER
  ifneq ($(strip $(IMAGE_VIEWER_VER)),NONE)
    IMAGE_VIEWER_VER_EX_SUPPORT_MAIN_LCD_SIZE = 176X220 240X240 240X320 320X320 240X400 320X480 320X240 360X640 480X800
...
ifeq ($(strip $(MMI_VERSION)),IOT_MMI)
  ...
  ifeq ($(strip $(IOT_LCD_SUPPORT)),SLIM)
    COMPLIST += gdi_g2d gdi_arm
  endif
...
ifdef FINGER_TOUCH_SUPPORT
  ifneq ($(strip $(FINGER_TOUCH_SUPPORT)),NONE)
    FINGER_TOUCH_SUPPORT_SUPPORT_LCD_SIZE = 240X240 240X400 240X320 320X320 320X240 320X480 480X800 
...
ifeq ($(strip $(PHB_ADDITIONAL_SUPPORT)),TRUE)
  ...
  COM_DEFS    +=   __PHB_USIM_ADDITIONAL_SUPPORT__ __AT_EPBUM_SUPPORT__
endif
...
ZIMAGE_MUST_ENABLE_PLATFORM = MT6250 MT6260
ZIMAGE_CONDITIONAL_ENABLE_PLATFORM = MT6261 MT2501 MT2502
...
ifdef INTERGRAFX_SUPPORT
  ...
  ifneq ($(strip $(INTERGRAFX_SUPPORT)),NONE)
    MAIN_LCD_SIZE_VALID_RANGE = 240X240 320X320 240X320 240X400 320X480 480X800
  ...
  MAIN_LCD_SUPPORT_SIZE = 240X240 320X320 240X320 240X400 320X480 480X800
...
ifdef FUDIFFNET_ENABLE
  ifeq ($(strip $(FUDIFFNET_ENABLE)),DIFF_IMAGE_UPDATE)
    COMPLIST += fdm_bl gfx_core32 sys_sec
  endif
endif

ifdef MTK_SENSOR_SUBSYS_SUPPORT
  ifeq ($(strip $(MTK_SENSOR_SUBSYS_SUPPORT)),TRUE)
    COMPLIST += sensor_subsys
    COM_DEFS += __MTK_SENSOR_SUBSYS_SUPPORT__
    COMPOBJS +=         sensor_subsys\fusion_algo\blood_pressure\lib_core\libbp.lib \
                        sensor_subsys\fusion_algo\common\lib_core\libcommon.lib \
                        sensor_subsys\fusion_algo\heart_rate\lib_core\libhr.lib \
                        sensor_subsys\fusion_algo\ppg_control\lib_core\libppgctrl.lib
    CUS_REL_OBJ_LIST += sensor_subsys\fusion_algo\blood_pressure\lib_core\libbp.lib \
                        sensor_subsys\fusion_algo\common\lib_core\libcommon.lib \
                        sensor_subsys\fusion_algo\heart_rate\lib_core\libhr.lib \
                        sensor_subsys\fusion_algo\ppg_control\lib_core\libppgctrl.lib
  endif
  ifeq ($(strip $(UPDATE_BINARY_FILE)),TRUE)
    ifeq ($(strip $(UPDATE_BINARY_PACKAGE)),SENSOR_ONLY)
      COMPLIST += sensor_algo
    else
      $(warning ERROR: For separate bin FOTA project, please set UPDATE_BINARY_PACKAGE = SENSOR_ONLY if enable sensor subsys, or turn off MTK_SENSOR_SUBSYS_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
endif
...
ifdef WIFI_SUPPORT
  ifneq ($(strip $(WIFI_SUPPORT)),NONE)
    ifeq ($(strip $(CUSTOM_WIFI_FEATURES_SWITCH)),TRUE)
      ...
      COMPLIST += dhcp
      ifdef WIFI_AUTHENTICATION_LEVEL
        ifneq ($(strip $(WIFI_AUTHENTICATION_LEVEL)),WIFI_FEATURE_SCAN_ONLY)
          COMPLIST += supc
        endif
      else
        COMPLIST += supc
...
ifeq ($(strip $(WIFI_SUPPORT)),MT5931)
  ...
  ifeq ($(strip $(CUSTOM_WIFI_FEATURES_SWITCH)),TRUE)
    ...
    ifdef WIFI_AUTHENTICATION_LEVEL
      ifeq ($(strip $(WIFI_AUTHENTICATION_LEVEL)),WIFI_FEATURE_SCAN_ONLY)
        COM_DEFS += __WIFI_SCAN_ONLY__
        ifeq ($(strip $(WIFI_SCAN_ONLY_AT_SUPPORT)),TRUE)
          COM_DEFS += __WIFI_SCAN_ONLY_AT_CMD__
          COMMINCDIRS += interface\mmi
        endif
      else
...
ifeq ($(filter BASIC L1S UDVT,$(strip $(call Upper,$(PROJECT)))),)
  ...
  ifdef FONT_RESOURCE
    ...
    ifeq ($(strip $(FONT_RESOURCE)),DEMO)
      ...
      ifeq ($(filter $(call Upper,$(strip $(MAIN_LCD_SIZE))),128X128 128X160 176X220 240X240 320X320 240X320 320X240 240X400 320X480 480X800),)
        $(warning ERROR: DEMO font only supports 128X128, 128X160, 176X220, 240X240, 320X320, 240X320, 320X240, 240X400, 320X480 and 480X800 MAIN_LCD_SIZE, for other MAIN_LCD_SIZE, please set FONT_RESOURCE=OFFICIAL)
        DEPENDENCY_CONFLICT = TRUE
      endif
      ifneq ($(strip $(MMIDIR)),lcmmi)
        ifneq ($(strip $(MAIN_LCD_SIZE)),$(BITMAP_FONT_EXCLUDE_LCD_SIZE))
...
ifeq ($(strip $(WAPI_SUPPORT)),TRUE)
  ifdef WIFI_AUTHENTICATION_LEVEL
    ifeq ($(strip $(WIFI_AUTHENTICATION_LEVEL)),WIFI_FEATURE_SCAN_ONLY)
      $(warning ERROR: Please turnoff WAPI_SUPPORT for WIFI_FEATURE_SCAN_ONLY !)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifeq ($(strip $(WIFI_AUTHENTICATION_LEVEL)),WIFI_AUTHENTICATION_PSK_ONLY)
...
ifdef FUDIFFNET_ENABLE
  ifeq ($(strip $(FUDIFFNET_ENABLE)),NONE)
    ifeq ($(strip $(CUSTOM_RELEASE)),FALSE)
    ...
    ifeq ($(strip $(MMI_IME_V3_SUPPORT)),TRUE)
      ifneq ($(call Upper,$(strip $(MAIN_LCD_SIZE))),240X320)
        ifneq ($(call Upper,$(strip $(MAIN_LCD_SIZE))),240X240)
          ifneq ($(call Upper,$(strip $(MAIN_LCD_SIZE))),320X320)
...
ifeq ($(strip $(ADUPS_FOTA_DIFF_ENABLE)),TRUE)
    COM_DEFS += __ADUPS_FOTA_DIFF__
ifeq ($(strip $(ADUPS_FOTA_SOC_ENABLE)),TRUE)
   	 COM_DEFS += __ADUPS_FOTA_SOC__
endif

ifeq ($(strip $(ADUPS_FOTA_GPS_ENABLE)),TRUE)
   	 COM_DEFS += __ADUPS_FOTA_GPS__
endif
COMPLIST += adups
CUS_REL_SRC_COMP += adups

 ifeq ($(strip $(ADUPS_FOTA_DIFF_LIB)),TRUE)
COMPOBJS	+= adups\libiothttp_adups.lib
endif
endif
################ADUPS END##################

ifeq ($(strip $(ROCK_FOTA_SUPPORT)),TRUE)
  ifneq ($(strip $(FUDIFFNET_ENABLE)),DIFF_IMAGE_UPDATE)
    $(call DEP_ERR_SETA_OR_OFFB,FUDIFFNET_ENABLE,DIFF_IMAGE_UPDATE,ROCK_FOTA_SUPPORT)
    DEPENDENCY_CONFLICT = TRUE
  else
    COM_DEFS += __ROCK_FOTA_SUPPORT__
  endif
endif
...
ifdef PRODUCT_LINE
  ifneq ($(filter WEARABLE_WATCH WEARABLE_WRISTBAND WEARABLE_TRACKER,$(PRODUCT_LINE)),)
  ifneq ($(strip $(PRODUCT_LINE)),WEARABLE_WATCH)
    COM_DEFS += __LINKIT_HIGH_PRIORITY_TASK_SUPPORT__
  endif
  endif
  ifeq ($(strip $(PRODUCT_LINE)),WEARABLE_WATCH)
    COM_DEFS += __WEARABLE__
    COM_DEFS += __WEARABLE_WATCH__
    ifdef HOTKNOT_SUPPORT
      ifeq ($(strip $(HOTKNOT_SUPPORT)),TRUE)
        COM_DEFS += __HOTKNOT_SUPPORT__
      endif
    endif
  endif
endif
...
ifeq ($(strip $(HOTKNOT_SUPPORT)),TRUE) 
  ifneq ($(strip $(PRODUCT_LINE)),WEARABLE_WATCH)
    $(warning ERROR: HotKnot: HotKnot can only enable on watch project.) 
    DEPENDENCY_CONFLICT = TRUE
  endif
endif
...
ifdef UPDATE_BINARY_FILE
  ifeq ($(strip $(UPDATE_BINARY_FILE)),TRUE)
    ifndef FUNET_ENABLE
      $(call DEP_ERR_SETA_OR_OFFB,FUNET_ENABLE,FULL_IMAGE_UPDATE,UPDATE_BINARY_FILE)
      DEPENDENCY_CONFLICT = TRUE
    else
      ifneq ($(strip $(FUNET_ENABLE)),FULL_IMAGE_UPDATE)
        $(call DEP_ERR_SETA_OR_OFFB,FUNET_ENABLE,FULL_IMAGE_UPDATE,UPDATE_BINARY_FILE)
        DEPENDENCY_CONFLICT = TRUE
      endif
    endif
    ifeq ($(strip $(TSRESERVEDSIZE_AUTOCONFIG)),TRUE)
      $(call DEP_ERR_OFFA_OR_OFFB,UPDATE_BINARY_FILE,TSRESERVEDSIZE_AUTOCONFIG)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifeq ($(strip $(BLRESERVEDSIZE_AUTOCONFIG)),TRUE)
      $(call DEP_ERR_OFFA_OR_OFFB,UPDATE_BINARY_FILE,BLRESERVEDSIZE_AUTOCONFIG)
      DEPENDENCY_CONFLICT = TRUE
    endif
    REMOVE_OPTION_FOR_UPDATE_BINARY_FILE := __FS_AUTO_CONFIG_SUPPORT__
    COM_DEFS  := $(filter-out $(REMOVE_OPTION_FOR_UPDATE_BINARY_FILE),$(COM_DEFS))
    COM_DEFS += __UPDATE_BINARY_FILE__
    UPDATE_BINARY_PACKAGE_SUPPORT_VALUE := MMI_BT MMI_ONLY BT_ONLY SENSOR_ONLY
    ifdef UPDATE_BINARY_PACKAGE
      ifeq ($(strip $(UPDATE_BINARY_PACKAGE)),MMI_BT)
        COM_DEFS += __UPDATE_PKG_MMI_BT__
      endif
      ifeq ($(strip $(UPDATE_BINARY_PACKAGE)),MMI_ONLY)
        COM_DEFS += __UPDATE_PKG_MMI_ONLY__
      endif
      ifeq ($(strip $(UPDATE_BINARY_PACKAGE)),BT_ONLY)
        COM_DEFS += __UPDATE_PKG_BT_ONLY__
      endif
      ifeq ($(strip $(UPDATE_BINARY_PACKAGE)),SENSOR_ONLY)
        COM_DEFS += __UPDATE_PKG_SENSOR_ONLY__
      endif
      ifeq ($(filter $(UPDATE_BINARY_PACKAGE_SUPPORT_VALUE),$(UPDATE_BINARY_PACKAGE)),)
        $(warning ERROR: Wrong UPDATE_BINARY_PACKAGE! Please configure it as $(UPDATE_BINARY_PACKAGE_SUPPORT_VALUE))
        DEPENDENCY_CONFLICT = TRUE
      endif
      ifneq ($(strip $(UPDATE_BINARY_PACKAGE)),BT_ONLY)
        ifeq ($(strip $(DCM_COMPRESSION_MAUI_INIT)),TRUE)
          $(warning ERROR: Please turn off UPDATE_BINARY_FILE or set UPDATE_BINARY_PACKAGE as BT_ONLY or turn off DCM_COMPRESSION_MAUI_INIT)
          DEPENDENCY_CONFLICT = TRUE
        endif
      endif
    else
      $(call DEP_ERR_ONA_OR_OFFB,UPDATE_BINARY_PACKAGE,UPDATE_BINARY_FILE)
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
endif
...
ifdef BUILD_UBIN_ONLY
  ifeq ($(strip $(BUILD_UBIN_ONLY)),TRUE)
    ifneq ($(strip $(UPDATE_BINARY_FILE)),TRUE)
      $(call DEP_ERR_ONA_OR_OFFB,UPDATE_BINARY_FILE,BUILD_UBIN_ONLY)
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
endif

ifdef TOUCH_PANEL_FRM_UPDATE
  ifeq ($(strip $(TOUCH_PANEL_FRM_UPDATE)),TRUE)
    COM_DEFS += __TP_AUTO_UPDATE_FW__
  endif
endif
...
# notice the order of __BTMTK__ & __BTVCSR_HCI_BCHS__
BT_LE_ONLY_BT_PROFILE_CONDITION += $(BT_DUN_PROFILE)
BT_LE_ONLY_BT_PROFILE_CONDITION += $(BT_FAX_PROFILE)
BT_LE_ONLY_BT_PROFILE_CONDITION += $(BT_FTC_PROFILE)
BT_LE_ONLY_BT_PROFILE_CONDITION += $(BT_FTS_PROFILE)
BT_LE_ONLY_BT_PROFILE_CONDITION += $(BT_HFG_PROFILE)
BT_LE_ONLY_BT_PROFILE_CONDITION += $(BT_HIDD_PROFILE)
BT_LE_ONLY_BT_PROFILE_CONDITION += $(BT_MAPC_PROFILE)
BT_LE_ONLY_BT_PROFILE_CONDITION += $(BT_OPP_PROFILE)
BT_LE_ONLY_BT_PROFILE_CONDITION += $(BT_PBAP_PROFILE)
BT_LE_ONLY_BT_PROFILE_CONDITION += $(BT_PBAPC_PROFILE)
BT_LE_ONLY_BT_PROFILE_CONDITION += $(BT_SIM_PROFILE)
BT_LE_ONLY_BT_PROFILE_CONDITION += $(BT_SPP_PROFILE)
BT_LE_ONLY_BT_PROFILE_CONDITION += $(BT_AVRCP_PROFILE)
BT_LE_ONLY_BT_PROFILE_CONDITION += $(BT_A2DP_PROFILE)
BT_LE_ONLY_BT_PROFILE_CONDITION += $(BT_GOEP_PROFILE)
BT_LE_ONLY_BT_PROFILE_CONDITION += $(BT_HF_PROFILE)

ifeq ($(filter TRUE,$(BT_LE_ONLY_BT_PROFILE_CONDITION)),)
  ifneq ($(filter __BTVCSR_HCI_BCHS__ __BTMTK__,$(COM_DEFS)),)
    COM_DEFS += __BT_LE_ONLY__
  endif
endif

# *************************************************************************
# gfh_process brom setting
# *************************************************************************
GFH_PROCESS_TYPE := NONE
ifneq ($(filter __DUAL_TALK_MODEM_SUPPORT__ ,$(COM_DEFS)),)
  GFH_PROCESS_TYPE := DSDA
endif
ifneq ($(filter __LINKIT_DEV_KIT__ ,$(COM_DEFS)),)
  GFH_PROCESS_TYPE := LINKIT
endif

GFH_PROCESS_TYPE_TEMP := $(filter __LINKIT_DEV_KIT__ __DUAL_TALK_MODEM_SUPPORT__,$(COM_DEFS))
ifeq ($(call gt,$(words $(GFH_PROCESS_TYPE_TEMP)),1),T)
  $(warning ERROR: There are existing $(words $(GFH_PROCESS_TYPE_TEMP)) types of gfh process are selected: $(GFH_PROCESS_TYPE_TEMP), cannot determine which one.)
  DEPENDENCY_CONFLICT = TRUE
endif
...
TS_SCATTERFILE   := custom\system\$(strip $(BOARD_VER))\scatTS_$(strip $(PLATFORM)).txt
UBIN_SCATTERFILE := custom\system\$(strip $(BOARD_VER))\scatUB_$(strip $(PLATFORM)).txt
...
ifeq ($(strip $(ADUPS_FOTA_DIFF_LIB)),TRUE)
	BL_COMPOBJS += adups\libiotbspatch_adups.lib
endif
ifdef FUDIFFNET_ENABLE
  ifeq ($(strip $(FUDIFFNET_ENABLE)),DIFF_IMAGE_UPDATE)
    BL_COMPLIST += fdm_bl gfx_core32 sys_sec
    ifeq ($(strip $(ROCK_FOTA_SUPPORT)),TRUE)
      ifneq ($(filter __FUDIFFNET_ROCK_ENABLE__ ,$(COM_DEFS)),)
        BL_COMPOBJS += vendor\rock_fota\libiotpatch_gmobi_rcvt31_20141022.lib
      endif
    else
      ifneq ($(filter __FUDIFFNET_REDBEND_ENABLE__ ,$(COM_DEFS)),)
        BL_COMPOBJS += vendor\redbend_fuediff\wearable_rvct31_fw.lib
      endif
    endif
  endif
endif
...
#########################################################
#########################################################
# Include ubin_Option.mak & Settings for Update Binary
#########################################################
NEED_BUILD_UPDATE_BINARY := FALSE
MBIN_WITH_ALL_LIBS := TRUE

ifeq ($(strip $(UPDATE_BINARY_FILE)),TRUE)
  ifneq ($(strip $(MODIS_CONFIG)),TRUE)
    NEED_BUILD_UPDATE_BINARY := TRUE
    MBIN_WITH_ALL_LIBS := FALSE
    COMPLIST += ubinverno system_ubin
include make\ubin_Option.mak
  endif
endif 
...
ifdef IOT_LOCK
     ifeq ($(strip $(IOT_LOCK)), TRUE)
	COM_DEFS += __IOT_LOCK__ __IOT_BLE_BKSS_SUPPORT__
	COM_DEFS     += __POPULATE_NO_IMAGE_DATA__
	COM_DEFS     += __POPULATE_NO_STRING_DATA__
# Add compile module
	COMPLIST += iotlock
	CUS_REL_SRC_COMP += iotlock
    endif
endif
ifdef NSK_ECG
     ifeq ($(strip $(NSK_ECG)), TRUE)
	COM_DEFS += __NSK_ECG__ 
    endif
endif
