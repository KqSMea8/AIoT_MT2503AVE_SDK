...
ifneq  ($(filter __MMI_UI_DISPLAY_LEVEL_NONE__, $(strip $(MODULE_DEFS))),)
...
ifneq ($(filter __MMI_SCREEN_SAVER__ , $(strip $(MODULE_DEFS))),) 
...
ifneq ($(filter __MMI_SCRLOCKER_APP__ , $(strip $(MODULE_DEFS))),) 
...
ifneq ($(filter __MMI_DIALER_CUI_SUPPORT__, $(strip $(MODULE_DEFS))),)
SRC_LIST +=plutommi\mmi\Dialer\DialerSrc\DialerMain.c \
...
ifneq  ($(filter __MMI_UI_DISPLAY_LEVEL_NONE__, $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\MMI\SlimInterface\app_slim.c
else

SRC_LIST += plutommi\mmi\mainmenu\mainmenusrc\mainmenu.c 
ifneq ($(filter __MMI_WEARABLE_DEVICE__ , $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\mmi\mainmenu\mainmenusrc\watch_barrel.c 
endif

endif

ifneq ($(filter __MMI_MESSAGE_APP_SUPPORT__ , $(strip $(MODULE_DEFS))),) 
SRC_LIST += plutommi\mmi\messages\messagessrc\messagesmiscell.c \
           ...
           plutommi\mmi\messages\messagessrc\SmsMainMenu.c
...
ifneq ($(filter __MMI_GSM_CALL_SUPPORT__ , $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\mmi\ucm\ucmsrc\UcmEventHdlr.c \
           ...
           plutommi\AppCore\Ucm\UcmKernel.c \
           plutommi\AppCore\Ucm\UcmUhaCore.c
endif

ifneq ($(filter __MMI_TELEPHONY_SUPPORT__ , $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\mmi\cphs\cphssrc\cphsprotocolhandlers.c
endif
...
SRC_LIST += plutommi\mmi\phonebook\phonebooksrc\PhoneBookGroup.c \
           ...
           plutommi\mmi\phonebook\phonebooksrc\phonebookappmem.c \
           plutommi\Cui\PhbCui\PhbCui.c 
endif
ifneq ($(filter __MMI_PROFILES_APP__ , $(strip $(MODULE_DEFS))),)            
SRC_LIST += plutommi\mmi\profiles\profilessrc\ProfilesApp.c \
           plutommi\mmi\profiles\profilessrc\Soundsetting.c \
...
SRC_LIST += plutommi\CUI\PasswordCui\PwdCuiBasic.c \
           plutommi\CUI\PasswordCui\PwdCuiGuardSlim.c \
           plutommi\MMI\BT_UCM\UcmBTSrc\UcmInterfaceBT.c \
           plutommi\MMI\BT_UCM\UcmBTSrc\UcmKernelBT.c \
           plutommi\MMI\BT_UCM\UcmBTSrc\UcmUiBT.c 

ifneq ($(filter __MMI_SETTINGS_SUPPORT__ , $(strip $(MODULE_DEFS))),)  
ifneq ($(filter __MMI_TELEPHONY_SUPPORT__ , $(strip $(MODULE_DEFS))),) 
SRC_LIST += plutommi\mmi\setting\settingsrc\NetSetApp.c \
...
ifneq ($(filter __MMI_SECSET_APP_SUPPORT__ , $(strip $(MODULE_DEFS))),) 
SRC_LIST += plutommi\MMI\SecuritySetting\SecSetSrc\SecSetMenu.c \
...
SRC_LIST +=  plutommi\mmi\SmsbtmapcApp\SmsbtmapcAppSrc\SmsUmInterAdp.c \
           plutommi\mmi\SmsbtmapcApp\SmsbtmapcAppSrc\SmsUmBtUtilaprnc.c \
           plutommi\mmi\SmsbtmapcApp\SmsbtmapcAppSrc\SmsUmBtSrv.c \
           plutommi\mmi\SmsbtmapcApp\SmsbtmapcAppSrc\SmsUmBtMapScrnHdlr.c \
	       plutommi\mmi\SmsbtmapcApp\SmsbtmapcAppSrc\SmsBtappmainUI.C \
	       plutommi\mmi\SmsbtmapcApp\SmsbtmapcAppSrc\SmsBtappSendMsg.C \
	       plutommi\mmi\BTNotification\BTNotificationSrc\BTNotificationMain.C \
           plutommi\mmi\BtRemoteCapture\BtRmtCapCmd.c
ifneq ($(filter __MMI_WEARABLE_DEVICE__ , $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\mmi\BtRemoteCapture\BtRmtCapMainEx.c \
           plutommi\mmi\BtRemoteCapture\BtRmtCapCategory.c
else
SRC_LIST += plutommi\mmi\BtRemoteCapture\BtRmtCapMain.c
endif				           
endif
...
SRC_LIST += plutommi\mmi\CubeApp\CubeAppSrc\CubeApp.c \
...
ifneq ($(filter __MMI_SMS_CUI_SUPPORT__, $(strip $(MODULE_DEFS))),)           
SRC_LIST += plutommi\Cui\SmsCui\SmsGenericCui.c \
           plutommi\Cui\SmsCui\SmsSaveCui.c \
           plutommi\Cui\SmsCui\SmsUtilCui.c \
           plutommi\Cui\SmsCui\SmsSenderCui.c 
endif
           
SRC_LIST += plutommi\mmi\Bootup\BootupSrc\BootupFlow.c \
           ...
           plutommi\mmi\Bootup\BootupSrc\BootupFTU.c \
...
ifneq ($(filter __MMI_TELEPHONY_SUPPORT__ __MMI_BT_PBAP_CLIENT__, $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\mmi\CallLog\CallLogSrc\CallLogAction.c \
...
ifneq ($(filter __MMI_TELEPHONY_SUPPORT__ , $(strip $(MODULE_DEFS))),) 
SRC_LIST += plutommi\mmi\Bootup\BootupSrc\BootupMode.c \
...
ifneq ($(filter __MMI_BT_PBAP_CLIENT__, $(strip $(MODULE_DEFS))),)
	SRC_LIST += plutommi\mmi\CallLog\CallLogSrc\CallLogPbapc.c \
            plutommi\mmi\CallLog\CallLogSrc\CallLogAdpPbapc.c
endif
...
ifneq ($(filter __BT_PBAP_CLIENT__, $(strip $(MODULE_DEFS))),)
  SRC_LIST += plutommi\mmi\phonebook\phonebooksrc\PhoneBookBtDailer.c
endif

ifneq ($(filter __BT_PBAP_CLIENT__, $(strip $(MODULE_DEFS))),)
  SRC_LIST += plutommi\mmi\phonebook\phonebooksrc\PhoneBookpbapc.c
  SRC_LIST += plutommi\mmi\phonebook\phonebooksrc\PhoneBookpbapcEx.c
ifneq ($(filter __MMI_WEARABLE_DEVICE__, $(strip $(MODULE_DEFS))),)
  SRC_LIST += plutommi\mmi\phonebook\phonebooksrc\PhoneBookpbapcWearable.c
endif
endif
...
ifneq ($(filter __MMI_GAME_FRUITNINJA__, $(strip $(MODULE_DEFS))),)
            SRC_LIST += plutommi\mmi\funandgames\funandgamessrc\FruitNinja.c
endif      
ifneq ($(filter __MMI_GAME_DIAMOND__, $(strip $(MODULE_DEFS))),)
            SRC_LIST += plutommi\mmi\funandgames\funandgamessrc\Diamond.c
endif
ifneq ($(filter __MMI_GAME_NINJACLIMB__, $(strip $(MODULE_DEFS))),)
            SRC_LIST += plutommi\mmi\funandgames\funandgamessrc\NinjaClimb.c
endif
ifneq ($(filter __MMI_GAME_FROGCANDY__, $(strip $(MODULE_DEFS))),)
            SRC_LIST += plutommi\mmi\funandgames\funandgamessrc\FrogCandy.c
endif
ifneq ($(filter __MMI_GAME_TRUEMAN__, $(strip $(MODULE_DEFS))),) 
            SRC_LIST += plutommi\mmi\funandgames\funandgamessrc\TrueMan.c
endif
ifneq ($(filter __MMI_GAME_TOPGUN__, $(strip $(MODULE_DEFS))),)
            SRC_LIST += plutommi\mmi\funandgames\funandgamessrc\TopGun.c
endif
...
#ifeq ($(filter __GPS_ADAPTOR_SUPPORT__, $(strip $(MODULE_DEFS))),)
...
ifneq ($(filter __MMI_SSC_CUI_SUPPORT__, $(strip $(MODULE_DEFS))),)
...
SRC_LIST += plutommi\mmi\PxpApp\PxpAppSrc\PxpAppMain.c
endif

ifneq ($(filter __MMI_BLE_FMP_SUPPORT__ , $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\mmi\FmpApp\FmpAppSrc\FmpAppMain.c
endif

ifneq ($(filter __MMI_BLE_ANP_SUPPORT__ , $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\mmi\AnpApp\AnpAppSrc\AnpAppMain.c
endif

ifneq ($(filter __MMI_BLE_TIP_SUPPORT__ , $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\mmi\TipApp\TipAppSrc\TipAppMain.c
endif

ifneq ($(filter __MMI_ANCS_IOS8_SUPPORT__ , $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\mmi\BTNotiAncs\BTNotiAncsSrc\BTAncsMain.c
endif

ifneq ($(filter __MMI_ONE_KEY_SOS_SUPPORT__ , $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\MMI\OneKeySOS\OKSOSSrc\OneKeySOSMain.c
endif

ifneq ($(filter __MMI_HEART_RATE_SUPPORT__ , $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\mmi\HeartRateApp\HeartRateSrc\HeartRate.c
endif

ifneq ($(filter __MMI_BLOOD_PRESSURE_SUPPORT__ , $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\mmi\BloodPressureApp\BloodPressureSrc\BloodPressure.c
endif
...
ifneq ($(filter __MMI_WEARABLE_DEVICE__ , $(strip $(MODULE_DEFS))),)
	INC_DIR += plutommi\MMI\Swatch\SwatchInc
ifneq ($(filter __TINY_SYS__, $(strip $(MODULE_DEFS))),)
	INC_DIR += tiny_system\app\swatch\inc
	INC_DIR += tiny_system\hal\display\inc
